...
class CreateCustomFieldRequest {
     ...
     */
    constructor(label, fieldType) { 
        
        CreateCustomFieldRequest.initialize(this, label, fieldType);
    }
     ...
     */
    static initialize(obj, label, fieldType) { 
        obj['label'] = label;
...
CreateCustomFieldRequest.RequiredProperties = ["label", "field_type"];
