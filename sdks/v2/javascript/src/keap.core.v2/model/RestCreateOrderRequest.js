...
class RestCreateOrderRequest {
     ...
     * @param orderItems {Array.<module:keap.core.v2/model/CreateOrderItemRequest>} 
     * @param orderTitle {String} 
     */
    constructor(contactId, orderItems, orderTitle) { 
        
        RestCreateOrderRequest.initialize(this, contactId, orderItems, orderTitle);
    }
     ...
     */
    static initialize(obj, contactId, orderItems, orderTitle) { 
...
RestCreateOrderRequest.RequiredProperties = ["contact_id", "order_items", "order_title"];
