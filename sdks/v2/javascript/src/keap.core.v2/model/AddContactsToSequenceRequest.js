...
class AddContactsToSequenceRequest {
     ...
     * @param contactIds {Array.<String>} List of contact IDs to add to the sequence
     */
    constructor(contactIds) { 
        
        AddContactsToSequenceRequest.initialize(this, contactIds);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of AddContactsToSequenceRequest.RequiredProperties) {
...
AddContactsToSequenceRequest.RequiredProperties = ["contact_ids"];
