...
import CategoryDiscountCriteriaResponse from './CategoryDiscountCriteriaResponse';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('criteria')) {
                obj['criteria'] = ApiClient.convertToType(data['criteria'], [CategoryDiscountCriteriaResponse]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['criteria']) { // data not null
            ...
            for (const item of data['criteria']) {
                CategoryDiscountCriteriaResponse.validateJSON(item);
            };
        }
        // ensure the json data is an array
 ...
 * @member {String} id
 */
CategoryDiscount.prototype['id'] = undefined;
 ...
 * @member {Array.<module:keap.core.v2/model/CategoryDiscountCriteriaResponse>} criteria
 */
