...
class CreateAffiliateRequest {
    ...
    constructor(code, contactId) { 
        ...
        CreateAffiliateRequest.initialize(this, code, contactId);
    }
...
CreateAffiliateRequest.RequiredProperties = ["code", "contact_id"];
 ...
 * @default 'INACTIVE'
 */
CreateAffiliateRequest.prototype['status'] = 'INACTIVE';
 ...
 */
CreateAffiliateRequest.prototype['parent_affiliate_id'] = undefined;

/**
 * Whether to notify on sale events
 * @member {Boolean} notify_on_sale
 */
CreateAffiliateRequest.prototype['notify_on_sale'] = undefined;

/**
 * Whether to notify on lead events
 * @member {Boolean} notify_on_lead
 */
CreateAffiliateRequest.prototype['notify_on_lead'] = undefined;

/**
 * Number of days to track leads
 * @member {Number} track_leads_days
 */
CreateAffiliateRequest.prototype['track_leads_days'] = undefined;
