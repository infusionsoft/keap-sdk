...
class CreateOrderTotalDiscountRequest {
     ...
     * @param discountType {module:keap.core.v2/model/CreateOrderTotalDiscountRequest.DiscountTypeEnum} Type of discount: AMOUNT (fixed amount) or PERCENT (percentage)
    ...
    constructor(name, discountType, discountValue) { 
        ...
        CreateOrderTotalDiscountRequest.initialize(this, name, discountType, discountValue);
    }
...
CreateOrderTotalDiscountRequest.RequiredProperties = ["name", "discount_type", "discount_value"];
