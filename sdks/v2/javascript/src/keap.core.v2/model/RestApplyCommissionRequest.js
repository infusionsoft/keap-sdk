...
class RestApplyCommissionRequest {
     ...
     * @param referralPartnerId {String} The referral partner id
     */
    constructor(payoutType, referralPartnerId) { 
        
        RestApplyCommissionRequest.initialize(this, payoutType, referralPartnerId);
    }
     ...
     */
    static initialize(obj, payoutType, referralPartnerId) { 
        obj['payout_type'] = payoutType;
        obj['referral_partner_id'] = referralPartnerId;
    }
...
RestApplyCommissionRequest.RequiredProperties = ["payout_type", "referral_partner_id"];
 ...
 */
RestApplyCommissionRequest.prototype['referral_partner_id'] = undefined;
