...
class BusinessProfileAddressRequest {
     ...
     */
    constructor(line1, line2, locality, region, countryCode, postalCode) { 
        
        BusinessProfileAddressRequest.initialize(this, line1, line2, locality, region, countryCode, postalCode);
    }
     ...
     */
    static initialize(obj, line1, line2, locality, region, countryCode, postalCode) { 
        obj['line1'] = line1;
        obj['line2'] = line2;
...
BusinessProfileAddressRequest.RequiredProperties = ["line1", "line2", "locality", "region", "country_code", "postal_code"];
