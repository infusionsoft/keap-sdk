...
class RestV2Opportunity {
     ...
     */
    constructor(contact, stage, opportunityTitle) { 
        
        RestV2Opportunity.initialize(this, contact, stage, opportunityTitle);
    }
     ...
     */
    static initialize(obj, contact, stage, opportunityTitle) { 
        obj['contact'] = contact;
        obj['stage'] = stage;
...
RestV2Opportunity.RequiredProperties = ["contact", "stage", "opportunity_title"];
