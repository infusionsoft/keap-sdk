...
class UpdateSubscriptionRequest {
    ...
    constructor(contactId) { 
        ...
        UpdateSubscriptionRequest.initialize(this, contactId);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of UpdateSubscriptionRequest.RequiredProperties) {
...
UpdateSubscriptionRequest.RequiredProperties = ["contact_id"];
