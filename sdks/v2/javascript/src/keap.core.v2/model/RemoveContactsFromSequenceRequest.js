...
class RemoveContactsFromSequenceRequest {
     ...
     * @param contactIds {Array.<String>} List of contact IDs to remove from the sequence
     */
    constructor(contactIds) { 
        
        RemoveContactsFromSequenceRequest.initialize(this, contactIds);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of RemoveContactsFromSequenceRequest.RequiredProperties) {
...
RemoveContactsFromSequenceRequest.RequiredProperties = ["contact_ids"];
