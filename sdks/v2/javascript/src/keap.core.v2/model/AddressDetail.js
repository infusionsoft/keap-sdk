 ...
 * @module keap.core.v2/model/AddressDetail
 */
class AddressDetail {
    /**
     * Constructs a new <code>AddressDetail</code>.
     * @alias module:keap.core.v2/model/AddressDetail
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/AddressDetail} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/AddressDetail} The populated <code>AddressDetail</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>AddressDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressDetail</code>.
     */
 ...
 * @member {String} line1
 */
AddressDetail.prototype['line1'] = undefined;

/**
 * Street address line 2
 * @member {String} line2
 */
AddressDetail.prototype['line2'] = undefined;
...
/**
 * Address type field
 * @member {module:keap.core.v2/model/AddressDetail.FieldEnum} field
 */
AddressDetail.prototype['field'] = undefined;

/**
 * An ISO 3166-2 Country Code (https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3)
 * @member {String} country_code
 */
AddressDetail.prototype['country_code'] = undefined;

/**
 * Postal or ZIP code
 * @member {String} postal_code
 */
AddressDetail.prototype['postal_code'] = undefined;
 ...
 */
AddressDetail.prototype['region_code'] = undefined;

/**
 * ZIP code (US)
 * @member {String} zip_code
 */
AddressDetail.prototype['zip_code'] = undefined;

/**
 * ZIP+4 extension
 * @member {String} zip_four
 */
AddressDetail.prototype['zip_four'] = undefined;
