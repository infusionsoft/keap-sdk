    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('subscription_plan_interests')) {
                obj['subscription_plan_interests'] = ApiClient.convertToType(data['subscription_plan_interests'], [ProductInterest]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:keap.core.v2/model/ProductInterest>} subscription_plan_interests
 */
