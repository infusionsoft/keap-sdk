...
class UpdateProductCommissionProgramRequest {
     ...
     * @param productId {String} Product ID to assign commission
     */
    constructor(productId) { 
        
        UpdateProductCommissionProgramRequest.initialize(this, productId);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of UpdateProductCommissionProgramRequest.RequiredProperties) {
