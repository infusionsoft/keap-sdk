...
class CreateOpportunityStageRequest {
     ...
     */
    constructor(name, order, targetNumberDays, probability) { 
        
        CreateOpportunityStageRequest.initialize(this, name, order, targetNumberDays, probability);
    }
     ...
     */
    static initialize(obj, name, order, targetNumberDays, probability) { 
        obj['name'] = name;
        obj['order'] = order;
...
CreateOpportunityStageRequest.RequiredProperties = ["name", "order", "target_number_days", "probability"];
