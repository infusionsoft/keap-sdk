...
import CreateProductDiscountCriteria from './CreateProductDiscountCriteria';
...
class CreateProductDiscountRequest {
     ...
     * @param productId {String} ID of the product this discount applies to
     * @param discountType {module:keap.core.v2/model/CreateProductDiscountRequest.DiscountTypeEnum} Type of discount: AMOUNT (fixed amount) or PERCENT (percentage)
     * @param discountValue {Number} Value of the discount (amount or percentage depending on discount_type)
     */
    constructor(name, productId, discountType, discountValue) { 
        
        CreateProductDiscountRequest.initialize(this, name, productId, discountType, discountValue);
    }
     ...
     */
    static initialize(obj, name, productId, discountType, discountValue) { 
        obj['name'] = name;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('criteria')) {
                obj['criteria'] = ApiClient.convertToType(data['criteria'], [CreateProductDiscountCriteria]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['criteria']) { // data not null
            ...
            for (const item of data['criteria']) {
                CreateProductDiscountCriteria.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
CreateProductDiscountRequest.RequiredProperties = ["name", "product_id", "discount_type", "discount_value"];
 ...
 * @member {Array.<module:keap.core.v2/model/CreateProductDiscountCriteria>} criteria
 */
