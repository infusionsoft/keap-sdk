...
class CreateProductDiscountRequest {
     ...
     */
    constructor(discountType, discountValue, name, productId) { 
        
        CreateProductDiscountRequest.initialize(this, discountType, discountValue, name, productId);
    }
     ...
     */
    static initialize(obj, discountType, discountValue, name, productId) { 
...
CreateProductDiscountRequest.RequiredProperties = ["discount_type", "discount_value", "name", "product_id"];
