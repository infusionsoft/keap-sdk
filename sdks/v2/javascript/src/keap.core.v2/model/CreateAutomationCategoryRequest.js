...
class CreateAutomationCategoryRequest {
    ...
    constructor(name) { 
        ...
        CreateAutomationCategoryRequest.initialize(this, name);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateAutomationCategoryRequest.RequiredProperties) {
...
CreateAutomationCategoryRequest.RequiredProperties = ["name"];
