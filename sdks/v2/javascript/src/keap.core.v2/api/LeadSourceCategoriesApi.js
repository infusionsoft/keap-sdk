...
export default class LeadSourceCategoriesApi {
    ...
    */
     ...
     */
    createLeadSourceCategoryUsingPOSTWithHttpInfo(createUpdateLeadSourceCategoryRequest) {
      ...
      if (createUpdateLeadSourceCategoryRequest === undefined || createUpdateLeadSourceCategoryRequest === null) {
        throw new Error("Missing the required parameter 'createUpdateLeadSourceCategoryRequest' when calling createLeadSourceCategoryUsingPOST");
      }
     ...
     */
    createLeadSourceCategoryUsingPOST(createUpdateLeadSourceCategoryRequest) {
      return this.createLeadSourceCategoryUsingPOSTWithHttpInfo(createUpdateLeadSourceCategoryRequest)
    ...
    deleteLeadSourceCategoryUsingDELETEWithHttpInfo(leadSourceCategoryId) {
      ...
      if (leadSourceCategoryId === undefined || leadSourceCategoryId === null) {
        throw new Error("Missing the required parameter 'leadSourceCategoryId' when calling deleteLeadSourceCategoryUsingDELETE");
      }
    ...
    deleteLeadSourceCategoryUsingDELETE(leadSourceCategoryId) {
      return this.deleteLeadSourceCategoryUsingDELETEWithHttpInfo(leadSourceCategoryId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.core.v2/model/LeadSourceCategory} and HTTP response
     */
    getLeadSourceCategoryUsingGETWithHttpInfo(leadSourceCategoryId) {
      let postBody = null;
      // verify the required parameter 'leadSourceCategoryId' is set
      if (leadSourceCategoryId === undefined || leadSourceCategoryId === null) {
        throw new Error("Missing the required parameter 'leadSourceCategoryId' when calling getLeadSourceCategoryUsingGET");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.core.v2/model/LeadSourceCategory}
     */
    getLeadSourceCategoryUsingGET(leadSourceCategoryId) {
      return this.getLeadSourceCategoryUsingGETWithHttpInfo(leadSourceCategoryId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    listCategoriesUsingGET1WithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    listCategoriesUsingGET1(opts) {
      return this.listCategoriesUsingGET1WithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.core.v2/model/LeadSourceCategory} and HTTP response
     */
    updateLeadSourceCategoryUsingPATCHWithHttpInfo(leadSourceCategoryId, createUpdateLeadSourceCategoryRequest, opts) {
      opts = opts || {};
      let postBody = createUpdateLeadSourceCategoryRequest;
      // verify the required parameter 'leadSourceCategoryId' is set
      if (leadSourceCategoryId === undefined || leadSourceCategoryId === null) {
        throw new Error("Missing the required parameter 'leadSourceCategoryId' when calling updateLeadSourceCategoryUsingPATCH");
      }
      // verify the required parameter 'createUpdateLeadSourceCategoryRequest' is set
      if (createUpdateLeadSourceCategoryRequest === undefined || createUpdateLeadSourceCategoryRequest === null) {
        throw new Error("Missing the required parameter 'createUpdateLeadSourceCategoryRequest' when calling updateLeadSourceCategoryUsingPATCH");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.core.v2/model/LeadSourceCategory}
     */
    updateLeadSourceCategoryUsingPATCH(leadSourceCategoryId, createUpdateLeadSourceCategoryRequest, opts) {
      return this.updateLeadSourceCategoryUsingPATCHWithHttpInfo(leadSourceCategoryId, createUpdateLeadSourceCategoryRequest, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
