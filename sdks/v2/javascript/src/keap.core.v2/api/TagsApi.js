...
export default class TagsApi {
    ...
    */
     ...
     * @param {String} tagId 
     * @param {module:keap.core.v2/model/ApplyRemoveTagRequest} applyRemoveTagRequest 
    ...
    applyTagsWithHttpInfo(tagId, applyRemoveTagRequest) {
      ...
      return this.apiClient.callApi(
        '/rest/v2/tags/{tag_id}/contacts:applyTags', 'POST',
    ...
    deleteTagCategoryWithHttpInfo(tagCategoryId) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/rest/v2/tags/categories/{tag_category_id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    listCompaniesForTagIdWithHttpInfo(tagId, opts) {
      ...
      return this.apiClient.callApi(
        '/rest/v2/tags/{tag_id}/companies', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {String} [pageToken] Page token
     * @param {String} [orderBy] Attribute and direction to order items (best-effort for cross-collection reads). Field: - `applied_time`  Direction: - `asc` - `desc`
     * @param {Number} [pageSize] Total number of items to return per page
     ...
     * @param {String} opts.pageToken Page token
     * @param {String} opts.orderBy Attribute and direction to order items (best-effort for cross-collection reads). Field: - `applied_time`  Direction: - `asc` - `desc`
     * @param {Number} opts.pageSize Total number of items to return per page
    ...
    listContactsWithTagIdWithHttpInfo(tagId, opts) {
      ...
      return this.apiClient.callApi(
        '/rest/v2/tags/{tag_id}/contacts', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    removeTagsWithHttpInfo(tagId, applyRemoveTagRequest) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/rest/v2/tags/{tag_id}/contacts:removeTags', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateTagWithHttpInfo(tagId, createUpdateTagRequest, opts) {
      ...
      // verify the required parameter 'createUpdateTagRequest' is set
      if (createUpdateTagRequest === undefined || createUpdateTagRequest === null) {
        throw new Error("Missing the required parameter 'createUpdateTagRequest' when calling updateTag");
      }
    ...
    updateTag(tagId, createUpdateTagRequest, opts) {
      return this.updateTagWithHttpInfo(tagId, createUpdateTagRequest, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateTagCategoryWithHttpInfo(tagCategoryId, createUpdateTagCategoryRequest, opts) {
      ...
      // verify the required parameter 'createUpdateTagCategoryRequest' is set
      if (createUpdateTagCategoryRequest === undefined || createUpdateTagCategoryRequest === null) {
        throw new Error("Missing the required parameter 'createUpdateTagCategoryRequest' when calling updateTagCategory");
      }
      ...
      return this.apiClient.callApi(
        '/rest/v2/tags/categories/{tag_category_id}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateTagCategory(tagCategoryId, createUpdateTagCategoryRequest, opts) {
      return this.updateTagCategoryWithHttpInfo(tagCategoryId, createUpdateTagCategoryRequest, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
