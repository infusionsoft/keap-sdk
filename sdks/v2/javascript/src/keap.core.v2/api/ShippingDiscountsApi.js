...
export default class ShippingDiscountsApi {
    ...
    */
     ...
     */
    createDiscountUsingPOST3WithHttpInfo(createShippingDiscountRequest) {
      ...
      if (createShippingDiscountRequest === undefined || createShippingDiscountRequest === null) {
        throw new Error("Missing the required parameter 'createShippingDiscountRequest' when calling createDiscountUsingPOST3");
      }
     ...
     */
    createDiscountUsingPOST3(createShippingDiscountRequest) {
      return this.createDiscountUsingPOST3WithHttpInfo(createShippingDiscountRequest)
    ...
    deleteDiscountUsingDELETE3WithHttpInfo(discountId) {
      ...
      if (discountId === undefined || discountId === null) {
        throw new Error("Missing the required parameter 'discountId' when calling deleteDiscountUsingDELETE3");
      }
    ...
    deleteDiscountUsingDELETE3(discountId) {
      return this.deleteDiscountUsingDELETE3WithHttpInfo(discountId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.core.v2/model/ShippingDiscount} and HTTP response
     */
    getDiscountUsingGET3WithHttpInfo(discountId) {
      let postBody = null;
      // verify the required parameter 'discountId' is set
      if (discountId === undefined || discountId === null) {
        throw new Error("Missing the required parameter 'discountId' when calling getDiscountUsingGET3");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.core.v2/model/ShippingDiscount}
     */
    getDiscountUsingGET3(discountId) {
      return this.getDiscountUsingGET3WithHttpInfo(discountId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} [orderBy] Attribute and direction to order items. One of the following fields: - `discount_type` - `discount_value` - `id`  One of the following directions: - `asc` - `desc`
     ...
     */
    listDiscountsUsingGET1WithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {String} opts.orderBy Attribute and direction to order items. One of the following fields: - `discount_type` - `discount_value` - `id`  One of the following directions: - `asc` - `desc`
     ...
     */
    listDiscountsUsingGET1(opts) {
      return this.listDiscountsUsingGET1WithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.core.v2/model/ShippingDiscount} and HTTP response
     */
    updateDiscountUsingPATCH3WithHttpInfo(discountId, updateShippingDiscountRequest, opts) {
      opts = opts || {};
      let postBody = updateShippingDiscountRequest;
      // verify the required parameter 'discountId' is set
      if (discountId === undefined || discountId === null) {
        throw new Error("Missing the required parameter 'discountId' when calling updateDiscountUsingPATCH3");
      }
      ...
      if (updateShippingDiscountRequest === undefined || updateShippingDiscountRequest === null) {
        throw new Error("Missing the required parameter 'updateShippingDiscountRequest' when calling updateDiscountUsingPATCH3");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.core.v2/model/ShippingDiscount}
     */
    updateDiscountUsingPATCH3(discountId, updateShippingDiscountRequest, opts) {
      return this.updateDiscountUsingPATCH3WithHttpInfo(discountId, updateShippingDiscountRequest, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
