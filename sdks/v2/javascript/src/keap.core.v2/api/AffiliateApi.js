...
export default class AffiliateApi {
    ...
    */
     ...
     * Retrieves a list of Affiliates
     * @param {Object} opts Optional parameters
     * @param {String} opts.filter Filter to apply, allowed fields are: - (String) `affiliate_name` - (String) `contact_id` - (String) `referral_contact_id` - (String) `status` - (String) `code`  You will need to apply the `==` operator to check the equality of one of the filters with the value you want to match, in the encoded form `%3D%3D`. For the filters listed above, here are some examples: - `filter=affiliate_name%3D%3DBob` - `filter=contact_id%3D%3D567` - `filter=contact_id%3D%3D123%3Bcode%3D%3D567`
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.core.v2/model/RestAffiliate} and HTTP response
     */
    updateAffiliateWithHttpInfo(id, updateAffiliateRequest) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.core.v2/model/RestAffiliate}
     */
    updateAffiliate(id, updateAffiliateRequest) {
      return this.updateAffiliateWithHttpInfo(id, updateAffiliateRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
