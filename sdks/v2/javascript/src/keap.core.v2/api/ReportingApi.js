...
export default class ReportingApi {
    ...
    */
     ...
     */
    listReportsUsingGETWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    listReportsUsingGET(opts) {
      return this.listReportsUsingGETWithHttpInfo(opts)
     ...
     */
    retrieveReportUsingGETWithHttpInfo(reportId) {
      let postBody = null;
      // verify the required parameter 'reportId' is set
      if (reportId === undefined || reportId === null) {
        throw new Error("Missing the required parameter 'reportId' when calling retrieveReportUsingGET");
      }
     ...
     */
    retrieveReportUsingGET(reportId) {
      return this.retrieveReportUsingGETWithHttpInfo(reportId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
