...
export default class FilesApi {
    ...
    */
     ...
     */
    createFileUsingPOST1WithHttpInfo(file, fileAssociation, fileName, isPublic, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'file' is set
      if (file === undefined || file === null) {
        throw new Error("Missing the required parameter 'file' when calling createFileUsingPOST1");
      }
      // verify the required parameter 'fileAssociation' is set
      if (fileAssociation === undefined || fileAssociation === null) {
        throw new Error("Missing the required parameter 'fileAssociation' when calling createFileUsingPOST1");
      }
      // verify the required parameter 'fileName' is set
      if (fileName === undefined || fileName === null) {
        throw new Error("Missing the required parameter 'fileName' when calling createFileUsingPOST1");
      }
      // verify the required parameter 'isPublic' is set
      if (isPublic === undefined || isPublic === null) {
        throw new Error("Missing the required parameter 'isPublic' when calling createFileUsingPOST1");
      }
     ...
     */
    createFileUsingPOST1(file, fileAssociation, fileName, isPublic, opts) {
      return this.createFileUsingPOST1WithHttpInfo(file, fileAssociation, fileName, isPublic, opts)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.core.v2/model/FileMetadata} and HTTP response
     */
    updateFileUsingPOSTWithHttpInfo(fileId, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'fileId' is set
      if (fileId === undefined || fileId === null) {
        throw new Error("Missing the required parameter 'fileId' when calling updateFileUsingPOST");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.core.v2/model/FileMetadata}
     */
    updateFileUsingPOST(fileId, opts) {
      return this.updateFileUsingPOSTWithHttpInfo(fileId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
