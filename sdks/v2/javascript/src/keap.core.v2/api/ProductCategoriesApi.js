...
export default class ProductCategoriesApi {
    ...
    */
     ...
     * @param {module:keap.core.v2/model/AssignProductsRequest} assignProductsRequest 
    ...
    assignProductsToCategoryWithHttpInfo(categoryId, assignProductsRequest) {
      ...
      return this.apiClient.callApi(
        '/rest/v2/productCategories/{category_id}:assignProducts', 'POST',
    ...
    createImageFileWithHttpInfo(categoryId, file) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/rest/v2/productCategories/{category_id}/images', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {module:keap.core.v2/model/CreateProductCategoryRequest} createProductCategoryRequest 
     ...
     */
    createProductCategoryWithHttpInfo(createProductCategoryRequest) {
      let postBody = createProductCategoryRequest;
      // verify the required parameter 'createProductCategoryRequest' is set
      if (createProductCategoryRequest === undefined || createProductCategoryRequest === null) {
        throw new Error("Missing the required parameter 'createProductCategoryRequest' when calling createProductCategory");
      }
      ...
      return this.apiClient.callApi(
        '/rest/v2/productCategories', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    createProductCategory(createProductCategoryRequest) {
      return this.createProductCategoryWithHttpInfo(createProductCategoryRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    deleteImageFileWithHttpInfo(categoryId) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/rest/v2/productCategories/{category_id}/images', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteProductCategoryWithHttpInfo(categoryId) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/rest/v2/productCategories/{category_id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    getProductCategoryWithHttpInfo(categoryId) {
      ...
      let returnType = ProductCategory;
      return this.apiClient.callApi(
        '/rest/v2/productCategories/{category_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * Retrieves a list of Product Categories
     * @param {Object} opts Optional parameters
     * @param {String} opts.filter Filter to apply, allowed fields are: - (String) `product_id` - (String) `name` - Wildcard matching allowed - (Number) `product_category_id` - supports comparison operators: `==`,`!=`, `>`, `<`, `>=`, `<=`  You will need to apply the `==` operator to check the equality of one of the filters with your searched word, in the encoded form `%3D%3D`.  For fields which allow wildcard matching, you may use the * wildcard character (or its encoded form %2A) for case-insensitive partial matching on text fields. Example of a valid pattern of wildcard usage: - `field==foo*` finds anything in `field` that begins with `foo`  For the filters listed above, here are some examples: - `filter=product_id%3D%3D29` - `filter=name%3D%3DTestSearch` - `filter=name%3D%3DElec*` (starts with \"Elec\") - `filter=product_category_id>5` (category ID greater than 5) - `filter=product_category_id>=10` (category ID greater than or equal to 10) - `filter=product_category_id%3D%3D42` (category ID equals 42) - `filter=name%3D%3DElec*%3Bproduct_category_id>5` (multiple filters combined) 
    ...
    updateProductCategoryWithHttpInfo(categoryId, updateProductCategoryRequest, opts) {
      ...
      let returnType = ProductCategory;
      return this.apiClient.callApi(
        '/rest/v2/productCategories/{category_id}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
