...
export default class PipelinesApi {
    ...
    */
     ...
     */
    getDealCountWithHttpInfo(id, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getDealCount");
      }
      ...
      return this.apiClient.callApi(
        '/v2/pipelines/{id}:dealsCount', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    getDealCount(id, opts) {
      return this.getDealCountWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
