...
export default class LeadSourcesApi {
    ...
    */
     ...
     */
    createLeadSourceUsingPOSTWithHttpInfo(createLeadSourceRequest) {
      ...
      if (createLeadSourceRequest === undefined || createLeadSourceRequest === null) {
        throw new Error("Missing the required parameter 'createLeadSourceRequest' when calling createLeadSourceUsingPOST");
      }
     ...
     */
    createLeadSourceUsingPOST(createLeadSourceRequest) {
      return this.createLeadSourceUsingPOSTWithHttpInfo(createLeadSourceRequest)
    ...
    deleteLeadSourceUsingDELETEWithHttpInfo(leadSourceId) {
      ...
      if (leadSourceId === undefined || leadSourceId === null) {
        throw new Error("Missing the required parameter 'leadSourceId' when calling deleteLeadSourceUsingDELETE");
      }
    ...
    deleteLeadSourceUsingDELETE(leadSourceId) {
      return this.deleteLeadSourceUsingDELETEWithHttpInfo(leadSourceId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.core.v2/model/LeadSource} and HTTP response
     */
    getLeadSourceUsingGETWithHttpInfo(leadSourceId) {
      let postBody = null;
      // verify the required parameter 'leadSourceId' is set
      if (leadSourceId === undefined || leadSourceId === null) {
        throw new Error("Missing the required parameter 'leadSourceId' when calling getLeadSourceUsingGET");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.core.v2/model/LeadSource}
     */
    getLeadSourceUsingGET(leadSourceId) {
      return this.getLeadSourceUsingGETWithHttpInfo(leadSourceId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.core.v2/model/LeadSource} and HTTP response
     */
    updateLeadSourceUsingPATCHWithHttpInfo(leadSourceId, createLeadSourceRequest, opts) {
      opts = opts || {};
      let postBody = createLeadSourceRequest;
      // verify the required parameter 'leadSourceId' is set
      if (leadSourceId === undefined || leadSourceId === null) {
        throw new Error("Missing the required parameter 'leadSourceId' when calling updateLeadSourceUsingPATCH");
      }
      // verify the required parameter 'createLeadSourceRequest' is set
      if (createLeadSourceRequest === undefined || createLeadSourceRequest === null) {
        throw new Error("Missing the required parameter 'createLeadSourceRequest' when calling updateLeadSourceUsingPATCH");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.core.v2/model/LeadSource}
     */
    updateLeadSourceUsingPATCH(leadSourceId, createLeadSourceRequest, opts) {
      return this.updateLeadSourceUsingPATCHWithHttpInfo(leadSourceId, createLeadSourceRequest, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
