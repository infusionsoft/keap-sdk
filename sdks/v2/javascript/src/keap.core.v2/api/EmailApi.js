...
export default class EmailApi {
    ...
    */
     ...
     * @param {module:keap.core.v2/model/CreateEmailSentRequest} createEmailSentRequest 
     ...
     * @param {module:keap.core.v2/model/CreateEmailsSentRequest} createEmailsSentRequest 
     ...
     */
    createEmailsWithHttpInfo(createEmailsSentRequest) {
      let postBody = createEmailsSentRequest;
      // verify the required parameter 'createEmailsSentRequest' is set
      if (createEmailsSentRequest === undefined || createEmailsSentRequest === null) {
        throw new Error("Missing the required parameter 'createEmailsSentRequest' when calling createEmails");
      }
     ...
     */
    createEmails(createEmailsSentRequest) {
      return this.createEmailsWithHttpInfo(createEmailsSentRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:keap.core.v2/model/DeleteEmailsRequest} deleteEmailsRequest 
    ...
    deleteEmailsWithHttpInfo(deleteEmailsRequest) {
      ...
      return this.apiClient.callApi(
        '/rest/v2/emails:batchRemove', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    getEmailTemplateWithHttpInfo(emailTemplateId) {
      ...
      return this.apiClient.callApi(
        '/rest/v2/emails/templates/{email_template_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {String} [filter] Filter to apply, allowed fields are: - (String) contact_id - (String) email - (String) start_created_time - (String) end_created_time 
     * @param {String} [orderBy] Attribute and direction to order items. One of the following fields: - `created_time`  One of the following directions: - `asc` - `desc`
     * @param {Number} [pageSize] Total number of items to return per page
     * @param {String} [pageToken] Page token
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.core.v2/model/ListEmailsSentResponse} and HTTP response
     */
    listEmailsWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ListEmailsSentResponse;
      return this.apiClient.callApi(
        '/rest/v2/emails', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
     ...
     * Retrieves a list of emails that have been sent
     * @param {Object} opts Optional parameters
     * @param {String} opts.filter Filter to apply, allowed fields are: - (String) contact_id - (String) email - (String) start_created_time - (String) end_created_time 
     * @param {String} opts.orderBy Attribute and direction to order items. One of the following fields: - `created_time`  One of the following directions: - `asc` - `desc`
     * @param {Number} opts.pageSize Total number of items to return per page
     * @param {String} opts.pageToken Page token
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.core.v2/model/ListEmailsSentResponse}
     */
    listEmails(opts) {
      return this.listEmailsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:keap.core.v2/model/EmailSendRequest} emailSendRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    sendEmailWithHttpInfo(emailSendRequest) {
      let postBody = emailSendRequest;
      // verify the required parameter 'emailSendRequest' is set
      if (emailSendRequest === undefined || emailSendRequest === null) {
        throw new Error("Missing the required parameter 'emailSendRequest' when calling sendEmail");
      }
    ...
    sendEmail(emailSendRequest) {
      return this.sendEmailWithHttpInfo(emailSendRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * Send an email based on a template
     * @param {module:keap.core.v2/model/EmailSendTemplateRequest} emailSendTemplateRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    sendEmailTemplateWithHttpInfo(emailSendTemplateRequest) {
      let postBody = emailSendTemplateRequest;
      // verify the required parameter 'emailSendTemplateRequest' is set
      if (emailSendTemplateRequest === undefined || emailSendTemplateRequest === null) {
        throw new Error("Missing the required parameter 'emailSendTemplateRequest' when calling sendEmailTemplate");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/rest/v2/emails/templates:send', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    sendEmailTemplate(emailSendTemplateRequest) {
      return this.sendEmailTemplateWithHttpInfo(emailSendTemplateRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
