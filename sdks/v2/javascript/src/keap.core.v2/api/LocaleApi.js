    ...
    */
    ...
    getCountryByCodeWithHttpInfo(countryCode) {
      ...
      return this.apiClient.callApi(
        '/rest/v2/locales/countries/{country_code}', 'GET',
    ...
    getProvinceByCodeWithHttpInfo(countryCode, provinceCode) {
      ...
      return this.apiClient.callApi(
        '/rest/v2/locales/countries/{country_code}/provinces/{province_code}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    listProvincesForCountryWithHttpInfo(countryCode) {
      ...
      return this.apiClient.callApi(
        '/rest/v2/locales/countries/{country_code}/provinces', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
