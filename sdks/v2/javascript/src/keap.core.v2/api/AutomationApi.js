    ...
    */
    ...
    bulkAssignmentAutomationsCategoriesUsingPOSTWithHttpInfo(assignAutomationCategoryRequest) {
      ...
      if (assignAutomationCategoryRequest === undefined || assignAutomationCategoryRequest === null) {
        throw new Error("Missing the required parameter 'assignAutomationCategoryRequest' when calling bulkAssignmentAutomationsCategoriesUsingPOST");
      }
    ...
    bulkAssignmentAutomationsCategoriesUsingPOST(assignAutomationCategoryRequest) {
      return this.bulkAssignmentAutomationsCategoriesUsingPOSTWithHttpInfo(assignAutomationCategoryRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
