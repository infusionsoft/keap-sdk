...
**customFields** | [**[CustomFieldValueObject]**](CustomFieldValueObject.md) | Custom field values for the note. An empty array resets all custom fields to their defaults. | [optional] 
