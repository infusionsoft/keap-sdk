# KeapCoreServiceV2Sdk.CreateSubscriptionRequestDetail
...
**startDate** | **Date** | The first day the subscription will bill. Must not be in the past. Default is today. | [optional] 
