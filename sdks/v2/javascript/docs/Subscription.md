...
**modificationTime** | **Date** | The date and time the subscription was last modified. | [optional] 
**customFields** | [**[CustomFieldValue]**](CustomFieldValue.md) | List of custom field values applied to this subscription | [optional] 
