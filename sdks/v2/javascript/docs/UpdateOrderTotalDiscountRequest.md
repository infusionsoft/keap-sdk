# KeapCoreServiceV2Sdk.UpdateOrderTotalDiscountRequest
...
**criteria** | [**[UpdateOrderTotalDiscountCriteria]**](UpdateOrderTotalDiscountCriteria.md) | List of criteria that must be met for this discount to apply | [optional] 
