# KeapCoreServiceV2Sdk.UpdateShippingDiscountRequest
...
**criteria** | [**[UpdateShippingDiscountCriteria]**](UpdateShippingDiscountCriteria.md) | List of criteria that must be met for this discount to apply | [optional] 
