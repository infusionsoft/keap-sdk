# KeapCoreServiceV2Sdk.UpdateProductDiscountRequest
...
**criteria** | [**[UpdateProductDiscountCriteria]**](UpdateProductDiscountCriteria.md) | List of criteria that must be met for this discount to apply | [optional] 
