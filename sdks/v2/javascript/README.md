...
*KeapCoreServiceV2Sdk.CustomFieldsApi* | [**updateCustomField**](docs/CustomFieldsApi.md#updateCustomField) | **PATCH** /v2/customFields/{id} | Updates a custom field
...
*KeapCoreServiceV2Sdk.DealsApi* | [**getDeal**](docs/DealsApi.md#getDeal) | **GET** /v2/deals/{id} | Retrieves a specific deal by its ID.
...
*KeapCoreServiceV2Sdk.DealsApi* | [**moveDealsForContacts**](docs/DealsApi.md#moveDealsForContacts) | **POST** /v2/deals/moveByContactIds | Moves the active deals of specified contacts from one stage to another, in bulk.
...
*KeapCoreServiceV2Sdk.DisplayFormsApi* | [**getDisplayForm**](docs/DisplayFormsApi.md#getDisplayForm) | **GET** /v2/pipelines/{id}/form | Retrieves a specific display form by a pipeline ID.
*KeapCoreServiceV2Sdk.DisplayFormsApi* | [**updateDisplayForm**](docs/DisplayFormsApi.md#updateDisplayForm) | **PATCH** /v2/pipelines/{id}/form | Updates a display form
...
*KeapCoreServiceV2Sdk.FreeTrialDiscountsApi* | [**createDiscountUsingPOST1**](docs/FreeTrialDiscountsApi.md#createDiscountUsingPOST1) | **POST** /v2/discounts/freeTrials | Create a Subscription Free Trial Discount
*KeapCoreServiceV2Sdk.FreeTrialDiscountsApi* | [**deleteDiscountUsingDELETE1**](docs/FreeTrialDiscountsApi.md#deleteDiscountUsingDELETE1) | **DELETE** /v2/discounts/freeTrials/{discount_id} | Delete a Subscription Free Trial Discount
*KeapCoreServiceV2Sdk.FreeTrialDiscountsApi* | [**getDiscountUsingGET1**](docs/FreeTrialDiscountsApi.md#getDiscountUsingGET1) | **GET** /v2/discounts/freeTrials/{discount_id} | Retrieve a Subscription Free Trial Discount
*KeapCoreServiceV2Sdk.FreeTrialDiscountsApi* | [**listFreeTrialsUsingGET**](docs/FreeTrialDiscountsApi.md#listFreeTrialsUsingGET) | **GET** /v2/discounts/freeTrials | List all Subscription Free Trial Discounts
*KeapCoreServiceV2Sdk.FreeTrialDiscountsApi* | [**updateDiscountUsingPATCH1**](docs/FreeTrialDiscountsApi.md#updateDiscountUsingPATCH1) | **PATCH** /v2/discounts/freeTrials/{discount_id} | Update a Subscription Free Trial Discount
...
*KeapCoreServiceV2Sdk.OrderTotalDiscountsApi* | [**createOrderTotalDiscountUsingPOST**](docs/OrderTotalDiscountsApi.md#createOrderTotalDiscountUsingPOST) | **POST** /v2/discounts/orderTotals | Create an Order Total Discount
*KeapCoreServiceV2Sdk.OrderTotalDiscountsApi* | [**deleteOrderTotalDiscountUsingDELETE**](docs/OrderTotalDiscountsApi.md#deleteOrderTotalDiscountUsingDELETE) | **DELETE** /v2/discounts/orderTotals/{discount_id} | Delete an Order Total Discount
*KeapCoreServiceV2Sdk.OrderTotalDiscountsApi* | [**getOrderTotalDiscountUsingGET**](docs/OrderTotalDiscountsApi.md#getOrderTotalDiscountUsingGET) | **GET** /v2/discounts/orderTotals/{discount_id} | Retrieve an Order Total Discount
*KeapCoreServiceV2Sdk.OrderTotalDiscountsApi* | [**listOrderTotalDiscountsUsingGET**](docs/OrderTotalDiscountsApi.md#listOrderTotalDiscountsUsingGET) | **GET** /v2/discounts/orderTotals | List all Order Total Discounts
*KeapCoreServiceV2Sdk.OrderTotalDiscountsApi* | [**updateOrderTotalDiscountUsingPATCH**](docs/OrderTotalDiscountsApi.md#updateOrderTotalDiscountUsingPATCH) | **PATCH** /v2/discounts/orderTotals/{discount_id} | Update an Order Total Discount
...
*KeapCoreServiceV2Sdk.ProductDiscountsApi* | [**createDiscountUsingPOST2**](docs/ProductDiscountsApi.md#createDiscountUsingPOST2) | **POST** /v2/discounts/products | Create a Product Discount
*KeapCoreServiceV2Sdk.ProductDiscountsApi* | [**deleteDiscountUsingDELETE2**](docs/ProductDiscountsApi.md#deleteDiscountUsingDELETE2) | **DELETE** /v2/discounts/products/{discount_id} | Delete a Product Discount
*KeapCoreServiceV2Sdk.ProductDiscountsApi* | [**getDiscountUsingGET2**](docs/ProductDiscountsApi.md#getDiscountUsingGET2) | **GET** /v2/discounts/products/{discount_id} | Retrieve a Product Discount
*KeapCoreServiceV2Sdk.ProductDiscountsApi* | [**listDiscountsUsingGET**](docs/ProductDiscountsApi.md#listDiscountsUsingGET) | **GET** /v2/discounts/products | List all Product Discounts
*KeapCoreServiceV2Sdk.ProductDiscountsApi* | [**updateDiscountUsingPATCH2**](docs/ProductDiscountsApi.md#updateDiscountUsingPATCH2) | **PATCH** /v2/discounts/products/{discount_id} | Update a Product Discount
...
*KeapCoreServiceV2Sdk.ShippingDiscountsApi* | [**createDiscountUsingPOST3**](docs/ShippingDiscountsApi.md#createDiscountUsingPOST3) | **POST** /v2/discounts/shipping | Create a Shipping Discount
*KeapCoreServiceV2Sdk.ShippingDiscountsApi* | [**deleteDiscountUsingDELETE3**](docs/ShippingDiscountsApi.md#deleteDiscountUsingDELETE3) | **DELETE** /v2/discounts/shipping/{discount_id} | Delete a Shipping Discount
*KeapCoreServiceV2Sdk.ShippingDiscountsApi* | [**getDiscountUsingGET3**](docs/ShippingDiscountsApi.md#getDiscountUsingGET3) | **GET** /v2/discounts/shipping/{discount_id} | Retrieve a Shipping Discount
*KeapCoreServiceV2Sdk.ShippingDiscountsApi* | [**listDiscountsUsingGET1**](docs/ShippingDiscountsApi.md#listDiscountsUsingGET1) | **GET** /v2/discounts/shipping | List all Shipping Discounts
*KeapCoreServiceV2Sdk.ShippingDiscountsApi* | [**updateDiscountUsingPATCH3**](docs/ShippingDiscountsApi.md#updateDiscountUsingPATCH3) | **PATCH** /v2/discounts/shipping/{discount_id} | Update a Shipping Discount
...
## Documentation for Models
 ...
 - [KeapCoreServiceV2Sdk.BaseListResponsePipelineCustomField](docs/BaseListResponsePipelineCustomField.md)
 ...
 - [KeapCoreServiceV2Sdk.MoveDealsForContactsRequest](docs/MoveDealsForContactsRequest.md)
 - [KeapCoreServiceV2Sdk.MoveDealsForContactsResponse](docs/MoveDealsForContactsResponse.md)
