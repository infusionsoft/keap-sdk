...
namespace Example
{
    public class CreateLeadSourceRecurringExpenseExample
    {
        public static void Main()
        {
            ...
            var createLeadSourceRecurringExpenseRequest = new CreateLeadSourceRecurringExpenseRequest(); // CreateLeadSourceRecurringExpenseRequest | 
...
namespace Example
{
    public class ListLeadSourceRecurringExpensesExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new LeadSourceRecurringExpensesApi(config);
            var leadSourceId = -;  // string | The ID of the lead source this recurring expense belongs to. Use '-' as a wildcard to list recurring expenses across all lead sources.
