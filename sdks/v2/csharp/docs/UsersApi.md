...
namespace Example
{
    public class ListPaginatedUsersExample
    {
        public static void Main()
        {
            ...
            var orderBy = "orderBy_example";  // string? | Attribute and direction to order items. One of the following fields: - `create_time` - `email` - `name` (sorts by family name / last name; uses User ID as tiebreaker for stable pagination)  One of the following directions: - `asc` - `desc` (optional) 
...
<a id="updateuser"></a>
# **UpdateUser**
> User UpdateUser (string userId, UpdateUserRequest updateUserRequest, List<string>? updateMask = null)
