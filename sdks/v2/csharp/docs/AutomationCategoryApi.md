...
namespace Example
{
    public class CreateCategoryExample
    {
        public static void Main()
        {
            ...
            var createAutomationCategoryRequest = new CreateAutomationCategoryRequest(); // CreateAutomationCategoryRequest | 
...
namespace Example
{
    public class PatchCategoryExample
    {
        public static void Main()
        {
            ...
            var patchAutomationCategoryRequest = new PatchAutomationCategoryRequest(); // PatchAutomationCategoryRequest | 
