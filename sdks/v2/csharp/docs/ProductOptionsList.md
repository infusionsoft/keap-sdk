# Keap.Core.V2.Model.ProductOptionsList
...
**FixedOptions** | [**List&lt;ProductFixedOptionList&gt;**](ProductFixedOptionList.md) | List of option values for the fixed option | [optional] 
