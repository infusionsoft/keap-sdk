...
**CreateTime** | **DateTime** | When the user was created, in ISO-8601 format | [optional] 
**UpdatedBy** | **long** | ID of the user who last updated this user | [optional] 
**UpdateTime** | **DateTime** | When the user was last updated, in ISO-8601 format | [optional] 
