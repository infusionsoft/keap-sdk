...
namespace Keap.Core.V2.Api
{
    ...
    public partial class SettingsApi : ISettingsApi
    {
        ...
        public Keap.Core.V2.Client.ApiResponse<GetSettingsResponse> GetApplicationConfigurationsWithHttpInfo(Object? fields = default, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<GetSettingsResponse>("/rest/v2/settings/applications:getConfiguration", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<GetSettingsResponse>> GetApplicationConfigurationsWithHttpInfoAsync(Object? fields = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetSettingsResponse>("/rest/v2/settings/applications:getConfiguration", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<GetContactOptionTypesResponse> GetContactOptionTypesWithHttpInfo(int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetContactOptionTypesResponse>("/rest/v2/settings/contactOptionTypes", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<GetContactOptionTypesResponse>> GetContactOptionTypesWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetContactOptionTypesResponse>("/rest/v2/settings/contactOptionTypes", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<GetApplicationEnabledStatusResponse> IsApplicationEnabledWithHttpInfo(int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetApplicationEnabledStatusResponse>("/rest/v2/settings/applications:isEnabled", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<GetApplicationEnabledStatusResponse>> IsApplicationEnabledWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetApplicationEnabledStatusResponse>("/rest/v2/settings/applications:isEnabled", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
