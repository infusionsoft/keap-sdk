...
namespace Keap.Core.V2.Api
{
    ...
    public interface ISubscriptionPlansApiSync : IApiAccessor
    {
        ...
        /// <param name="createSubscriptionPlanRequest"></param>
        ...
        /// <param name="productId">product_id</param>
        /// <param name="subscriptionPlanId">subscription_plan_id</param>
        /// <param name="updateSubscriptionPlanRequest"></param>
    ...
    public partial class SubscriptionPlansApi : ISubscriptionPlansApi
    {
        ...
        public Keap.Core.V2.Client.ApiResponse<SubscriptionPlan> CreateSubscriptionPlansWithHttpInfo(string productId, CreateSubscriptionPlanRequest createSubscriptionPlanRequest, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<SubscriptionPlan>("/rest/v2/products/{product_id}/subscriptions", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<SubscriptionPlan>> CreateSubscriptionPlansWithHttpInfoAsync(string productId, CreateSubscriptionPlanRequest createSubscriptionPlanRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<SubscriptionPlan>("/rest/v2/products/{product_id}/subscriptions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<Object> DeleteSubscriptionPlanWithHttpInfo(string productId, string subscriptionPlanId, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/rest/v2/products/{product_id}/subscriptions/{subscription_plan_id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<Object>> DeleteSubscriptionPlanWithHttpInfoAsync(string productId, string subscriptionPlanId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/rest/v2/products/{product_id}/subscriptions/{subscription_plan_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<SubscriptionPlan> FetchSubscriptionPlanWithHttpInfo(string productId, string subscriptionPlanId, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<SubscriptionPlan>("/rest/v2/products/{product_id}/subscriptions/{subscription_plan_id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<SubscriptionPlan>> FetchSubscriptionPlanWithHttpInfoAsync(string productId, string subscriptionPlanId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<SubscriptionPlan>("/rest/v2/products/{product_id}/subscriptions/{subscription_plan_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<ListSubscriptionPlansResponse> ListSubscriptionPlansWithHttpInfo(string productId, string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ListSubscriptionPlansResponse>("/rest/v2/products/{product_id}/subscriptions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<ListSubscriptionPlansResponse>> ListSubscriptionPlansWithHttpInfoAsync(string productId, string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListSubscriptionPlansResponse>("/rest/v2/products/{product_id}/subscriptions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<SubscriptionPlan> UpdateSubscriptionPlanWithHttpInfo(string productId, string subscriptionPlanId, UpdateSubscriptionPlanRequest updateSubscriptionPlanRequest, Object? updateMask = default, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Patch<SubscriptionPlan>("/rest/v2/products/{product_id}/subscriptions/{subscription_plan_id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<SubscriptionPlan>> UpdateSubscriptionPlanWithHttpInfoAsync(string productId, string subscriptionPlanId, UpdateSubscriptionPlanRequest updateSubscriptionPlanRequest, Object? updateMask = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<SubscriptionPlan>("/rest/v2/products/{product_id}/subscriptions/{subscription_plan_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
