...
namespace Keap.Core.V2.Api
{
    ...
    public interface ISalesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task SetMerchantGatewayAsDefaultUsingPOSTAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> SetMerchantGatewayAsDefaultUsingPOSTWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class SalesApi : ISalesApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task SetMerchantGatewayAsDefaultUsingPOSTAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<Object>> SetMerchantGatewayAsDefaultUsingPOSTWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
