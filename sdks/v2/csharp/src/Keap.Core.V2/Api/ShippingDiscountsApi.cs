...
namespace Keap.Core.V2.Api
{
    ...
    public interface IShippingDiscountsApiSync : IApiAccessor
    {
        ...
        /// <param name="createShippingDiscountRequest"></param>
        ...
        /// <exception cref="Keap.Core.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="discountId"></param>
        /// <param name="updateShippingDiscountRequest"></param>
    ...
    public partial class ShippingDiscountsApi : IShippingDiscountsApi
    {
        ...
        public Keap.Core.V2.Client.ApiResponse<ShippingDiscount> CreateShippingDiscountWithHttpInfo(CreateShippingDiscountRequest createShippingDiscountRequest, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<ShippingDiscount>("/rest/v2/discounts/shipping", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<ShippingDiscount>> CreateShippingDiscountWithHttpInfoAsync(CreateShippingDiscountRequest createShippingDiscountRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ShippingDiscount>("/rest/v2/discounts/shipping", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<Object> DeleteShippingDiscountWithHttpInfo(string discountId, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/rest/v2/discounts/shipping/{discount_id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<Object>> DeleteShippingDiscountWithHttpInfoAsync(string discountId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/rest/v2/discounts/shipping/{discount_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<ShippingDiscount> GetShippingDiscountWithHttpInfo(string discountId, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ShippingDiscount>("/rest/v2/discounts/shipping/{discount_id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<ShippingDiscount>> GetShippingDiscountWithHttpInfoAsync(string discountId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ShippingDiscount>("/rest/v2/discounts/shipping/{discount_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<ListShippingDiscountsResponse> ListShippingDiscountsWithHttpInfo(string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ListShippingDiscountsResponse>("/rest/v2/discounts/shipping", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<ListShippingDiscountsResponse>> ListShippingDiscountsWithHttpInfoAsync(string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListShippingDiscountsResponse>("/rest/v2/discounts/shipping", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<ShippingDiscount> UpdateShippingDiscountWithHttpInfo(string discountId, UpdateShippingDiscountRequest updateShippingDiscountRequest, string? updateMask = default, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Patch<ShippingDiscount>("/rest/v2/discounts/shipping/{discount_id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<ShippingDiscount>> UpdateShippingDiscountWithHttpInfoAsync(string discountId, UpdateShippingDiscountRequest updateShippingDiscountRequest, string? updateMask = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<ShippingDiscount>("/rest/v2/discounts/shipping/{discount_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
