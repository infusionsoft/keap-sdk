...
namespace Keap.Core.V2.Api
{
    ...
    public interface ITaskApiSync : IApiAccessor
    {
        ...
        ListTasksResponse ListTasks(string? endDueTime = default, string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, string? startDueTime = default, int operationIndex = 0);
        ...
        ApiResponse<ListTasksResponse> ListTasksWithHttpInfo(string? endDueTime = default, string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, string? startDueTime = default, int operationIndex = 0);
        /// <summary>
        /// Retrieve Task Model
        /// </summary>
        /// <remarks>
    ...
    public interface ITaskApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ListTasksResponse> ListTasksAsync(string? endDueTime = default, string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, string? startDueTime = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<ListTasksResponse>> ListTasksWithHttpInfoAsync(string? endDueTime = default, string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, string? startDueTime = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Retrieve Task Model
        /// </summary>
        /// <remarks>
    ...
    public partial class TaskApi : ITaskApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ListTasksResponse</returns>
        public ListTasksResponse ListTasks(string? endDueTime = default, string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, string? startDueTime = default, int operationIndex = 0)
        {
            Keap.Core.V2.Client.ApiResponse<ListTasksResponse> localVarResponse = ListTasksWithHttpInfo(endDueTime, filter, orderBy, pageSize, pageToken, startDueTime);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ListTasksResponse</returns>
        public Keap.Core.V2.Client.ApiResponse<ListTasksResponse> ListTasksWithHttpInfo(string? endDueTime = default, string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, string? startDueTime = default, int operationIndex = 0)
        {
            Keap.Core.V2.Client.RequestOptions localVarRequestOptions = new Keap.Core.V2.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ListTasksResponse</returns>
        public async System.Threading.Tasks.Task<ListTasksResponse> ListTasksAsync(string? endDueTime = default, string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, string? startDueTime = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            Keap.Core.V2.Client.ApiResponse<ListTasksResponse> localVarResponse = await ListTasksWithHttpInfoAsync(endDueTime, filter, orderBy, pageSize, pageToken, startDueTime, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListTasksResponse)</returns>
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<ListTasksResponse>> ListTasksWithHttpInfoAsync(string? endDueTime = default, string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, string? startDueTime = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
