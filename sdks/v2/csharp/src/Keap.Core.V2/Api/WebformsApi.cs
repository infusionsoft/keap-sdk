...
namespace Keap.Core.V2.Api
{
    ...
    public interface IWebformsApiSync : IApiAccessor
    {
        ...
        string GetHtml(string webformId, int operationIndex = 0);
        ...
        ApiResponse<string> GetHtmlWithHttpInfo(string webformId, int operationIndex = 0);
        /// <summary>
    ...
    public interface IWebformsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<string> GetHtmlAsync(string webformId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> GetHtmlWithHttpInfoAsync(string webformId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// List Webforms with filter
        /// </summary>
        /// <remarks>
    ...
    public partial class WebformsApi : IWebformsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>string</returns>
        public string GetHtml(string webformId, int operationIndex = 0)
        {
            Keap.Core.V2.Client.ApiResponse<string> localVarResponse = GetHtmlWithHttpInfo(webformId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of string</returns>
        public Keap.Core.V2.Client.ApiResponse<string> GetHtmlWithHttpInfo(string webformId, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<string>("/rest/v2/webforms/{webform_id}:data", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> GetHtmlAsync(string webformId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            Keap.Core.V2.Client.ApiResponse<string> localVarResponse = await GetHtmlWithHttpInfoAsync(webformId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<string>> GetHtmlWithHttpInfoAsync(string webformId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'webformId' is set
            if (webformId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<string>("/rest/v2/webforms/{webform_id}:data", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Keap.Core.V2.Client.ApiResponse<ListWebformsResponse> ListWebformsWithHttpInfo(string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ListWebformsResponse>("/rest/v2/webforms", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<ListWebformsResponse>> ListWebformsWithHttpInfoAsync(string? filter = default, string? orderBy = default, int? pageSize = default, string? pageToken = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListWebformsResponse>("/rest/v2/webforms", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
