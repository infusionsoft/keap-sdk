...
namespace Keap.Core.V2.Api
{
    ...
    public interface ITagsApiSync : IApiAccessor
    {
        ...
        /// <param name="pageToken">Page token (optional)</param>
        /// <param name="orderBy">Attribute and direction to order items (best-effort for cross-collection reads). Field: - &#x60;applied_time&#x60;  Direction: - &#x60;asc&#x60; - &#x60;desc&#x60; (optional)</param>
        /// <param name="pageSize">Total number of items to return per page (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
    ...
    public partial class TagsApi : ITagsApi
    {
        ...
        /// <summary>
        /// List Contacts Across Tags Retrieves tag-contact associations across the tag collection (AEP-159), using the &#x60;-&#x60; wildcard in place of a single tag id. At least one filter is required. Returns association tuples (contact_id, tag_id, applied_at) only.
        /// </summary>
        /// <exception cref="Keap.Core.V2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filter">Filter to apply (at least one is required). Allowed fields: - (List[String]) &#x60;tag_ids&#x60; (max 100) - (ISO-8601) &#x60;since_applied_time&#x60; - (ISO-8601) &#x60;until_applied_time&#x60;  (optional)</param>
        /// <param name="pageToken">Page token (optional)</param>
