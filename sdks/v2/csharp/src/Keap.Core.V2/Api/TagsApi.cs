...
namespace Keap.Core.V2.Api
{
    ...
    public interface ITagsApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Tag</returns>
        Tag CreateTagCategory(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tag</returns>
        ApiResponse<Tag> CreateTagCategoryWithHttpInfo(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest, int operationIndex = 0);
        /// <summary>
        /// Delete Tag
        /// </summary>
        /// <remarks>
    ...
    public interface ITagsApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Tag</returns>
        System.Threading.Tasks.Task<Tag> CreateTagCategoryAsync(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Tag)</returns>
        System.Threading.Tasks.Task<ApiResponse<Tag>> CreateTagCategoryWithHttpInfoAsync(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Delete Tag
        /// </summary>
        /// <remarks>
    ...
    public partial class TagsApi : ITagsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Tag</returns>
        public Tag CreateTagCategory(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest, int operationIndex = 0)
        {
            Keap.Core.V2.Client.ApiResponse<Tag> localVarResponse = CreateTagCategoryWithHttpInfo(createUpdateTagCategoryRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tag</returns>
        public Keap.Core.V2.Client.ApiResponse<Tag> CreateTagCategoryWithHttpInfo(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest, int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Tag</returns>
        public async System.Threading.Tasks.Task<Tag> CreateTagCategoryAsync(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            Keap.Core.V2.Client.ApiResponse<Tag> localVarResponse = await CreateTagCategoryWithHttpInfoAsync(createUpdateTagCategoryRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Tag)</returns>
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<Tag>> CreateTagCategoryWithHttpInfoAsync(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'createUpdateTagCategoryRequest' is set
            if (createUpdateTagCategoryRequest == null)
            {
