...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ShippingDiscount : IValidatableObject
    {
        ...
        */
        ...
        /// </summary>
        /// <param name="id">Unique identifier for this shipping discount.</param>
        ...
        public ShippingDiscount(string id = default, string name = default, string description = default, List<DiscountCriteria> criteria = default, DiscountTypeEnum? discountType = default, double discountValue = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        /// </summary>
        /// <value>Unique identifier for this shipping discount</value>
        /*
        <example>105</example>
        */
