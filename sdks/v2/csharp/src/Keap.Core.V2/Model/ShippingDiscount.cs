...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ShippingDiscount : IValidatableObject
    {
        ...
        public ShippingDiscount(List<DiscountCriteria> criteria = default, string description = default, DiscountTypeEnum? discountType = default, double discountValue = default, string id = default, string name = default)
        {
