...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateTagResponse : IValidatableObject
    {
        ...
        public UpdateTagResponse(CategoryReference category = default, string createTime = default, string description = default, string id = default, string name = default, string updateTime = default)
        {
