...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateTagResponse : IValidatableObject
    {
        ...
        public UpdateTagResponse(string id = default, string name = default, string description = default, CategoryReference category = default, DateTime createTime = default, DateTime updateTime = default)
        {
            this.Id = id;
            this.Name = name;
