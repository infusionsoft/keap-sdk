...
namespace Keap.Core.V2.Model
{
    ...
    public partial class AffiliateProgramV2 : IValidatableObject
    {
        ...
        public AffiliateProgramV2(string affiliateId = default, string createTime = default, DefaultCommission defaultCommission = default, string id = default, string name = default, string notes = default, string priority = default, List<ProductCommission> productCommissions = default, List<SubscriptionCommission> subscriptionCommissions = default)
        {
