...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ListAffiliateCommissionsResponse : IValidatableObject
    {
        ...
        public ListAffiliateCommissionsResponse(List<AffiliateCommission> affiliateCommissions = default, string nextPageToken = default, double totalAffCommEarned = default, double totalClawBack = default, double totalCommEarned = default)
        {
