...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductCommission : IValidatableObject
    {
        ...
        public ProductCommission(double dollarAmount = default, double percentage = default, string productId = default, string productName = default, double productPrice = default)
        {
