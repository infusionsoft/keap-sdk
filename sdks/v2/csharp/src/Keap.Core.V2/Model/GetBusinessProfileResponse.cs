...
namespace Keap.Core.V2.Model
{
    ...
    public partial class GetBusinessProfileResponse : IValidatableObject
    {
        ...
        public GetBusinessProfileResponse(string name = default, string email = default, string website = default, string phone = default, BusinessProfileAddressResponse address = default, string varTimeZone = default, string logoUrl = default, string currencyCode = default, string languageTag = default, string businessType = default, List<string> businessGoals = default, string businessPrimaryColor = default, string businessSecondaryColor = default)
        {
            this.Name = name;
            this.Email = email;
