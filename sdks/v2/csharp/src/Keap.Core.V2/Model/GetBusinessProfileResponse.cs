...
namespace Keap.Core.V2.Model
{
    ...
    public partial class GetBusinessProfileResponse : IValidatableObject
    {
        ...
        public GetBusinessProfileResponse(BusinessProfileAddressResponse address = default, List<string> businessGoals = default, string businessPrimaryColor = default, string businessSecondaryColor = default, string businessType = default, string currencyCode = default, string email = default, string languageTag = default, string logoUrl = default, string name = default, string phone = default, string varTimeZone = default, string website = default)
        {
