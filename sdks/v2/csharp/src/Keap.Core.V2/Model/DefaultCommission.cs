...
namespace Keap.Core.V2.Model
{
    ...
    public partial class DefaultCommission : IValidatableObject
    {
        ...
        */
        ...
        public DefaultCommission(PayoutTypeEnum? payoutType = PayoutTypeEnum.UPFRONT, double dollarAmount = default, double percentage = default, CommissionItem unused = default, CommissionItem level1 = default, CommissionItem level2 = default)
        {
