...
namespace Keap.Core.V2.Model
{
    ...
    public partial class EmailSent : IValidatableObject
    {
        ...
        public EmailSent(string clickedTime = default, string contactId = default, string headers = default, string id = default, string openedTime = default, OriginalProviderEnum? originalProvider = default, string originalProviderId = default, string providerSourceId = default, string receivedTime = default, string sentFromAddress = default, string sentFromReplyAddress = default, string sentTime = default, string sentToAddress = default, List<string> sentToBccAddressList = default, List<string> sentToCcAddressList = default, string subject = default)
        {
