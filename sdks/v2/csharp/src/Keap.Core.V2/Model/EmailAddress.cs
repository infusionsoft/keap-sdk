...
namespace Keap.Core.V2.Model
{
    ...
    public partial class EmailAddress : IValidatableObject
    {
        ...
        */
        ...
        public EmailAddress(string email = default, FieldEnum? field = default, string optInReason = default, bool isOptIn = default, EmailOptStatusEnum? emailOptStatus = default)
        {
            this.Email = email;
            this.Field = field;
