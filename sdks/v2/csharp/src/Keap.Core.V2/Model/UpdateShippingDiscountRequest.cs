...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateShippingDiscountRequest : IValidatableObject
    {
        ...
        public UpdateShippingDiscountRequest(List<DiscountCriteria> criteria = default, string description = default, DiscountTypeEnum? discountType = default, double discountValue = default, string name = default)
        {
