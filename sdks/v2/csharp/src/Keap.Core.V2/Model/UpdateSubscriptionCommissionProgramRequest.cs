...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateSubscriptionCommissionProgramRequest : IValidatableObject
    {
        ...
        */
        ...
        public UpdateSubscriptionCommissionProgramRequest(string percentage = default, CommissionItemRequest unused = default, string dollarAmount = default, CommissionItemRequest level1 = default, CommissionItemRequest level2 = default, PayoutTypeEnum? payoutType = PayoutTypeEnum.UPFRONT, string subscriptionId = default)
        {
