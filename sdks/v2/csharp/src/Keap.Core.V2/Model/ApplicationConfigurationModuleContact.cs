...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ApplicationConfigurationModuleContact : IValidatableObject
    {
        ...
        public ApplicationConfigurationModuleContact(ApplicationConfigurationModuleContactAddressLabels addressLabels = default, string contactTypes = default, string defaultNewContactForm = default, bool disableContactEditInClientLogin = default, string faxTypes = default, string phoneTypes = default, string suffixTypes = default, string titleTypes = default)
        {
