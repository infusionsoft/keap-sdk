...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ApplicationConfigurationModuleContact : IValidatableObject
    {
        ...
        public ApplicationConfigurationModuleContact(string titleTypes = default, string suffixTypes = default, string contactTypes = default, string phoneTypes = default, string faxTypes = default, ApplicationConfigurationModuleContactAddressLabels addressLabels = default, bool disableContactEditInClientLogin = default, string defaultNewContactForm = default)
        {
