...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateOrUpdateAffiliateLinkRequest : IValidatableObject
    {
        ...
        public CreateOrUpdateAffiliateLinkRequest(string affiliateId = default, string code = default, string name = default, List<string> programIds = default, string websiteAddress = default)
        {
