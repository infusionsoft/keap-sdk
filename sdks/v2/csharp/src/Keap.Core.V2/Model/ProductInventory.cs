...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductInventory : IValidatableObject
    {
        ...
        public ProductInventory(string emailForInventoryNotifications = default, int inventoryCount = default, int inventoryLimit = default, bool outOfStockEnabled = default)
        {
