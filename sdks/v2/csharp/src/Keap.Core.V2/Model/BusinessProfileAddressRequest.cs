...
namespace Keap.Core.V2.Model
{
    ...
    public partial class BusinessProfileAddressRequest : IValidatableObject
    {
        ...
        public BusinessProfileAddressRequest(string line1 = default, string line2 = default, string locality = default, string region = default, string countryCode = default, string postalCode = default)
        {
