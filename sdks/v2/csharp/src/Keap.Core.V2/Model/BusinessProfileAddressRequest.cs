...
namespace Keap.Core.V2.Model
{
    ...
    public partial class BusinessProfileAddressRequest : IValidatableObject
    {
        ...
        public BusinessProfileAddressRequest(string countryCode = default, string line1 = default, string line2 = default, string locality = default, string postalCode = default, string region = default)
        {
