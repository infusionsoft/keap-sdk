...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestAffiliate : IValidatableObject
    {
        ...
        */
        ...
        public RestAffiliate(string code = default, string contactId = default, string dateCreated = default, string id = default, string name = default, StatusEnum? status = default, string uniqueSiteId = default)
        {
            this.Code = code;
