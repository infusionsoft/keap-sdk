...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BulkCreateDealNoteResponse")]
    public partial class BulkCreateDealNoteResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkCreateDealNoteResponse" /> class.
        /// </summary>
        ...
        /// <param name="createSuccess">Indicates whether the note was created successfully..</param>
        /// <param name="errorMessage">If the note creation was not successful, this field contains the error message..</param>
        public BulkCreateDealNoteResponse(string id = default, string body = default, string dealId = default, string createdBy = default, DateTime createdTime = default, DateTime modifiedTime = default, bool createSuccess = default, string errorMessage = default)
        {
            this.Id = id;
            this.Body = body;
            this.DealId = dealId;
        ...
        /// </summary>
        /// <value>Unique identifier for the note.</value>
        ...
        /// </summary>
        /// <value>Indicates whether the note was created successfully.</value>
        [DataMember(Name = "create_success", EmitDefaultValue = true)]
        public bool CreateSuccess { get; set; }

        /// <summary>
        /// If the note creation was not successful, this field contains the error message.
        /// </summary>
        /// <value>If the note creation was not successful, this field contains the error message.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CreateSuccess: ").Append(CreateSuccess).Append("\n");
