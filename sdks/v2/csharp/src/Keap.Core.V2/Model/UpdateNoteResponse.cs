...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateNoteResponse : IValidatableObject
    {
        ...
        public UpdateNoteResponse(BasicUser assignedToUser = default, string contactId = default, string createTime = default, string createdByUserId = default, string id = default, string lastUpdatedByUserId = default, string pinnedAt = default, string text = default, string title = default, string type = default, string updateTime = default)
        {
