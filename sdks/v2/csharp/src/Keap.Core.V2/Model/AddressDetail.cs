...
namespace Keap.Core.V2.Model
{
    ...
    /// AddressDetail
    /// </summary>
    [DataContract(Name = "Address_Detail")]
    public partial class AddressDetail : IValidatableObject
    {
        /// <summary>
        /// Address type field
        /// </summary>
        ...
        */
        ...
        public AddressDetail(string country = default, string line1 = default, string line2 = default, string locality = default, string region = default, FieldEnum? field = default, string countryCode = default, string postalCode = default, string regionCode = default, string zipCode = default, string zipFour = default)
        {
