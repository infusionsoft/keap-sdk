...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateTaskRequest : IValidatableObject
    {
        ...
        public CreateTaskRequest(string assignedToUserId = default, bool completed = default, string completionTime = default, string contactId = default, string description = default, string dueTime = default, PriorityEnum? priority = default, int remindTimeMins = default, string title = default, string type = default)
        {
