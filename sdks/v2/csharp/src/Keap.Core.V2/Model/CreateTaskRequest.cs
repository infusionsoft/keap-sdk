...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateTaskRequest : IValidatableObject
    {
        ...
        */
        ...
        public CreateTaskRequest(string title = default, string description = default, string type = default, PriorityEnum? priority = default, bool completed = default, string completionTime = default, string dueTime = default, RemindTimeMinsEnum? remindTimeMins = default, string assignedToUserId = default, string contactId = default)
        {
