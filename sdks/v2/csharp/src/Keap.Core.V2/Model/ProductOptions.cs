...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductOptions : IValidatableObject
    {
        ...
        public ProductOptions(List<ProductFixedOption> fixedOptions = default, string name = default, bool required = default, TypeEnum? type = default, ProductVariableSetting variableSetting = default)
        {
