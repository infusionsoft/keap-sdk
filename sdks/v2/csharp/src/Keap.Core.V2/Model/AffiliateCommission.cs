...
namespace Keap.Core.V2.Model
{
    ...
    public partial class AffiliateCommission : IValidatableObject
    {
        ...
        public AffiliateCommission(long affOwedId = default, float amountEarned = default, string contactFirstName = default, long contactId = default, string contactLastName = default, DateTime dateEarned = default, string description = default, long invoiceId = default, string productName = default, long salesAffiliateId = default, string soldByFirstName = default, string soldByLastName = default)
        {
