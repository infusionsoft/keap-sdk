...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Error : IValidatableObject
    {
        ...
        public Error(Throwable cause = default, string localizedMessage = default, string message = default, List<StackTraceElement> stackTrace = default, List<Throwable> suppressed = default)
        {
            this.Cause = cause;
