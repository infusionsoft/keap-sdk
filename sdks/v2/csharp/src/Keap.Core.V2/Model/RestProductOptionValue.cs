...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestProductOptionValue : IValidatableObject
    {
        ...
        public RestProductOptionValue(string id = default, int index = default, bool isDefault = default, string label = default, double priceAdjustment = default, string sku = default)
        {
            this.Id = id;
            this.Index = index;
