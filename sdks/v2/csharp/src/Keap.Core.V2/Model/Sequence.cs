...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Sequence : IValidatableObject
    {
        ...
        public Sequence(int activeContactCount = default, int activeContactCountCompleted = default, HistoricalCounts historicalContactCount = default, string id = default, string name = default, List<SequencePath> paths = default)
        {
