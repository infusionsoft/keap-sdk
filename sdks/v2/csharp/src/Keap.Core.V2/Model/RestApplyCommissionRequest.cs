...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestApplyCommissionRequest : IValidatableObject
    {
        ...
        public RestApplyCommissionRequest(double commissionAmount = default, string commissionDate = default, string description = default, double payPercent = default, PayoutTypeEnum payoutType = default, string referralPartnerId = default)
        {
