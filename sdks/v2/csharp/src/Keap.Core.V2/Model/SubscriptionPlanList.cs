...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscriptionPlan_List")]
    public partial class SubscriptionPlanList : IValidatableObject
    {
        /// <summary>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionPlanList" /> class.
        /// </summary>
        ...
        public SubscriptionPlanList(string id = default, bool active = default, bool prorate = default, BillingCycleEnum? billingCycle = default, int billingFrequency = default, int numberOfCycles = default, CurrencyValueList planPrice = default, int orderIndex = default)
        {
            this.Id = id;
            this.Active = active;
        ...
        */
        ...
        public CurrencyValueList PlanPrice { get; set; }
