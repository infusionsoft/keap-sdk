...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ShippingInformation : IValidatableObject
    {
        ...
        public ShippingInformation(Address address = default(Address), string company = default(string), string familyName = default(string), string givenName = default(string), string id = default(string), bool invoiceToCompany = default(bool), string phoneNumber = default(string))
        {
