...
namespace Keap.Core.V2.Model
{
    ...
    public partial class SubscriptionPlanInterest : IValidatableObject
    {
        ...
        /// <param name="subscriptionPlanId">The ID of the Subscription Plan.</param>
        public SubscriptionPlanInterest(int discountPercent = default(int), string id = default(string), CurrencyValue price = default(CurrencyValue), int quantity = default(int), string subscriptionPlanId = default(string))
        {
