...
namespace Keap.Core.V2.Model
{
    ...
    public partial class AffiliateLink : IValidatableObject
    {
        ...
        public AffiliateLink(string affiliateId = default, string dateCreated = default, string id = default, string localUrlCode = default, string name = default, List<string> programIds = default, string redirectUrl = default)
        {
