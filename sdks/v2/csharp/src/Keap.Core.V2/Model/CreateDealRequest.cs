...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateDealRequest")]
    public partial class CreateDealRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDealRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateDealRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDealRequest" /> class.
        /// </summary>
        ...
        public CreateDealRequest(string name = default, Money value = default, List<DealContact> contacts = default, Stage stage = default, List<Owner> owners = default, string ownerId = default, List<string> taskIds = default, string status = default, DateTime? estimatedCloseTime = default, Dictionary<string, Object> customFields = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateDealRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CreateDealRequest and cannot be null");
            }
            this.Value = value;
            // to ensure "contacts" is required (not null)
            if (contacts == null)
            {
                throw new ArgumentNullException("contacts is a required property for CreateDealRequest and cannot be null");
            }
            this.Contacts = contacts;
            // to ensure "stage" is required (not null)
            if (stage == null)
            {
                throw new ArgumentNullException("stage is a required property for CreateDealRequest and cannot be null");
            }
            this.Stage = stage;
            // to ensure "owners" is required (not null)
            if (owners == null)
            {
                throw new ArgumentNullException("owners is a required property for CreateDealRequest and cannot be null");
            }
            this.Owners = owners;
            // to ensure "taskIds" is required (not null)
            if (taskIds == null)
            {
                throw new ArgumentNullException("taskIds is a required property for CreateDealRequest and cannot be null");
            }
            this.TaskIds = taskIds;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for CreateDealRequest and cannot be null");
            }
            this.Status = status;
