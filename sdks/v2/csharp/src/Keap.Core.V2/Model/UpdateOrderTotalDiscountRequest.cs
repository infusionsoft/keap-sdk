...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateOrderTotalDiscountRequest : IValidatableObject
    {
        ...
        public UpdateOrderTotalDiscountRequest(bool applyToCommissions = default, List<DiscountCriteria> criteria = default, string description = default, DiscountStrategyEnum? discountStrategy = default, DiscountTypeEnum? discountType = default, double discountValue = default, string name = default)
        {
