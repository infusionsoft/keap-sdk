...
namespace Keap.Core.V2.Model
{
    ...
    public partial class GetNoteResponse : IValidatableObject
    {
        ...
        public GetNoteResponse(string id = default, string text = default, string title = default, string type = default, string contactId = default, BasicUser assignedToUser = default, string createTime = default, string updateTime = default, string lastUpdatedByUserId = default, string pinnedAt = default, string createdByUserId = default, List<CustomFieldValueObject> customFields = default)
        {
            this.Id = id;
            this.Text = text;
            this.Title = title;
