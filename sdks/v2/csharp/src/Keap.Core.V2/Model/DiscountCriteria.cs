...
namespace Keap.Core.V2.Model
{
    ...
    public partial class DiscountCriteria : IValidatableObject
    {
        ...
        public DiscountCriteria(string code = default, string criteriaId = default, OperatorEnum? varOperator = default, string planId = default, string productId = default, int productQuantityMax = default, int productQuantityMin = default, string rangeEndTime = default, string rangeStartTime = default, int subscriptionQuantity = default, double totalAmount = default, TypeEnum? type = default)
        {
            this.Code = code;
