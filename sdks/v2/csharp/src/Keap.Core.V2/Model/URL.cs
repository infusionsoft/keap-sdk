...
namespace Keap.Core.V2.Model
{
    ...
    public partial class URL : IValidatableObject
    {
        ...
        public URL(string authority = default, Object content = default, int defaultPort = default, string file = default, string host = default, string path = default, int port = default, string protocol = default, string query = default, string varRef = default, string userInfo = default)
        {
