...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdatedPaymentPlan : IValidatableObject
    {
        ...
        public UpdatedPaymentPlan(bool autoCharge = default(bool), long daysBetweenPayments = default(long), long daysBetweenRetries = default(long), double initialPaymentAmount = default(double), string initialPaymentDate = default(string), long maxChargeAttempts = default(long), long numberOfPayments = default(long), string paymentMethodId = default(string), string planStartDate = default(string))
        {
