...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CardInfo : IValidatableObject
    {
        ...
        public CardInfo(string brand = default(string), CardTypeEnum? cardType = default(CardTypeEnum?), string expirationMonth = default(string), string expirationYear = default(string), string lastFour = default(string))
        {
            this.Brand = brand;
