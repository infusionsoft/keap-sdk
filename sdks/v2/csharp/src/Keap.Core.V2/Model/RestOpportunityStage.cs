...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestOpportunityStage : IValidatableObject
    {
        ...
        public RestOpportunityStage(List<ChecklistItem> checklistItems = default, string createdTime = default, string id = default, string name = default, int order = default, int probability = default, int targetNumberDays = default, string updatedTime = default)
        {
