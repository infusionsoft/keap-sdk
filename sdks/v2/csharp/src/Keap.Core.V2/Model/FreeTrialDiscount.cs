...
namespace Keap.Core.V2.Model
{
    ...
    public partial class FreeTrialDiscount : IValidatableObject
    {
        ...
        public FreeTrialDiscount(List<DiscountCriteria> criteria = default(List<DiscountCriteria>), string description = default(string), string discountId = default(string), int freeTrialDays = default(int), bool hidePrice = default(bool), string name = default(string), string subscriptionPlanId = default(string))
        {
