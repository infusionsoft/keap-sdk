...
namespace Keap.Core.V2.Model
{
    ...
    public partial class OpportunityContact : IValidatableObject
    {
        ...
        public OpportunityContact(string companyName = default, string email = default, string firstName = default, string id = default, string jobTitle = default, string lastName = default, string phoneNumber = default)
        {
