...
namespace Keap.Core.V2.Model
{
    ...
    public partial class GetSettingsResponse : IValidatableObject
    {
        ...
        public GetSettingsResponse(ApplicationConfigurationModuleAffiliate affiliate = default, ApplicationConfigurationModuleApplication application = default, ApplicationConfigurationModuleAppointment appointment = default, ApplicationConfigurationModuleContact contact = default, ApplicationConfigurationModuleEcommerce ecommerce = default, ApplicationConfigurationModuleEmail email = default, ApplicationConfigurationModuleForms forms = default, ApplicationConfigurationModuleFulfillment fulfillment = default, ApplicationConfigurationModuleInvoice invoice = default, ApplicationConfigurationModuleNote note = default, ApplicationConfigurationModuleOpportunity opportunity = default, ApplicationConfigurationModuleTask task = default, ApplicationConfigurationModuleTemplate template = default)
        {
