...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateUpdateTaskRequest : IValidatableObject
    {
        ...
        public CreateUpdateTaskRequest(string assignedToUserId = default, bool completed = default, string completionTime = default, string contactId = default, string description = default, string dueTime = default, PriorityEnum? priority = default, int remindTimeMins = default, string title = default, TypeEnum? type = default)
        {
