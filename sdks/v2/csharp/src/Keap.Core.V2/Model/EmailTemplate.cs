...
namespace Keap.Core.V2.Model
{
    ...
    public partial class EmailTemplate : IValidatableObject
    {
        ...
        public EmailTemplate(string bccAddress = default, List<string> categories = default, string ccAddress = default, ContentTypeEnum? contentType = default, string fromAddress = default, string htmlBody = default, string mergeContext = default, string pieceTitle = default, string subject = default, string textBody = default, string toAddress = default)
        {
