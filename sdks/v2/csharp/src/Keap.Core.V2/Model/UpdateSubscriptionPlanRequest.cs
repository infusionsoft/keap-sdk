...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateSubscriptionPlanRequest : IValidatableObject
    {
        ...
        /// <param name="frequency">The frequency of the subscription plan. Must be greater than 0..</param>
        ...
        public UpdateSubscriptionPlanRequest(bool active = default, bool allowProrating = default, CycleTypeEnum cycleType = default, int displayOrderIndex = default, int frequency = default, double planPrice = default, int totalCycles = default)
        {
        ...
        /// </summary>
        /// <value>The frequency of the subscription plan. Must be greater than 0.</value>
        ...
        /// </summary>
        /// <value>The price of the subscription plan in the smallest currency unit. Must be greater than or equal to 0.</value>
