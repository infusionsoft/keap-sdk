...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateSubscriptionPlanRequest : IValidatableObject
    {
        ...
        */
        ...
        public UpdateSubscriptionPlanRequest(bool active = default, int frequency = default, bool allowProrating = default, CycleTypeEnum cycleType = default, int displayOrderIndex = default, double planPrice = default, int totalCycles = default)
        {
