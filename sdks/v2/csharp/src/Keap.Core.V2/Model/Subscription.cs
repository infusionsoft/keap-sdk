...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Subscription : IValidatableObject
    {
        ...
        */
        ...
        /// <param name="modificationTime">The date and time the subscription was last modified..</param>
        /// <param name="customFields">List of custom field values applied to this subscription.</param>
        public Subscription(string id = default, long quantity = default, bool active = default, string contactId = default, string productId = default, string subscriptionPlanId = default, double billingAmount = default, bool autoCharge = default, int billingFrequency = default, BillingCycleEnum? billingCycle = default, DateOnly startDate = default, DateOnly lastBillDate = default, DateOnly nextBillDate = default, DateOnly endDate = default, string merchantAccountId = default, string paymentMethodId = default, bool allowTax = default, int maxChargeAttempts = default, int daysBetweenRetries = default, string leadAffiliateId = default, string saleAffiliateId = default, Address shippingAddress = default, string promoCode = default, string shippingOptionId = default, string reasonStopped = default, DateTime modificationTime = default, List<CustomFieldValue> customFields = default)
        {
            this.Id = id;
        ...
        */
        ...
        /// </summary>
        /// <value>The date and time the subscription was last modified.</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>List of custom field values applied to this subscription</value>
        /*
