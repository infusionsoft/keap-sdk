...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Subscription : IValidatableObject
    {
        ...
        /// <param name="lastBillDate">lastBillDate.</param>
