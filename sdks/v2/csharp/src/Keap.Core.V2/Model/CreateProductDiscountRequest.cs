...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateProductDiscountRequest : IValidatableObject
    {
        ...
        */
        ...
        public CreateProductDiscountRequest(string name = default, string description = default, List<CreateProductDiscountCriteria> criteria = default, bool applyToCommissions = default, string productId = default, DiscountTypeEnum discountType = default, double discountValue = default)
        {
        ...
        */
        ...
        public List<CreateProductDiscountCriteria> Criteria { get; set; }
