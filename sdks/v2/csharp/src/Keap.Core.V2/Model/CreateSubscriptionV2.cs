...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateSubscriptionV2 : IValidatableObject
    {
        ...
        public CreateSubscriptionV2(bool allowDuplicate = default, bool allowTax = default, bool autoCharge = default, double billingAmount = default, string contactId = default, DateOnly firstBillDate = default, string paymentMethodId = default, int quantity = default, string saleAffiliateId = default, string subscriptionPlanId = default)
        {
