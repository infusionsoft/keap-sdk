...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestV2Order : IValidatableObject
    {
        ...
        public RestV2Order(bool allowPayment = default(bool), bool allowPaypal = default(bool), BasicContact contact = default(BasicContact), string creationTime = default(string), List<InvoiceFile> files = default(List<InvoiceFile>), string id = default(string), string invoiceNumber = default(string), string leadAffiliateId = default(string), string modificationTime = default(string), string notes = default(string), List<RestV2OrderItem> orderItems = default(List<RestV2OrderItem>), string orderTime = default(string), OrderTypeEnum? orderType = default(OrderTypeEnum?), PaymentPlan paymentPlan = default(PaymentPlan), CurrencyValue refundTotal = default(CurrencyValue), string salesAffiliateId = default(string), ShippingInformation shippingInformation = default(ShippingInformation), SourceTypeEnum? sourceType = default(SourceTypeEnum?), StatusEnum? status = default(StatusEnum?), string terms = default(string), string title = default(string), CurrencyValue total = default(CurrencyValue), CurrencyValue totalDue = default(CurrencyValue), CurrencyValue totalPaid = default(CurrencyValue))
        {
