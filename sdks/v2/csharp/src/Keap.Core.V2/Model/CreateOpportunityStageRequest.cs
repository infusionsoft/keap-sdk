...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateOpportunityStageRequest : IValidatableObject
    {
        ...
        public CreateOpportunityStageRequest(List<CreateOpportunityStageChecklistItem> checklistItems = default, string name = default, int order = default, int probability = default, int targetNumberDays = default)
        {
