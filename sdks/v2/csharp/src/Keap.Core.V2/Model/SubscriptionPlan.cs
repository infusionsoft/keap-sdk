...
namespace Keap.Core.V2.Model
{
    ...
    {
        /// <summary>
        /// The cycle type of the subscription plan. Possible values: YEARLY, MONTHLY, WEEKLY, DAILY
        /// </summary>
        /// <value>The cycle type of the subscription plan. Possible values: YEARLY, MONTHLY, WEEKLY, DAILY</value>
        ...
        /// <param name="cycleType">The cycle type of the subscription plan. Possible values: YEARLY, MONTHLY, WEEKLY, DAILY.</param>
        ...
        public SubscriptionPlan(bool active = default, bool allowProrating = default, CycleTypeEnum? cycleType = default, int displayOrderIndex = default, int frequency = default, string id = default, CurrencyValue planPrice = default, string productId = default, int totalCycles = default)
        {
            this.Active = active;
