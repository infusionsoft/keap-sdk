...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateOpportunityStageRequest : IValidatableObject
    {
        ...
        public UpdateOpportunityStageRequest(string name = default, int order = default, int probability = default, int targetNumberDays = default, List<UpdateOpportunityStageChecklistItem> checklistItems = default)
        {
            this.Name = name;
            this.Order = order;
