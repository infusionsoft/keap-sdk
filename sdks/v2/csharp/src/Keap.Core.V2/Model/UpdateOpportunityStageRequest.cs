...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateOpportunityStageRequest : IValidatableObject
    {
        ...
        public UpdateOpportunityStageRequest(List<UpdateOpportunityStageChecklistItem> checklistItems = default, string name = default, int order = default, int probability = default, int targetNumberDays = default)
        {
