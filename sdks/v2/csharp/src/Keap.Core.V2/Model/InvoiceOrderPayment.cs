...
namespace Keap.Core.V2.Model
{
    ...
    public partial class InvoiceOrderPayment : IValidatableObject
    {
        ...
        public InvoiceOrderPayment(decimal amount = default, string id = default, string invoiceId = default, string lastUpdatedTime = default, string note = default, PayStatusEnum? payStatus = default, string payTime = default, string paymentId = default, string refundInvoicePaymentId = default, bool skipCommission = default)
        {
            this.Amount = amount;
            this.Id = id;
