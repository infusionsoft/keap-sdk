...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Address : IValidatableObject
    {
        ...
        public Address(string country = default, string countryCode = default, FieldEnum? field = default, string line1 = default, string line2 = default, string locality = default, string postalCode = default, string region = default, string regionCode = default, string zipCode = default, string zipFour = default)
        {
