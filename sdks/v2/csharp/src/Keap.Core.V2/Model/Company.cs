...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Company : IValidatableObject
    {
        ...
        /// <param name="groups">Comma-delimited list of tag IDs applied to this company.</param>
        ...
        /// <param name="accountId">The company&#39;s account ID.</param>
        /// <param name="createdBy">ID of the user who created this company.</param>
        /// <param name="lastUpdatedBy">ID of the user who last updated this company.</param>
        public Company(string id = default, Address address = default, string notes = default, string website = default, string suffix = default, string title = default, string groups = default, string companyName = default, List<CustomFieldValue> customFields = default, EmailAddress emailAddress = default, FaxNumber faxNumber = default, PhoneNumber phoneNumber = default, string updateTime = default, string createTime = default, string anniversaryDate = default, string assistantName = default, string assistantPhone = default, string billingInformation = default, string birthDate = default, string contactType = default, string firstName = default, string jobTitle = default, string lastName = default, string middleName = default, string preferredName = default, string ownerId = default, string referralCode = default, string spouseName = default, string accountId = default, string createdBy = default, string lastUpdatedBy = default)
        {
            this.Id = id;
        ...
        */
        ...
        /// </summary>
        /// <value>Comma-delimited list of tag IDs applied to this company</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The company&#39;s account ID</value>
        /*
        <example>100</example>
        */
        ...
        /// </summary>
        /// <value>ID of the user who created this company</value>
        /*
        <example>10</example>
        */
        ...
        /// </summary>
        /// <value>ID of the user who last updated this company</value>
        /*
        <example>10</example>
        */
