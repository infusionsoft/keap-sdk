...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Company : IValidatableObject
    {
        ...
        public Company(string id = default, Address address = default, string notes = default, string website = default, string companyName = default, List<CustomFieldValue> customFields = default, EmailAddress emailAddress = default, FaxNumber faxNumber = default, PhoneNumber phoneNumber = default, string updateTime = default, string createTime = default)
        {
            this.Id = id;
