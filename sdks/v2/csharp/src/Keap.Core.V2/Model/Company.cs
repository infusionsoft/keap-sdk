...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Company : IValidatableObject
    {
        ...
        public Company(Address address = default, string companyName = default, string createTime = default, List<CustomFieldValue> customFields = default, EmailAddress emailAddress = default, FaxNumber faxNumber = default, string id = default, string notes = default, PhoneNumber phoneNumber = default, string updateTime = default, string website = default)
        {
