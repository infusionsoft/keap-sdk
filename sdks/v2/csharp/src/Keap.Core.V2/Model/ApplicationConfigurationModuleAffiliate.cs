...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ApplicationConfigurationModuleAffiliate : IValidatableObject
    {
        ...
        public ApplicationConfigurationModuleAffiliate(bool chooseAffiliate = default, ApplicationConfigurationModuleAffiliateCommission commission = default, string customAffiliateUrl = default, bool displayAffiliateIpAddress = default, bool doNotNotifyAffiliate = default, bool skipPayIfUnused = default, bool useReferralHistoryIfNoTrackingCookie = default)
        {
