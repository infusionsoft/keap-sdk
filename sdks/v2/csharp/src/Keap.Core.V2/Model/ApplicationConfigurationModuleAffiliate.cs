...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ApplicationConfigurationModuleAffiliate : IValidatableObject
    {
        ...
        public ApplicationConfigurationModuleAffiliate(ApplicationConfigurationModuleAffiliateCommission commission = default, bool chooseAffiliate = default, string customAffiliateUrl = default, bool displayAffiliateIpAddress = default, bool doNotNotifyAffiliate = default, bool useReferralHistoryIfNoTrackingCookie = default, bool skipPayIfUnused = default)
        {
