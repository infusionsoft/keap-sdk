...
namespace Keap.Core.V2.Model
{
    ...
    public partial class User : IValidatableObject
    {
        ...
        public User(Address address = default, bool admin = default, string companyName = default, string createTime = default, long createdBy = default, List<EmailAddress> emailAddresses = default, string familyName = default, List<FaxNumber> faxNumbers = default, string givenName = default, string globalUserId = default, string id = default, string keapId = default, bool partner = default, List<PhoneNumber> phoneNumbers = default, List<SocialAccount> socialAccounts = default, StatusEnum? status = default, string varTimeZone = default, string title = default, string updateTime = default, long updatedBy = default, string website = default)
        {
