...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Goal : IValidatableObject
    {
        ...
        public Goal(HistoricalCounts historicalContactCounts = default, string id = default, string name = default, List<string> nextSequenceIds = default, List<string> previousSequenceIds = default, TypeEnum? type = default)
        {
