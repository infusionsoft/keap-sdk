...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ApplicationCompany : IValidatableObject
    {
        ...
        public ApplicationCompany(string callerIdNumber = default, string city = default, string country = default, string email = default, string name = default, string phone = default, string phoneExt = default, string state = default, string streetAddress1 = default, string streetAddress2 = default, string webLogoUrl = default, string website = default, string zip = default)
        {
