...
namespace Keap.Core.V2.Model
{
    ...
    public partial class OrderTotalDiscount : IValidatableObject
    {
        ...
        public OrderTotalDiscount(bool applyToCommissions = default(bool), List<DiscountCriteria> criteria = default(List<DiscountCriteria>), string description = default(string), DiscountStrategyEnum? discountStrategy = default(DiscountStrategyEnum?), DiscountTypeEnum? discountType = default(DiscountTypeEnum?), double discountValue = default(double), string id = default(string), string name = default(string))
        {
