...
namespace Keap.Core.V2.Model
{
    ...
    public partial class OrderTotalDiscount : IValidatableObject
    {
        ...
        public OrderTotalDiscount(bool applyToCommissions = default, List<DiscountCriteria> criteria = default, string description = default, DiscountStrategyEnum? discountStrategy = default, DiscountTypeEnum? discountType = default, double discountValue = default, string id = default, string name = default)
        {
