...
namespace Keap.Core.V2.Model
{
    ...
    public partial class OrderTotalDiscount : IValidatableObject
    {
        ...
        */
        ...
        /// </summary>
        /// <param name="id">Unique identifier for this order total discount.</param>
        ...
        public OrderTotalDiscount(string id = default, string name = default, string description = default, List<DiscountCriteria> criteria = default, bool applyToCommissions = default, DiscountTypeEnum? discountType = default, double discountValue = default, DiscountStrategyEnum? discountStrategy = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        /// </summary>
        /// <value>Unique identifier for this order total discount</value>
        /*
        <example>103</example>
        */
