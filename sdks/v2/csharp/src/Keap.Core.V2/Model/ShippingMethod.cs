...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ShippingMethod : IValidatableObject
    {
        ...
        public ShippingMethod(string description = default, string id = default, bool international = default, string name = default, Object settings = default, string status = default, string type = default)
        {
