...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateBusinessProfileRequest : IValidatableObject
    {
        ...
        public UpdateBusinessProfileRequest(string name = default, string email = default, string website = default, string phone = default, BusinessProfileAddressRequest address = default, string currencyCode = default, List<string> businessGoals = default, string businessPrimaryColor = default, string businessSecondaryColor = default)
        {
            this.Name = name;
            this.Email = email;
