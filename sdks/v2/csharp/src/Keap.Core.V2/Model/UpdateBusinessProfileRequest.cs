...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateBusinessProfileRequest : IValidatableObject
    {
        ...
        public UpdateBusinessProfileRequest(BusinessProfileAddressRequest address = default, List<string> businessGoals = default, string businessPrimaryColor = default, string businessSecondaryColor = default, string currencyCode = default, string email = default, string name = default, string phone = default, string website = default)
        {
