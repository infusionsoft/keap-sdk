...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Campaign : IValidatableObject
    {
        ...
        public Campaign(int activeContactCount = default, int completedContactCount = default, string createdByGlobalId = default, string dateCreated = default, string errorMessage = default, List<Goal> goals = default, string id = default, bool locked = default, string name = default, string publishedDate = default, bool publishedStatus = default, string publishedTimeZone = default, List<Sequence> sequences = default, string varTimeZone = default)
        {
