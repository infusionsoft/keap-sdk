...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Transaction : IValidatableObject
    {
        ...
        public Transaction(string contactId = default, string id = default, bool isLive = default, bool isSuccessful = default, string orderId = default, string paymentGatewayId = default, string paymentId = default, PaymentProcessorTypeEnum? paymentProcessorType = default, CurrencyValue transactionAmount = default, string transactionTime = default, string transactionType = default)
        {
