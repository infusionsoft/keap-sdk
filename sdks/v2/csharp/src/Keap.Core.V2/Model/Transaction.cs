...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Transaction : IValidatableObject
    {
        ...
        public Transaction(string contactId = default(string), string id = default(string), bool isLive = default(bool), bool isSuccessful = default(bool), string orderId = default(string), string paymentGatewayId = default(string), string paymentId = default(string), PaymentProcessorTypeEnum? paymentProcessorType = default(PaymentProcessorTypeEnum?), CurrencyValue transactionAmount = default(CurrencyValue), string transactionTime = default(string), string transactionType = default(string))
        {
