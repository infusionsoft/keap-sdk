...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestV2Opportunity : IValidatableObject
    {
        ...
        public RestV2Opportunity(string affiliateId = default, OpportunityContact contact = default, string createdTime = default, List<CustomField> customFields = default, string estimatedCloseTime = default, string id = default, bool includeInForecast = default, string lastUpdatedTime = default, string nextActionNotes = default, string nextActionTime = default, string opportunityNotes = default, string opportunityTitle = default, double projectedRevenueHigh = default, double projectedRevenueLow = default, OpportunityStage stage = default, RestV2User user = default)
        {
