...
namespace Keap.Core.V2.Model
{
    ...
    public partial class LeadSourceRecurringExpenseUpdateRequest : IValidatableObject
    {
        ...
        public LeadSourceRecurringExpenseUpdateRequest(long amount = default(long), string endTime = default(string), string notes = default(string), string startTime = default(string), string title = default(string))
        {
            this.Amount = amount;
