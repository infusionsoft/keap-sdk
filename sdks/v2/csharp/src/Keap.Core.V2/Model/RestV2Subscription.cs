...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestV2Subscription : IValidatableObject
    {
        ...
        public RestV2Subscription(bool subscriptionActive = default, int subscriptionCyclesCompleted = default, string subscriptionEndDate = default, string subscriptionId = default, string subscriptionNextBillDate = default, string subscriptionStartDate = default)
        {
