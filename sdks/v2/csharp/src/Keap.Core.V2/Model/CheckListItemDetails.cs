...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CheckListItemDetails : IValidatableObject
    {
        ...
        public CheckListItemDetails(string description = default, DateTime doneDate = default, long id = default, long instanceId = default, int itemOrder = default, bool required = default)
        {
