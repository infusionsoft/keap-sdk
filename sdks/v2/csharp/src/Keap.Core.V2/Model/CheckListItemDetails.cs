...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CheckListItemDetails : IValidatableObject
    {
        ...
        public CheckListItemDetails(long id = default, string description = default, bool required = default, long instanceId = default, int itemOrder = default, DateTime doneDate = default)
        {
            this.Id = id;
