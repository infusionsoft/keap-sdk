...
namespace Keap.Core.V2.Model
{
    ...
    public partial class FileMetadata : IValidatableObject
    {
        ...
        public FileMetadata(CategoryEnum? category = default, string contactId = default, string createdById = default, string createdTime = default, FileBoxTypeEnum? fileBoxType = default, string fileName = default, long fileSize = default, string id = default, bool isPublic = default, string remoteFileKey = default, string updatedTime = default)
        {
