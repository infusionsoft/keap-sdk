...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateOrderTotalDiscountRequest : IValidatableObject
    {
        ...
        public CreateOrderTotalDiscountRequest(bool applyToCommissions = default, List<DiscountCriteria> criteria = default, string description = default, DiscountStrategyEnum? discountStrategy = default, DiscountTypeEnum discountType = default, double discountValue = default, string name = default)
        {
