...
namespace Keap.Core.V2.Model
{
    ...
    public partial class DealNote : IValidatableObject
    {
        ...
        public DealNote(string id = default, string dealId = default, string body = default, string createdBy = default, DateTime createdTime = default, DateTime modifiedTime = default)
        {
            this.Id = id;
            this.DealId = dealId;
            this.Body = body;
