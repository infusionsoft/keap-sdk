...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ContactUtmResponse : IValidatableObject
    {
        ...
        public ContactUtmResponse(DateTime dateCreated = default, bool firstTouch = default, long id = default, string keapSourceId = default, bool lastTouch = default, string utmCampaign = default, string utmContent = default, string utmMedium = default, string utmSource = default, string utmTerm = default)
        {
