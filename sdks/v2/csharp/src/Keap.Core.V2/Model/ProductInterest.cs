...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductInterest : IValidatableObject
    {
        ...
        public ProductInterest(int discountPercent = default(int), string id = default(string), CurrencyValue price = default(CurrencyValue), string productId = default(string), int quantity = default(int))
        {
