...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductInterest : IValidatableObject
    {
        ...
        public ProductInterest(int discountPercent = default(int), string id = default(string), string interestId = default(string), CurrencyValue price = default(CurrencyValue), int quantity = default(int), TypeEnum? type = default(TypeEnum?))
        {
