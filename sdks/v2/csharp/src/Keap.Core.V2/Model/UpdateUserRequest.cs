...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateUserRequest : IValidatableObject
    {
        ...
        public UpdateUserRequest(Address address = default, string companyName = default, EmailAddressRequest emailAddress = default, string familyName = default, List<FaxNumber> faxNumbers = default, string givenName = default, List<PhoneNumber> phoneNumbers = default, string varTimeZone = default, string title = default, string website = default)
        {
