...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Automation : IValidatableObject
    {
        ...
        public Automation(int activeContacts = default, List<string> categories = default, AutomationLockStatus currentEditLockStatus = default, string errorMessage = default, string id = default, bool locked = default, string publicationDate = default, string publishedBy = default, DateTime publishedDate = default, string publishedTimezone = default, string status = default, string title = default)
        {
