...
namespace Keap.Core.V2.Model
{
    ...
    /// ListReportsResponse
    /// </summary>
    [DataContract(Name = "ListReportsResponse")]
    public partial class ListReportsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public ListReportsResponse(string nextPageToken = default(string), List<Report> reports = default(List<Report>))
        {
