...
namespace Keap.Core.V2.Model
{
    ...
    public partial class GetUserInfoResponse : IValidatableObject
    {
        ...
        public GetUserInfoResponse(string email = default, string familyName = default, string givenName = default, string id = default, bool isAdmin = default, string keapId = default, string middleName = default, string preferredName = default, string sub = default)
        {
            this.Email = email;
