...
namespace Keap.Core.V2.Model
{
    ...
    public partial class PipelineSummary : IValidatableObject
    {
        ...
        public PipelineSummary(string id = default, string pipelineId = default, string pipelineName = default, int? statTotalDealCount = default, int? statNewDealCount = default)
        {
