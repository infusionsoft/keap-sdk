...
namespace Keap.Core.V2.Model
{
    ...
    public partial class File : IValidatableObject
    {
        ...
        public File(bool absolute = default, File absoluteFile = default, string absolutePath = default, File canonicalFile = default, string canonicalPath = default, bool directory = default, bool executable = default, bool varFile = default, long freeSpace = default, bool hidden = default, long lastModified = default, string name = default, string parent = default, File parentFile = default, string path = default, bool readable = default, long totalSpace = default, long usableSpace = default, bool writable = default)
        {
