...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductInterestBundle : IValidatableObject
    {
        ...
        public ProductInterestBundle(string description = default, string id = default, string name = default, List<ProductInterest> productInterests = default, List<ProductInterest> subscriptionPlanInterests = default)
        {
