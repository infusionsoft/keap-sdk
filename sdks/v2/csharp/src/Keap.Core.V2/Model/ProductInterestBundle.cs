...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductInterestBundle : IValidatableObject
    {
        ...
        public ProductInterestBundle(string id = default, string name = default, string description = default, List<ProductInterest> productInterests = default, List<ProductInterest> subscriptionPlanInterests = default)
        {
            this.Id = id;
            this.Name = name;
