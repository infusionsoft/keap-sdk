...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductInterestBundle : IValidatableObject
    {
        ...
        public ProductInterestBundle(string description = default(string), string id = default(string), string name = default(string), List<ProductInterest> productInterests = default(List<ProductInterest>), List<ProductInterest> subscriptionPlanInterests = default(List<ProductInterest>))
        {
        ...
        public List<ProductInterest> SubscriptionPlanInterests { get; set; }
