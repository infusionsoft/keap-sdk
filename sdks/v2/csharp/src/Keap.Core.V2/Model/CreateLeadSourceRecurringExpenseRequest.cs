...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateLeadSourceRecurringExpenseRequest : IValidatableObject
    {
        ...
        protected CreateLeadSourceRecurringExpenseRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLeadSourceRecurringExpenseRequest" /> class.
        /// </summary>
        ...
        public CreateLeadSourceRecurringExpenseRequest(string title = default, string notes = default, long amount = default, DateTime startTime = default, DateTime endTime = default)
        {
            this.Amount = amount;
            this.Title = title;
            this.Notes = notes;
