...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateLeadSourceRecurringExpenseRequest : IValidatableObject
    {
        ...
        public CreateLeadSourceRecurringExpenseRequest(long amount = default, string endTime = default, string notes = default, string startTime = default, string title = default)
        {
            this.Amount = amount;
