...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestV2Product : IValidatableObject
    {
        ...
        public RestV2Product(bool active = default, List<string> categories = default, bool cityTaxable = default, bool countryTaxable = default, string description = default, string id = default, ProductInventory inventory = default, string name = default, List<ProductOptions> options = default, CurrencyValue price = default, bool shippable = default, string shortDescription = default, string sku = default, bool stateTaxable = default, bool storefrontHidden = default, bool subscriptionOnly = default, List<SubscriptionPlan> subscriptionPlans = default, bool taxable = default, double weight = default)
        {
            this.Active = active;
