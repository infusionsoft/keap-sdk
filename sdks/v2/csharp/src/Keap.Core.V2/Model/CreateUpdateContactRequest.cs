...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateUpdateContactRequest : IValidatableObject
    {
        ...
        public CreateUpdateContactRequest(List<Address> addresses = default, string anniversaryDate = default, string birthDate = default, BasicCompany company = default, string contactType = default, List<CustomFieldValue> customFields = default, List<EmailAddressRequest> emailAddresses = default, string familyName = default, List<FaxNumber> faxNumbers = default, string givenName = default, string jobTitle = default, string leadsourceId = default, string middleName = default, OriginRequest origin = default, string ownerId = default, List<PhoneNumber> phoneNumbers = default, string preferredLocale = default, string preferredName = default, string prefix = default, string referralCode = default, List<SocialAccount> socialAccounts = default, SourceTypeEnum? sourceType = default, string spouseName = default, string suffix = default, string varTimeZone = default, CreateContactUtmPropertiesRequest utmParameters = default, string website = default)
        {
