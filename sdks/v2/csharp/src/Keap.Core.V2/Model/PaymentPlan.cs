...
namespace Keap.Core.V2.Model
{
    ...
    public partial class PaymentPlan : IValidatableObject
    {
        ...
        public PaymentPlan(bool autoCharge = default(bool), long daysBetweenPayments = default(long), long daysBetweenRetries = default(long), CurrencyValue initialPaymentAmount = default(CurrencyValue), string initialPaymentDate = default(string), double initialPaymentPercent = default(double), long maxChargeAttempts = default(long), long numberOfPayments = default(long), string paymentMethodId = default(string), string planStartDate = default(string))
        {
