...
namespace Keap.Core.V2.Model
{
    ...
    public partial class PaymentPlan : IValidatableObject
    {
        ...
        public PaymentPlan(bool autoCharge = default, long daysBetweenPayments = default, long daysBetweenRetries = default, CurrencyValue initialPaymentAmount = default, string initialPaymentDate = default, double initialPaymentPercent = default, long maxChargeAttempts = default, long numberOfPayments = default, string paymentMethodId = default, string planStartDate = default)
        {
