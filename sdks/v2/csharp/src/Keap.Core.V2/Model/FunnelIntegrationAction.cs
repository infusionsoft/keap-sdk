...
namespace Keap.Core.V2.Model
{
    ...
    public partial class FunnelIntegrationAction : IValidatableObject
    {
        ...
        public FunnelIntegrationAction(string baseUrl = default, string context = default, bool enabled = default, string iconUrl = default, string name = default, List<FunnelIntegrationSchemaField> schemaFields = default)
        {
