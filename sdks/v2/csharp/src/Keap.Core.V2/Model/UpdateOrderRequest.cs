...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateOrderRequest : IValidatableObject
    {
        ...
        public UpdateOrderRequest(string contactId = default(string), string leadAffiliateId = default(string), string notes = default(string), string orderTime = default(string), string orderTitle = default(string), OrderTypeEnum? orderType = default(OrderTypeEnum?), UpdatedPaymentPlan paymentPlan = default(UpdatedPaymentPlan), List<string> promoCodes = default(List<string>), string salesAffiliateId = default(string), AddressInformation shippingAddress = default(AddressInformation), string terms = default(string))
        {
