...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateNoteRequest : IValidatableObject
    {
        ...
        public UpdateNoteRequest(string title = default, string text = default, string type = default, string userId = default, bool isPinned = default, List<CustomFieldValueObject> customFields = default, string contactId = default)
        {
