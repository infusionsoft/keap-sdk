...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateNoteRequest : IValidatableObject
    {
        ...
        public UpdateNoteRequest(string contactId = default, bool isPinned = default, string text = default, string title = default, string type = default, string userId = default)
        {
