...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Contact : IValidatableObject
    {
        ...
        public Contact(List<Address> addresses = default, string anniversaryDate = default, string birthDate = default, BasicCompany company = default, string contactType = default, string createTime = default, List<CustomFieldValue> customFields = default, List<EmailAddress> emailAddresses = default, string familyName = default, List<FaxNumber> faxNumbers = default, string givenName = default, string id = default, string jobTitle = default, string leadsourceId = default, List<Link> links = default, string middleName = default, Origin origin = default, string ownerId = default, List<PhoneNumber> phoneNumbers = default, string preferredLocale = default, string preferredName = default, string prefix = default, string referralCode = default, string scoreValue = default, List<SocialAccount> socialAccounts = default, SourceTypeEnum? sourceType = default, string spouseName = default, string suffix = default, List<string> tagIds = default, string varTimeZone = default, string updateTime = default, List<ContactUtmResponse> utmParameters = default, string website = default)
        {
