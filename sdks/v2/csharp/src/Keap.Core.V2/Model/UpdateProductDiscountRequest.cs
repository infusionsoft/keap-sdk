...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateProductDiscountRequest : IValidatableObject
    {
        ...
        public UpdateProductDiscountRequest(bool applyToCommissions = default(bool), List<DiscountCriteria> criteria = default(List<DiscountCriteria>), string description = default(string), DiscountTypeEnum? discountType = default(DiscountTypeEnum?), double discountValue = default(double), string name = default(string), string productId = default(string))
        {
