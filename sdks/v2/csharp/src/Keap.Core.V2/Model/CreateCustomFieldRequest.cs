...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateCustomFieldRequest : IValidatableObject
    {
        ...
        public CreateCustomFieldRequest(FieldTypeEnum fieldType = default, string groupId = default, string label = default, List<CreateCustomFieldOptionRequest> options = default, string userGroupId = default)
        {
