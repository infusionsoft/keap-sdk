...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateCustomFieldRequest : IValidatableObject
    {
        ...
        public CreateCustomFieldRequest(string label = default, List<CreateCustomFieldOptionRequest> options = default, FieldTypeEnum fieldType = default, string groupId = default, string userGroupId = default)
        {
