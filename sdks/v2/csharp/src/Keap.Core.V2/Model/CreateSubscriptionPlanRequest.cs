...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateSubscriptionPlanRequest : IValidatableObject
    {
        ...
        public CreateSubscriptionPlanRequest(bool active = default, bool allowProrating = default, CycleTypeEnum cycleType = default, int displayOrderIndex = default, int frequency = default, double planPrice = default, int totalCycles = default)
        {
        ...
        /// </summary>
        /// <value>The frequency of the subscription plan. Must be greater than 0. Default is 1.</value>
