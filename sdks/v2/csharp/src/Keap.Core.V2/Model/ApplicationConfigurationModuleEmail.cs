...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ApplicationConfigurationModuleEmail : IValidatableObject
    {
        ...
        public ApplicationConfigurationModuleEmail(bool appendContactKeyToLinks = default, string defaultOptInLink = default, string defaultOptOutLink = default, string hideEmailsToAndFromDomains = default, string whitelistedDomains = default)
        {
