...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ApplicationConfigurationModuleEmail : IValidatableObject
    {
        ...
        public ApplicationConfigurationModuleEmail(string defaultOptInLink = default, string defaultOptOutLink = default, string whitelistedDomains = default, string hideEmailsToAndFromDomains = default, bool appendContactKeyToLinks = default)
        {
