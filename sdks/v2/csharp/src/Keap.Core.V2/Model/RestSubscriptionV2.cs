...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestSubscriptionV2 : IValidatableObject
    {
        ...
        public RestSubscriptionV2(bool active = default, bool allowTax = default, bool autoCharge = default, double billingAmount = default, BillingCycleEnum? billingCycle = default, int billingFrequency = default, string contactId = default, string endDate = default, string id = default, string nextBillDate = default, string paymentGatewayId = default, string paymentMethodId = default, string productId = default, long quantity = default, string saleAffiliateId = default, string startDate = default, string subscriptionPlanId = default)
        {
            this.Active = active;
