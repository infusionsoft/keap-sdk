...
namespace Keap.Core.V2.Model
{
    ...
    public partial class PaymentMethod : IValidatableObject
    {
        ...
        public PaymentMethod(CardInfo cardInfo = default(CardInfo), string contactId = default(string), string createdTime = default(string), string paymentGatewayId = default(string), string paymentMethodId = default(string), PaymentMethodTypeEnum? paymentMethodType = default(PaymentMethodTypeEnum?), PaymentProcessorTypeEnum? paymentProcessorType = default(PaymentProcessorTypeEnum?))
        {
