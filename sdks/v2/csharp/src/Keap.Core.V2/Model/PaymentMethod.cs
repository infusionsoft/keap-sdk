...
namespace Keap.Core.V2.Model
{
    ...
    public partial class PaymentMethod : IValidatableObject
    {
        ...
        /// <param name="merchantAccountType">merchantAccountType.</param>
        /// <param name="paymentMethodId">paymentMethodId.</param>
        /// <param name="paymentMethodType">paymentMethodType.</param>
        public PaymentMethod(CardInfo cardInfo = default, string contactId = default, string createdTime = default, string merchantAccountId = default, MerchantAccountTypeEnum? merchantAccountType = default, string paymentMethodId = default, PaymentMethodTypeEnum? paymentMethodType = default)
        {
