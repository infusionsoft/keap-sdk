...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ListLeadSourceRecurringExpensesResponse : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="leadSourceRecurringExpenses">leadSourceRecurringExpenses.</param>
        /// <param name="nextPageToken">nextPageToken.</param>
        public ListLeadSourceRecurringExpensesResponse(List<LeadSourceRecurringExpense> leadSourceRecurringExpenses = default(List<LeadSourceRecurringExpense>), string nextPageToken = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets LeadSourceRecurringExpenses
        /// </summary>
