...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateProductRequest : IValidatableObject
    {
        ...
        public UpdateProductRequest(bool active = default, bool cityTaxable = default, bool countryTaxable = default, string description = default, string name = default, long price = default, string shortDescription = default, string sku = default, bool stateTaxable = default, bool storefrontHidden = default, bool subscriptionOnly = default, bool taxable = default, double weight = default)
        {
            this.Active = active;
