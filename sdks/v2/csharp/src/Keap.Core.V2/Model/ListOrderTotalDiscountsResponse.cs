...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ListOrderTotalDiscountsResponse : IValidatableObject
    {
        ...
        public ListOrderTotalDiscountsResponse(List<OrderTotalDiscount> discounts = default(List<OrderTotalDiscount>), string nextPageToken = default(string))
        {
        ...
        public List<OrderTotalDiscount> Discounts { get; set; }
