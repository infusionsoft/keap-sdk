...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateContactUtmPropertiesRequest : IValidatableObject
    {
        ...
        public CreateContactUtmPropertiesRequest(string keapSourceId = default, string utmCampaign = default, string utmContent = default, string utmMedium = default, string utmSource = default, string utmTerm = default)
        {
