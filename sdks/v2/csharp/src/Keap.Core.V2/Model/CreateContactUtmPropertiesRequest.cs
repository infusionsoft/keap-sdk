...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateContactUtmPropertiesRequest : IValidatableObject
    {
        ...
        public CreateContactUtmPropertiesRequest(string keapSourceId = default, string utmSource = default, string utmMedium = default, string utmTerm = default, string utmCampaign = default, string utmContent = default)
        {
