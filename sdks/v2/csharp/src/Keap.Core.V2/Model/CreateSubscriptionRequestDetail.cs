...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateSubscriptionRequest_Detail")]
    public partial class CreateSubscriptionRequestDetail : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionRequestDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateSubscriptionRequestDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionRequestDetail" /> class.
        /// </summary>
        ...
        public CreateSubscriptionRequestDetail(int quantity = default, bool active = default, string contactId = default, string subscriptionPlanId = default, double billingAmount = default, bool autoCharge = default, int maxChargeAttempts = default, int daysBetweenRetries = default, DateOnly startDate = default, string paymentMethodId = default, bool allowTax = default, bool allowDuplicate = default, string leadAffiliateId = default, string saleAffiliateId = default, AddressRequestDetail shippingAddress = default, string promoCode = default, string shippingOptionId = default, string reasonStopped = default)
        {
            // to ensure "contactId" is required (not null)
            if (contactId == null)
            {
                throw new ArgumentNullException("contactId is a required property for CreateSubscriptionRequestDetail and cannot be null");
            }
            this.ContactId = contactId;
            // to ensure "subscriptionPlanId" is required (not null)
            if (subscriptionPlanId == null)
            {
                throw new ArgumentNullException("subscriptionPlanId is a required property for CreateSubscriptionRequestDetail and cannot be null");
            }
