...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateProductRequest : IValidatableObject
    {
        ...
        public CreateProductRequest(bool active = default, bool cityTaxable = default, bool countryTaxable = default, string description = default, ProductInventory inventory = default, string name = default, long price = default, bool shippable = default, string shortDescription = default, string sku = default, bool stateTaxable = default, bool storefrontHidden = default, bool subscriptionOnly = default, bool taxable = default, double weight = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateProductRequest and cannot be null");
            }
            this.Name = name;
            this.Price = price;
            ...
            {
                throw new ArgumentNullException("shortDescription is a required property for CreateProductRequest and cannot be null");
            }
