...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductFixedOption_Detail")]
    public partial class ProductFixedOptionDetail : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductFixedOptionDetail" /> class.
        /// </summary>
        ...
        public ProductFixedOptionDetail(string value = default, string code = default, double priceAdjustment = default)
        {
            this.Value = value;
            this.Code = code;
