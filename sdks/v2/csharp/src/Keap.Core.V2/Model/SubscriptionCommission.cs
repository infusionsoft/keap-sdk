...
namespace Keap.Core.V2.Model
{
    ...
    public partial class SubscriptionCommission : IValidatableObject
    {
        ...
        public SubscriptionCommission(double dollarAmount = default, string name = default, double percentage = default, double planPrice = default, string subscriptionId = default)
        {
