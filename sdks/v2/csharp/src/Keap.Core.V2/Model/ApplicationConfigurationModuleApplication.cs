...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ApplicationConfigurationModuleApplication : IValidatableObject
    {
        ...
        public ApplicationConfigurationModuleApplication(ApplicationCompany company = default, string defaultViewLocale = default, ApplicationFeaturesEnabled featuresEnabled = default, string varTimeZone = default)
        {
