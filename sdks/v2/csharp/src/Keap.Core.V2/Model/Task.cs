...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Task : IValidatableObject
    {
        ...
        public Task(string assignedToUserId = default, bool completed = default, string completionTime = default, string contactId = default, string createTime = default, string createdByUserId = default, string description = default, string dueTime = default, string id = default, string modificationTime = default, PriorityEnum? priority = default, int remindTimeMins = default, string title = default, TypeEnum? type = default)
        {
