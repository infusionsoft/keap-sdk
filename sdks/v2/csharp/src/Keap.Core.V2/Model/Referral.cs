...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Referral : IValidatableObject
    {
        ...
        public Referral(string contactId = default, string description = default, string expirationTime = default, string id = default, string ipAddress = default, string referralPartnerId = default, string referralTime = default, ReferralTypeEnum? referralType = default, string source = default)
        {
