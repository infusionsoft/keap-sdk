...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ApplicationConfigurationModuleEcommerce : IValidatableObject
    {
        ...
        public ApplicationConfigurationModuleEcommerce(string creditCardTypes = default, string currency = default, int defaultChargeMaxRetryAttempts = default, string defaultCountry = default, string defaultMerchant = default, int defaultNumberOfDaysBetweenChargeAttempts = default, string defaultTax = default, bool defaultToAutoCharge = default, int merchantAccountMaxRetryAttempts = default, string paymentTypes = default, string promoCodes = default, bool trackCostPerUnit = default, bool trackInventory = default)
        {
