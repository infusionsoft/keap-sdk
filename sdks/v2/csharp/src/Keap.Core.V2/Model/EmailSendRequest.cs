...
namespace Keap.Core.V2.Model
{
    ...
    public partial class EmailSendRequest : IValidatableObject
    {
        ...
        public EmailSendRequest(string addressField = default, List<EmailSendRequestAttachment> attachments = default, List<string> contacts = default, string htmlContent = default, string plainContent = default, string subject = default, string userId = default)
        {
