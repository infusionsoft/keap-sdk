...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateFreeTrialDiscountRequest : IValidatableObject
    {
        ...
        public UpdateFreeTrialDiscountRequest(List<DiscountCriteria> criteria = default(List<DiscountCriteria>), string description = default(string), int freeTrialDays = default(int), bool hidePrice = default(bool), string name = default(string), string subscriptionPlanId = default(string))
        {
