...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Report : IValidatableObject
    {
        ...
        public Report(string createdTime = default(string), string id = default(string), string name = default(string), string updatedTime = default(string), List<string> userIds = default(List<string>))
        {
