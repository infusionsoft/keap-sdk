...
namespace Keap.Core.V2.Model
{
    ...
    public partial class URI : IValidatableObject
    {
        ...
        public URI(bool absolute = default, string authority = default, string fragment = default, string host = default, bool opaque = default, string path = default, int port = default, string query = default, string rawAuthority = default, string rawFragment = default, string rawPath = default, string rawQuery = default, string rawSchemeSpecificPart = default, string rawUserInfo = default, string scheme = default, string schemeSpecificPart = default, string userInfo = default)
        {
