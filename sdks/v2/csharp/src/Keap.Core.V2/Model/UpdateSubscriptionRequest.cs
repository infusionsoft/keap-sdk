...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateSubscriptionRequest : IValidatableObject
    {
        ...
        */
        ...
        public UpdateSubscriptionRequest(int quantity = default, bool active = default, string contactId = default, string subscriptionPlanId = default, double billingAmount = default, bool autoCharge = default, int maxChargeAttempts = default, int daysBetweenRetries = default, int billingFrequency = default, BillingCycleEnum? billingCycle = default, DateOnly nextBillDate = default, DateOnly endDate = default, string paymentMethodId = default, bool allowTax = default, string leadAffiliateId = default, string saleAffiliateId = default, AddressRequest shippingAddress = default, string promoCode = default, string shippingOptionId = default, string reasonStopped = default, List<CustomFieldValue> customFields = default)
        {
