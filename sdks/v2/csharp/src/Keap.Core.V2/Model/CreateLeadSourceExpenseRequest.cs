...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateLeadSourceExpenseRequest : IValidatableObject
    {
        ...
        public CreateLeadSourceExpenseRequest(long amount = default(long), string incurredTime = default(string), string notes = default(string), string title = default(string))
        {
            this.Amount = amount;
