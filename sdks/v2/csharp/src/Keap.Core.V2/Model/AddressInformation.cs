...
namespace Keap.Core.V2.Model
{
    ...
    public partial class AddressInformation : IValidatableObject
    {
        ...
        public AddressInformation(string company = default, string countryCode = default, string firstName = default, bool isInvoiceToCompany = default, string lastName = default, string line1 = default, string line2 = default, string locality = default, string middleName = default, string phone = default, string region = default, string zipCode = default, string zipFour = default)
        {
