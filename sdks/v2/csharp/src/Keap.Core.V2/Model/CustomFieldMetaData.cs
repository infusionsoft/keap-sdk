...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CustomFieldMetaData : IValidatableObject
    {
        ...
        public CustomFieldMetaData(string defaultValue = default, string fieldName = default, FieldTypeEnum? fieldType = default, string groupId = default, string id = default, string label = default, List<CustomFieldOption> options = default, RecordTypeEnum? recordType = default)
        {
