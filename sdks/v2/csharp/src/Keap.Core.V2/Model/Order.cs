...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Order : IValidatableObject
    {
        ...
        public Order(bool allowPayment = default, bool allowPaypal = default, BasicContact contact = default, string creationTime = default, List<InvoiceFile> files = default, string id = default, string invoiceNumber = default, string leadAffiliateId = default, string modificationTime = default, string notes = default, List<OrderItem> orderItems = default, string orderTime = default, OrderTypeEnum? orderType = default, PaymentPlan paymentPlan = default, CurrencyValue refundTotal = default, string salesAffiliateId = default, ShippingInformation shippingInformation = default, SourceTypeEnum? sourceType = default, StatusEnum? status = default, string terms = default, string title = default, CurrencyValue total = default, CurrencyValue totalDue = default, CurrencyValue totalPaid = default)
        {
