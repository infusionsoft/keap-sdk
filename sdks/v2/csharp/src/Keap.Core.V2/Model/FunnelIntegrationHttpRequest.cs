...
namespace Keap.Core.V2.Model
{
    ...
    public partial class FunnelIntegrationHttpRequest : IValidatableObject
    {
        ...
        public FunnelIntegrationHttpRequest(string body = default, string callType = default, Dictionary<string, string> headerParameters = default, Dictionary<string, string> queryParameters = default, string url = default)
        {
            this.Body = body;
