...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CategoryDiscount : IValidatableObject
    {
        ...
        public CategoryDiscount(bool applyToCommissions = default(bool), List<DiscountCriteria> criteria = default(List<DiscountCriteria>), string description = default(string), double discountPercent = default(double), string id = default(string), string name = default(string), List<string> productCategories = default(List<string>))
        {
