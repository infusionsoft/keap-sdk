...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Throwable : IValidatableObject
    {
        ...
        public Throwable(Throwable cause = default, string localizedMessage = default, string message = default, List<StackTraceElement> stackTrace = default, List<Throwable> suppressed = default)
        {
            this.Cause = cause;
