...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RemoveContactsFromSequenceRequest : IValidatableObject
    {
        ...
        protected RemoveContactsFromSequenceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveContactsFromSequenceRequest" /> class.
        /// </summary>
        /// <param name="contactIds">List of contact IDs to remove from the sequence (required).</param>
        public RemoveContactsFromSequenceRequest(List<string> contactIds = default)
        {
            // to ensure "contactIds" is required (not null)
            if (contactIds == null)
            {
                throw new ArgumentNullException("contactIds is a required property for RemoveContactsFromSequenceRequest and cannot be null");
            }
            this.ContactIds = contactIds;
        }

        /// <summary>
        /// List of contact IDs to remove from the sequence
        /// </summary>
        /// <value>List of contact IDs to remove from the sequence</value>
        /*
