...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ListAutomationIdsResponse : IValidatableObject
    {
        ...
        public ListAutomationIdsResponse(List<string> automationIds = default(List<string>), List<string> lockedAutomationIds = default(List<string>), string nextPageToken = default(string))
        {
