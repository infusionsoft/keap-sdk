...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ListFreeTrialDiscountsResponse : IValidatableObject
    {
        ...
        public ListFreeTrialDiscountsResponse(List<FreeTrialDiscount> discounts = default(List<FreeTrialDiscount>), string nextPageToken = default(string))
        {
        ...
        public List<FreeTrialDiscount> Discounts { get; set; }
