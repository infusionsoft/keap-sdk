...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateRestOrderItemRequest : IValidatableObject
    {
        ...
        public CreateRestOrderItemRequest(string description = default(string), ItemTypeEnum? itemType = default(ItemTypeEnum?), double price = default(double), string productId = default(string), int quantity = default(int))
        {
