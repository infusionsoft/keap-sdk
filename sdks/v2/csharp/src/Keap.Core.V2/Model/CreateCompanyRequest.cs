...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateCompanyRequest : IValidatableObject
    {
        ...
        public CreateCompanyRequest(Address address = default, string companyName = default, List<CustomFieldValue> customFields = default, EmailAddress emailAddress = default, FaxNumber faxNumber = default, string notes = default, PhoneNumber phoneNumber = default, string website = default)
        {
