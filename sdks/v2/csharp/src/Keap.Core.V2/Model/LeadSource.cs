...
namespace Keap.Core.V2.Model
{
    ...
    public partial class LeadSource : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The status of this lead source</value>
        ...
        /// <param name="description">The description of this lead source.</param>
        /// <param name="endTime">The time that this lead source will end.</param>
        /// <param name="id">The unique identifier for thia lead source.</param>
        /// <param name="leadSourceCategoryId">The ID of of the category that this lead source belongs to.</param>
        /// <param name="medium">The medium of the lead source.</param>
        /// <param name="message">The message/content of the lead source.</param>
        /// <param name="name">The name of this lead source.</param>
        /// <param name="startTime">The time that this lead source started.</param>
        /// <param name="status">The status of this lead source.</param>
        ...
        public LeadSource(string createTime = default(string), string description = default(string), string endTime = default(string), string id = default(string), string leadSourceCategoryId = default(string), string medium = default(string), string message = default(string), string name = default(string), string startTime = default(string), StatusEnum? status = default(StatusEnum?), string updateTime = default(string), string vendor = default(string))
        {
        ...
        /// </summary>
        /// <value>The description of this lead source</value>
        ...
        /// </summary>
        /// <value>The unique identifier for thia lead source</value>
        ...
        /// </summary>
        /// <value>The ID of of the category that this lead source belongs to</value>
        ...
        /// </summary>
        /// <value>The name of this lead source</value>
