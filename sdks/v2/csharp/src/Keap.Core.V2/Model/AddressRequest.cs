...
namespace Keap.Core.V2.Model
{
    ...
    public partial class AddressRequest : IValidatableObject
    {
        ...
        public AddressRequest(string countryCode = default, FieldEnum? field = default, string line1 = default, string line2 = default, string locality = default, string postalCode = default, string regionCode = default)
        {
