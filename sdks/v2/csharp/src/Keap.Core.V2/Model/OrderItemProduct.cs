...
namespace Keap.Core.V2.Model
{
    ...
    public partial class OrderItemProduct : IValidatableObject
    {
        ...
        public OrderItemProduct(bool active = default(bool), string createdTime = default(string), string description = default(string), string id = default(string), string lastUpdatedTime = default(string), string name = default(string), List<RestProductOption> productOptions = default(List<RestProductOption>), double productPrice = default(double), string productShortDescription = default(string), bool shippable = default(bool), string sku = default(string), bool subscriptionOnly = default(bool), List<RestSubscriptionPlan> subscriptionPlans = default(List<RestSubscriptionPlan>), bool taxable = default(bool), string url = default(string))
        {
            this.Active = active;
