...
namespace Keap.Core.V2.Model
{
    ...
    public partial class OrderItemProduct : IValidatableObject
    {
        ...
        public OrderItemProduct(bool active = default, string createdTime = default, string description = default, string id = default, string lastUpdatedTime = default, string name = default, List<RestProductOption> productOptions = default, double productPrice = default, string productShortDescription = default, bool shippable = default, string sku = default, bool subscriptionOnly = default, List<RestSubscriptionPlan> subscriptionPlans = default, bool taxable = default, string url = default)
        {
            this.Active = active;
