...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestSubscriptionPlan : IValidatableObject
    {
        ...
        */
        ...
        public RestSubscriptionPlan(bool active = default(bool), CycleEnum? cycle = default(CycleEnum?), int frequency = default(int), string id = default(string), int numberOfCycles = default(int), CurrencyValue planPrice = default(CurrencyValue), int subscriptionPlanIndex = default(int), string subscriptionPlanName = default(string))
        {
            this.Active = active;
            this.Cycle = cycle;
