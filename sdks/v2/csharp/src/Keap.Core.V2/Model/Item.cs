...
namespace Keap.Core.V2.Model
{
    ...
    public partial class Item : IValidatableObject
    {
        ...
        public Item(string id = default, string name = default, string nextItemId = default, string previousItemId = default, TypeEnum? type = default)
        {
            this.Id = id;
            this.Name = name;
