...
namespace Keap.Core.V2.Model
{
    ...
    public partial class FunnelIntegrationTriggerResultDTO : IValidatableObject
    {
        ...
        public FunnelIntegrationTriggerResultDTO(long automationId = default, long goalId = default, string message = default, string schemaData = default, bool success = default)
        {
