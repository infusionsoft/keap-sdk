...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductDiscount : IValidatableObject
    {
        ...
        public ProductDiscount(bool applyToCommissions = default(bool), List<DiscountCriteria> criteria = default(List<DiscountCriteria>), string description = default(string), DiscountTypeEnum? discountType = default(DiscountTypeEnum?), double discountValue = default(double), string id = default(string), string name = default(string), string productId = default(string))
        {
