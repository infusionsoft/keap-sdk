...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductDiscount : IValidatableObject
    {
        ...
        public ProductDiscount(bool applyToCommissions = default, List<DiscountCriteria> criteria = default, string description = default, DiscountTypeEnum? discountType = default, double discountValue = default, string id = default, string name = default, string productId = default)
        {
