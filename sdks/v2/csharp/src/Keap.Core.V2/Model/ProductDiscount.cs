...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ProductDiscount : IValidatableObject
    {
        ...
        */
        ...
        /// </summary>
        /// <param name="id">Unique identifier for this product discount.</param>
        ...
        public ProductDiscount(string id = default, string name = default, string description = default, List<DiscountCriteria> criteria = default, bool applyToCommissions = default, string productId = default, DiscountTypeEnum? discountType = default, double discountValue = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        /// </summary>
        /// <value>Unique identifier for this product discount</value>
        /*
        <example>101</example>
        */
