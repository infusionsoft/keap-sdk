...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestCreateOrderRequest : IValidatableObject
    {
        ...
        public RestCreateOrderRequest(string contactId = default, string leadAffiliateId = default, string notes = default, List<CreateOrderItemRequest> orderItems = default, string orderTime = default, string orderTitle = default, OrderTypeEnum? orderType = default, List<string> promoCodes = default, string salesAffiliateId = default, AddressInformation shippingAddress = default, string terms = default)
        {
