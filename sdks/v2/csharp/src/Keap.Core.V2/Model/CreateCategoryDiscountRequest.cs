...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateCategoryDiscountRequest : IValidatableObject
    {
        ...
        /// <param name="discountPercent">The discount percent. Must be greater than or equal to 0. (required).</param>
        /// <param name="name">name (required).</param>
        /// <param name="productCategoryIds">productCategoryIds (required).</param>
        public CreateCategoryDiscountRequest(bool applyToCommissions = default, List<DiscountCriteria> criteria = default, string description = default, double discountPercent = default, string name = default, List<string> productCategoryIds = default)
        {
