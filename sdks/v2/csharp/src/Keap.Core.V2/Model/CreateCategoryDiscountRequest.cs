...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateCategoryDiscountRequest : IValidatableObject
    {
        ...
        /// <param name="applyToCommissions">Whether to apply this discount to commission calculations (required).</param>
        /// <param name="discountPercent">Percentage discount to apply. Must be greater than or equal to 0. (required).</param>
        /// <param name="productCategoryIds">List of product category IDs this discount applies to (required).</param>
        public CreateCategoryDiscountRequest(string name = default, string description = default, List<CategoryDiscountCriteriaRequest> criteria = default, bool applyToCommissions = default, double discountPercent = default, List<string> productCategoryIds = default)
        {
