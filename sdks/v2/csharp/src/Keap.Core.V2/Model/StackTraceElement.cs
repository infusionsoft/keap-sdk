...
namespace Keap.Core.V2.Model
{
    ...
    public partial class StackTraceElement : IValidatableObject
    {
        ...
        public StackTraceElement(string classLoaderName = default, string className = default, string fileName = default, int lineNumber = default, string methodName = default, string moduleName = default, string moduleVersion = default, bool nativeMethod = default)
        {
