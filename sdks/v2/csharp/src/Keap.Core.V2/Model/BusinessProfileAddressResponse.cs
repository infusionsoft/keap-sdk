...
namespace Keap.Core.V2.Model
{
    ...
    public partial class BusinessProfileAddressResponse : IValidatableObject
    {
        ...
        public BusinessProfileAddressResponse(string countryCode = default, string line1 = default, string line2 = default, string locality = default, string postalCode = default, string region = default)
        {
