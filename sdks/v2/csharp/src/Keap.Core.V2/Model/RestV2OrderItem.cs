...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestV2OrderItem : IValidatableObject
    {
        ...
        public RestV2OrderItem(CurrencyValue cost = default(CurrencyValue), string description = default(string), CurrencyValue discount = default(CurrencyValue), string id = default(string), ItemTypeEnum? itemType = default(ItemTypeEnum?), string name = default(string), string notes = default(string), List<OrderItemTax> orderItemTaxes = default(List<OrderItemTax>), CurrencyValue price = default(CurrencyValue), OrderItemProduct product = default(OrderItemProduct), int quantity = default(int), Discount special = default(Discount), RestV2Subscription subscription = default(RestV2Subscription), string subscriptionId = default(string), RestSubscriptionPlan subscriptionPlan = default(RestSubscriptionPlan))
        {
            this.Cost = cost;
