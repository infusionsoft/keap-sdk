...
namespace Keap.Core.V2.Model
{
    ...
    public partial class RestV2OrderItem : IValidatableObject
    {
        ...
        public RestV2OrderItem(CurrencyValue costPerUnit = default, string description = default, CurrencyValue discount = default, string id = default, ItemTypeEnum? itemType = default, string name = default, string notes = default, List<OrderItemTax> orderItemTaxes = default, CurrencyValue pricePerUnit = default, OrderItemProduct product = default, int quantity = default, Discount special = default, RestV2Subscription subscription = default, string subscriptionId = default, RestSubscriptionPlan subscriptionPlan = default)
        {
