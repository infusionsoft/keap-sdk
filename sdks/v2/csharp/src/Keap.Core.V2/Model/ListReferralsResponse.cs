...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListReferralsResponse")]
    public partial class ListReferralsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListReferralsResponse" /> class.
        /// </summary>
        /// <param name="referrals">referrals.</param>
        /// <param name="nextPageToken">nextPageToken.</param>
        public ListReferralsResponse(List<Referral> referrals = default, string nextPageToken = default)
        {
