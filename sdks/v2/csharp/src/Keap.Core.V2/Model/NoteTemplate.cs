...
namespace Keap.Core.V2.Model
{
    ...
    public partial class NoteTemplate : IValidatableObject
    {
        ...
        public NoteTemplate(ActionTypeEnum? actionType = default, long assignmentUserId = default, string description = default, string id = default, List<string> notifyUsers = default, string title = default)
        {
