...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateOrderItemRequest : IValidatableObject
    {
        ...
        public UpdateOrderItemRequest(bool chargeInventory = default, double costPerUnit = default, string description = default, string name = default, string note = default, double pricePerUnit = default, int quantity = default, TypeEnum? type = default)
        {
