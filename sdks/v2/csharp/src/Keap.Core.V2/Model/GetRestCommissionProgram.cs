...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetRestCommissionProgram")]
    public partial class GetRestCommissionProgram : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRestCommissionProgram" /> class.
        /// </summary>
        ...
        public GetRestCommissionProgram(string id = default, string name = default, string priority = default, string notes = default, string createTime = default, List<string> affiliateIds = default, DefaultCommission defaultCommission = default, List<ProductCommission> productCommissions = default, List<SubscriptionCommission> subscriptionCommissions = default)
        {
            this.Id = id;
            this.Name = name;
