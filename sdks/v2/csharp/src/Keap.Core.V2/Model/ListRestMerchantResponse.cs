...
namespace Keap.Core.V2.Model
{
    ...
    public partial class ListRestMerchantResponse : IValidatableObject
    {
        ...
        public ListRestMerchantResponse(string defaultMerchantAccountId = default, List<ListRestMerchantAccountResponse> merchantAccounts = default, string nextPageToken = default)
        {
