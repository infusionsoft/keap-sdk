...
/**
 * CreateFreeTrialDiscountRequest Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class CreateFreeTrialDiscountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateFreeTrialDiscountRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('free_trial_days', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int|null $free_trial_days The number of free trial days. Must be a positive number. Defaults to 0.
     *
     * @return self
     */
    public function setFreeTrialDays($free_trial_days)
    {
        if (is_null($free_trial_days)) {
            throw new \InvalidArgumentException('non-nullable free_trial_days cannot be null');
        }
     ...
     *
     * @param string $subscription_plan_id subscription_plan_id
     *
     * @return self
     */
