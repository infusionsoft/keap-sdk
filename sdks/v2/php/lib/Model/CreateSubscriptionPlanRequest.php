...
class CreateSubscriptionPlanRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets frequency
     *
     * @param int|null $frequency The frequency of the subscription plan. Must be greater than 0. Default is 1.
     *
     * @return self
     */
     ...
     * Sets plan_price
     *
     * @param float $plan_price The price of the subscription plan in the smallest currency unit. Must be greater than or equal to 0.
     *
     * @return self
     */
