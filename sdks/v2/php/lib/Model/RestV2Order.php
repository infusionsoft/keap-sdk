...
class RestV2Order implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ORDER_TYPE_UNKNOWN = 'UNKNOWN';
    ...
    */
     ...
     * Sets creation_time
     *
     * @param string|null $creation_time When this order was originally created. In ISO-8601 format (e.g. 2024-05-21T23:00:00Z)
     *
     * @return self
     */
     ...
     *
     * @param string|null $modification_time When this order was changed. In ISO-8601 format (e.g. 2024-05-21T23:00:00Z)
     *
     * @return self
     */
     ...
     * Sets order_time
     *
     * @param string|null $order_time A user-defined date and time of the order. In ISO-8601 format (e.g. 2024-05-21T23:00:00Z)
     *
     * @return self
     */
     ...
     * Sets refund_total
     *
     * @param \Keap\Core\V2\Model\CurrencyValue|null $refund_total refund_total
     *
     * @return self
     */
     ...
     * Sets source_type
     *
     * @param string|null $source_type The source where the order was created. Valid values include: API, CHECKOUT_FORM, INVOICE, MANUAL_PAYMENT, QUICKBOOKS, UNKNOWN.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The order status. Valid values are: DRAFT, SENT, VIEWED, PAID.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param \Keap\Core\V2\Model\CurrencyValue|null $total total
     *
     * @return self
     */
     ...
     * Sets total_due
     *
     * @param \Keap\Core\V2\Model\CurrencyValue|null $total_due total_due
     *
     * @return self
     */
     ...
     * Sets total_paid
     *
     * @param \Keap\Core\V2\Model\CurrencyValue|null $total_paid total_paid
     *
     * @return self
     */
