...
```python
from keap_core_v2_client.models.update_order_total_discount_criteria import UpdateOrderTotalDiscountCriteria

# TODO update the JSON string below
json = "{}"
# create an instance of UpdateOrderTotalDiscountCriteria from a JSON string
update_order_total_discount_criteria_instance = UpdateOrderTotalDiscountCriteria.from_json(json)
# print the JSON string representation of the object
print(UpdateOrderTotalDiscountCriteria.to_json())

# convert the object into a dict
update_order_total_discount_criteria_dict = update_order_total_discount_criteria_instance.to_dict()
# create an instance of UpdateOrderTotalDiscountCriteria from a dict
update_order_total_discount_criteria_from_dict = UpdateOrderTotalDiscountCriteria.from_dict(update_order_total_discount_criteria_dict)
```
