...
**custom_fields** | [**List[CustomFieldValue]**](CustomFieldValue.md) | Any item not listed here will be removed if it already exists. If an empty array is specified, all existing values will be removed. | [optional] 
**email_addresses** | [**List[EmailAddressRequest]**](EmailAddressRequest.md) | Any item not listed here will be removed if it already exists. If an empty array is specified, all existing values will be removed. | [optional] 
**family_name** | **str** | Last name / surname | [optional] 
**fax_numbers** | [**List[FaxNumber]**](FaxNumber.md) | Any item not listed here will be removed if it already exists. If an empty array is specified, all existing values will be removed. | [optional] 
...
**phone_numbers** | [**List[PhoneNumber]**](PhoneNumber.md) | Any item not listed here will be removed if it already exists. If an empty array is specified, all existing values will be removed. | [optional] 
...
**social_accounts** | [**List[SocialAccount]**](SocialAccount.md) | Any item not listed here will be removed if it already exists. If an empty array is specified, all existing values will be removed. | [optional] 
...
**assistant_name** | **str** | Assistant&#39;s name | [optional] 
**assistant_phone** | **str** | Assistant&#39;s phone number | [optional] 
**billing_information** | **str** | Billing information | [optional] 
