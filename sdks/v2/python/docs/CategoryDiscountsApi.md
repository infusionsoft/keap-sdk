...
[**create_category_discount_criteria**](CategoryDiscountsApi.md#create_category_discount_criteria) | **POST** /rest/v2/discounts/productCategories/{discount_id}/criteria | Create a Category Discount Criteria
...
[**delete_category_discount_criteria**](CategoryDiscountsApi.md#delete_category_discount_criteria) | **DELETE** /rest/v2/discounts/productCategories/{discount_id}/criteria/{criteria_id} | Delete a Category Discount Criteria
...
# **create_category_discount_criteria**
> DiscountCriteria create_category_discount_criteria(discount_id, create_category_discount_criteria)
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    create_category_discount_criteria = keap_core_v2_client.CreateCategoryDiscountCriteria() # CreateCategoryDiscountCriteria | 

    try:
        # Create a Category Discount Criteria
        api_response = api_instance.create_category_discount_criteria(discount_id, create_category_discount_criteria)
        print("The response of CategoryDiscountsApi->create_category_discount_criteria:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CategoryDiscountsApi->create_category_discount_criteria: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **discount_id** | **str**|  | 
 **create_category_discount_criteria** | [**CreateCategoryDiscountCriteria**](CreateCategoryDiscountCriteria.md)|  | 
...
# **delete_category_discount_criteria**
> delete_category_discount_criteria(discount_id, criteria_id)
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a Category Discount Criteria
        api_instance.delete_category_discount_criteria(discount_id, criteria_id)
    except Exception as e:
        print("Exception when calling CategoryDiscountsApi->delete_category_discount_criteria: %s\n" % e)
```
