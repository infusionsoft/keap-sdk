...
json = "{}"
# create an instance of CreateShippingDiscountCriteria from a JSON string
create_shipping_discount_criteria_instance = CreateShippingDiscountCriteria.from_json(json)
# print the JSON string representation of the object
print(CreateShippingDiscountCriteria.to_json())

# convert the object into a dict
create_shipping_discount_criteria_dict = create_shipping_discount_criteria_instance.to_dict()
# create an instance of CreateShippingDiscountCriteria from a dict
create_shipping_discount_criteria_from_dict = CreateShippingDiscountCriteria.from_dict(create_shipping_discount_criteria_dict)
```
