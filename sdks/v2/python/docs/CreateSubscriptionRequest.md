...
**shipping_address** | [**AddressRequest**](AddressRequest.md) | The shipping address for the subscription. | [optional] 
...
**custom_fields** | [**List[CustomFieldValue]**](CustomFieldValue.md) | List of custom field values to apply to this subscription | [optional] 
