...
**error_message** | **str** | An error message to display if any rules are broken. | [optional] 
...
json = "{}"
# create an instance of TextOption from a JSON string
text_option_instance = TextOption.from_json(json)
# print the JSON string representation of the object
print(TextOption.to_json())

# convert the object into a dict
text_option_dict = text_option_instance.to_dict()
# create an instance of TextOption from a dict
text_option_from_dict = TextOption.from_dict(text_option_dict)
```
