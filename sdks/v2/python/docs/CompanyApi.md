...
[**create_company_custom_field_tab**](CompanyApi.md#create_company_custom_field_tab) | **POST** /rest/v2/companies/model/customFields/tabs | Create a Company Custom Field Tab
...
[**delete_company_custom_field_tab**](CompanyApi.md#delete_company_custom_field_tab) | **DELETE** /rest/v2/companies/model/customFields/tabs/{tab_id} | Delete a Company Custom Field Tab
...
[**get_company_custom_field_tab**](CompanyApi.md#get_company_custom_field_tab) | **GET** /rest/v2/companies/model/customFields/tabs/{tab_id} | Retrieve a Company Custom Field Tab
...
[**list_company_custom_field_tabs**](CompanyApi.md#list_company_custom_field_tabs) | **GET** /rest/v2/companies/model/customFields/tabs | List Company Custom Field Tabs
...
[**update_company_custom_field_tab**](CompanyApi.md#update_company_custom_field_tab) | **PATCH** /rest/v2/companies/model/customFields/tabs/{tab_id} | Update a Company Custom Field Tab
...
# **create_company_custom_field_tab**
> CustomFieldTab create_company_custom_field_tab(create_custom_field_tab_request)
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a Company Custom Field Tab
        api_response = api_instance.create_company_custom_field_tab(create_custom_field_tab_request)
        print("The response of CompanyApi->create_company_custom_field_tab:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CompanyApi->create_company_custom_field_tab: %s\n" % e)
```
...
# **delete_company_custom_field_tab**
> delete_company_custom_field_tab(tab_id)
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a Company Custom Field Tab
        api_instance.delete_company_custom_field_tab(tab_id)
    except Exception as e:
        print("Exception when calling CompanyApi->delete_company_custom_field_tab: %s\n" % e)
```
...
# **get_company_custom_field_tab**
> CustomFieldTab get_company_custom_field_tab(tab_id)
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve a Company Custom Field Tab
        api_response = api_instance.get_company_custom_field_tab(tab_id)
        print("The response of CompanyApi->get_company_custom_field_tab:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CompanyApi->get_company_custom_field_tab: %s\n" % e)
```
...
# **list_company_custom_field_tabs**
> ListCustomFieldTabsResponse list_company_custom_field_tabs()
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Company Custom Field Tabs
        api_response = api_instance.list_company_custom_field_tabs()
        print("The response of CompanyApi->list_company_custom_field_tabs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CompanyApi->list_company_custom_field_tabs: %s\n" % e)
```
...
# **update_company_custom_field_tab**
> CustomFieldTab update_company_custom_field_tab(tab_id, update_mask, update_custom_field_tab_request)
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a Company Custom Field Tab
        api_response = api_instance.update_company_custom_field_tab(tab_id, update_mask, update_custom_field_tab_request)
        print("The response of CompanyApi->update_company_custom_field_tab:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CompanyApi->update_company_custom_field_tab: %s\n" % e)
```
