...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    create_free_trial_discount_request = keap_core_v2_client.CreateFreeTrialDiscountRequest() # CreateFreeTrialDiscountRequest | 
...
------------- | ------------- | ------------- | -------------
 **create_free_trial_discount_request** | [**CreateFreeTrialDiscountRequest**](CreateFreeTrialDiscountRequest.md)|  | 
