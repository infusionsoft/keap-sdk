...
json = "{}"
# create an instance of CreateOrderTotalDiscountCriteria from a JSON string
create_order_total_discount_criteria_instance = CreateOrderTotalDiscountCriteria.from_json(json)
# print the JSON string representation of the object
print(CreateOrderTotalDiscountCriteria.to_json())

# convert the object into a dict
create_order_total_discount_criteria_dict = create_order_total_discount_criteria_instance.to_dict()
# create an instance of CreateOrderTotalDiscountCriteria from a dict
create_order_total_discount_criteria_from_dict = CreateOrderTotalDiscountCriteria.from_dict(create_order_total_discount_criteria_dict)
```
