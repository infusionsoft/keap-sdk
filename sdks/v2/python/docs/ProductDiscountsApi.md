...
[**create_product_discount_criteria**](ProductDiscountsApi.md#create_product_discount_criteria) | **POST** /rest/v2/discounts/products/{discount_id}/criteria | Create a Product Discount Criteria
...
[**delete_product_discount_criteria**](ProductDiscountsApi.md#delete_product_discount_criteria) | **DELETE** /rest/v2/discounts/products/{discount_id}/criteria/{criteria_id} | Delete a Product Discount Criteria
...
# **create_product_discount_criteria**
> DiscountCriteria create_product_discount_criteria(discount_id, create_product_discount_criteria)
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    create_product_discount_criteria = keap_core_v2_client.CreateProductDiscountCriteria() # CreateProductDiscountCriteria | 

    try:
        # Create a Product Discount Criteria
        api_response = api_instance.create_product_discount_criteria(discount_id, create_product_discount_criteria)
        print("The response of ProductDiscountsApi->create_product_discount_criteria:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductDiscountsApi->create_product_discount_criteria: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **discount_id** | **str**|  | 
 **create_product_discount_criteria** | [**CreateProductDiscountCriteria**](CreateProductDiscountCriteria.md)|  | 
...
# **delete_product_discount_criteria**
> delete_product_discount_criteria(discount_id, criteria_id)
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a Product Discount Criteria
        api_instance.delete_product_discount_criteria(discount_id, criteria_id)
    except Exception as e:
        print("Exception when calling ProductDiscountsApi->delete_product_discount_criteria: %s\n" % e)
```
