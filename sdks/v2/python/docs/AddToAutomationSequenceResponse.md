...
------------ | ------------- | ------------- | -------------
**add_to_automation_sequence_results** | **Dict[str, str]** | A map containing the contact ID as key and the result of adding them to the sequence as value | [optional] 
