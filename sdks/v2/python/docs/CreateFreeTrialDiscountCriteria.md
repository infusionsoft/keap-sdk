...
json = "{}"
# create an instance of CreateFreeTrialDiscountCriteria from a JSON string
create_free_trial_discount_criteria_instance = CreateFreeTrialDiscountCriteria.from_json(json)
# print the JSON string representation of the object
print(CreateFreeTrialDiscountCriteria.to_json())

# convert the object into a dict
create_free_trial_discount_criteria_dict = create_free_trial_discount_criteria_instance.to_dict()
# create an instance of CreateFreeTrialDiscountCriteria from a dict
create_free_trial_discount_criteria_from_dict = CreateFreeTrialDiscountCriteria.from_dict(create_free_trial_discount_criteria_dict)
```
