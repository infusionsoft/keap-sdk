...
------------- | ------------- | -------------
[**get_html**](WebformsApi.md#get_html) | **GET** /rest/v2/webforms/{webform_id}:data | Get Webform HTML
[**list_webforms**](WebformsApi.md#list_webforms) | **GET** /rest/v2/webforms | List Webforms with filter


# **get_html**
> str get_html(webform_id)
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    webform_id = 'webform_id_example' # str | 
