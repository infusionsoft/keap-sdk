...
json = "{}"
# create an instance of UpdateProductDiscountCriteria from a JSON string
update_product_discount_criteria_instance = UpdateProductDiscountCriteria.from_json(json)
# print the JSON string representation of the object
print(UpdateProductDiscountCriteria.to_json())

# convert the object into a dict
update_product_discount_criteria_dict = update_product_discount_criteria_instance.to_dict()
# create an instance of UpdateProductDiscountCriteria from a dict
update_product_discount_criteria_from_dict = UpdateProductDiscountCriteria.from_dict(update_product_discount_criteria_dict)
```
