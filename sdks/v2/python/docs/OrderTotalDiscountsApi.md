...
[**create_order_total_discount_criteria**](OrderTotalDiscountsApi.md#create_order_total_discount_criteria) | **POST** /rest/v2/discounts/orderTotals/{discount_id}/criteria | Create an Order Total Discount Criteria
...
[**delete_order_total_discount_criteria**](OrderTotalDiscountsApi.md#delete_order_total_discount_criteria) | **DELETE** /rest/v2/discounts/orderTotals/{discount_id}/criteria/{criteria_id} | Delete an Order Total Discount Criteria
...
# **create_order_total_discount_criteria**
> DiscountCriteria create_order_total_discount_criteria(discount_id, create_order_total_discount_criteria)
...
```python
import keap_core_v2_client
from keap_core_v2_client.models.create_order_total_discount_criteria import CreateOrderTotalDiscountCriteria
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    create_order_total_discount_criteria = keap_core_v2_client.CreateOrderTotalDiscountCriteria() # CreateOrderTotalDiscountCriteria | 

    try:
        # Create an Order Total Discount Criteria
        api_response = api_instance.create_order_total_discount_criteria(discount_id, create_order_total_discount_criteria)
        print("The response of OrderTotalDiscountsApi->create_order_total_discount_criteria:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrderTotalDiscountsApi->create_order_total_discount_criteria: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **discount_id** | **str**|  | 
 **create_order_total_discount_criteria** | [**CreateOrderTotalDiscountCriteria**](CreateOrderTotalDiscountCriteria.md)|  | 
...
# **delete_order_total_discount_criteria**
> delete_order_total_discount_criteria(discount_id, criteria_id)
...
with keap_core_v2_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete an Order Total Discount Criteria
        api_instance.delete_order_total_discount_criteria(discount_id, criteria_id)
    except Exception as e:
        print("Exception when calling OrderTotalDiscountsApi->delete_order_total_discount_criteria: %s\n" % e)
```
