...
json = "{}"
# create an instance of UpdateFreeTrialDiscountCriteria from a JSON string
update_free_trial_discount_criteria_instance = UpdateFreeTrialDiscountCriteria.from_json(json)
# print the JSON string representation of the object
print(UpdateFreeTrialDiscountCriteria.to_json())

# convert the object into a dict
update_free_trial_discount_criteria_dict = update_free_trial_discount_criteria_instance.to_dict()
# create an instance of UpdateFreeTrialDiscountCriteria from a dict
update_free_trial_discount_criteria_from_dict = UpdateFreeTrialDiscountCriteria.from_dict(update_free_trial_discount_criteria_dict)
```
