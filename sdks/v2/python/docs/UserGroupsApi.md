...
------------- | ------------- | -------------
[**get_user_group**](UserGroupsApi.md#get_user_group) | **GET** /rest/v2/userGroups/{user_group_id} | Retrieve a User Group
[**list_user_groups**](UserGroupsApi.md#list_user_groups) | **GET** /rest/v2/userGroups | List User Groups
