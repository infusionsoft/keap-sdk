...
class ShippingInformation(BaseModel):
    ...
    ShippingInformation
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Shipping information ID")
    ...
    family_name: Optional[StrictStr] = Field(default=None, description="Last name")
    phone_number: Optional[StrictStr] = Field(default=None, description="Phone number")
    invoice_to_company: Optional[StrictBool] = Field(default=None, description="Whether to invoice to company")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "address", "company", "given_name", "family_name", "phone_number", "invoice_to_company"]
