...
class SequencePath(BaseModel):
    ...
    SequencePath
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the sequence path")
    items: Optional[List[Item]] = Field(default=None, description="List of items in this sequence path")
