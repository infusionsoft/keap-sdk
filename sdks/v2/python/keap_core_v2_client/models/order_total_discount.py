...
class OrderTotalDiscount(BaseModel):
    ...
    OrderTotalDiscount
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this order total discount")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "criteria", "apply_to_commissions", "discount_type", "discount_value", "discount_strategy"]
