...
class UpdateOrderTotalDiscountRequest(BaseModel):
    ...
    criteria: Optional[List[UpdateOrderTotalDiscountCriteria]] = Field(default=None, description="List of criteria that must be met for this discount to apply")
    ...
    discount_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value of the discount (amount or percentage depending on discount_type)")
    discount_strategy: Optional[StrictStr] = Field(default=None, description="Strategy for applying discount: GROSS (before tax) or NET (after tax)")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "criteria", "apply_to_commissions", "discount_type", "discount_value", "discount_strategy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "criteria": [UpdateOrderTotalDiscountCriteria.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None,
