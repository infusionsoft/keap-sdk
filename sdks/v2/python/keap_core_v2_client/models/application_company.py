...
class ApplicationCompany(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "country", "email", "city", "state", "zip", "phone", "website", "street_address_1", "street_address_2", "phone_ext", "caller_id_number", "web_logo_url"]
