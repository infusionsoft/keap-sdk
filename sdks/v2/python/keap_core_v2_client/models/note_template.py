...
class NoteTemplate(BaseModel):
    ...
    action_type: Optional[StrictStr] = Field(default=None, description="Note action type")
    assignment_user_id: Optional[StrictInt] = Field(default=None, description="Default assigned user ID")
