...
class ListTransactions(BaseModel):
    ...
    ListTransactions
    """ # noqa: E501
    transactions: Optional[List[TransactionV2]] = None
    next_page_token: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["transactions", "next_page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [TransactionV2.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None,
