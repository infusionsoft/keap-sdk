...
class UpdateUserRequest(BaseModel):
    ...
    email_address: Optional[EmailAddressRequest] = Field(default=None, description="The user's email address")
    ...
    time_zone: Optional[StrictStr] = Field(default=None, description="The user's timezone in IANA format")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["address", "title", "website", "company_name", "email_address", "family_name", "fax_numbers", "given_name", "phone_numbers", "time_zone"]
