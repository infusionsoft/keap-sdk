...
class ListCustomFieldTabsResponse(BaseModel):
    """
    ListCustomFieldTabsResponse
    """ # noqa: E501
    tabs: Optional[List[CustomFieldTab]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tabs": [CustomFieldTab.from_dict(_item) for _item in obj["tabs"]] if obj.get("tabs") is not None else None
        })
