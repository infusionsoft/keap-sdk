...
class CategoryDiscount(BaseModel):
    ...
    CategoryDiscount
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this category discount")
    ...
    criteria: Optional[List[CategoryDiscountCriteriaResponse]] = Field(default=None, description="List of criteria that must be met for this discount to apply")
    discount_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Percentage discount to apply (0-100)")
    ...
    product_categories: Optional[List[StrictStr]] = Field(default=None, description="List of product category IDs this discount applies to")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "description", "criteria", "discount_percent", "apply_to_commissions", "product_categories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "criteria": [CategoryDiscountCriteriaResponse.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None,
