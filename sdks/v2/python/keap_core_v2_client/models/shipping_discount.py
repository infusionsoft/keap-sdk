...
class ShippingDiscount(BaseModel):
    ...
    ShippingDiscount
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this shipping discount")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "criteria", "discount_type", "discount_value"]
