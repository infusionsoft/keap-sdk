...
class ListCompanyTagsResponse(BaseModel):
    """
    List of tags applied to a company
    """ # noqa: E501
    tags: Optional[List[AppliedTag]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tags": [AppliedTag.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None,
