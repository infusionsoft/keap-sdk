...
class CreateProductCommissionProgramRequest(BaseModel):
    ...
    product_id: Optional[StrictStr] = Field(default=None, description="Product ID to assign commission")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["percentage", "unused", "dollar_amount", "level_1", "level_2", "payout_type", "product_id"]
