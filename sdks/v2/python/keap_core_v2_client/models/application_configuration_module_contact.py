...
class ApplicationConfigurationModuleContact(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["title_types", "suffix_types", "contact_types", "phone_types", "fax_types", "address_labels", "disable_contact_edit_in_client_login", "default_new_contact_form"]
