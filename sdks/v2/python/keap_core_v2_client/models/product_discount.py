...
class ProductDiscount(BaseModel):
    ...
    ProductDiscount
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this product discount")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "criteria", "apply_to_commissions", "product_id", "discount_type", "discount_value"]
