...
class CreateEmailSentRequest(BaseModel):
    ...
    sent_to_address: StrictStr = Field(description="The email address the email was sent to")
    ...
    __properties: ClassVar[List[str]] = ["subject", "headers", "contact_id", "sent_to_address", "sent_to_cc_address_list", "sent_to_bcc_address_list", "sent_from_address", "sent_from_reply_address", "sent_time", "received_time", "opened_time", "clicked_time", "plain_content", "html_content", "original_provider", "original_provider_id", "provider_source_id"]
