...
class RestV2ProductDetail(BaseModel):
    """
    RestV2ProductDetail
    """ # noqa: E501
    ...
    price: Optional[CurrencyValueDetail] = Field(default=None, description="The product price")
    ...
    options: Optional[List[ProductOptionsDetail]] = Field(default=None, description="List of product options. Can be empty.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "price": CurrencyValueDetail.from_dict(obj["price"]) if obj.get("price") is not None else None,
            ...
            "options": [ProductOptionsDetail.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
