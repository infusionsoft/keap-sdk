...
class TaggedContact(BaseModel):
    ...
    applied_time: Optional[datetime] = Field(default=None, description="The time the tag was applied to the contact, in ISO 8601 format.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "email", "given_name", "family_name", "applied_time"]
