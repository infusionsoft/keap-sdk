...
class AutomationCategory(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the category")
    name: Optional[StrictStr] = Field(default=None, description="The name of the category")
    automation_count: Optional[StrictInt] = Field(default=None, description="Number of automations in this category")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "automation_count"]
