...
class UpdateSubscriptionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["quantity", "active", "contact_id", "subscription_plan_id", "billing_amount", "auto_charge", "max_charge_attempts", "days_between_retries", "billing_frequency", "billing_cycle", "next_bill_date", "end_date", "payment_method_id", "allow_tax", "lead_affiliate_id", "sale_affiliate_id", "shipping_address", "promo_code", "shipping_option_id", "reason_stopped", "custom_fields"]
