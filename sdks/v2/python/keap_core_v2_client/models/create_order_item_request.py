...
class CreateOrderItemRequest(BaseModel):
    ...
    def item_type_validate_enum(cls, value):
        ...
        if value not in set(['PRODUCT', 'SHIPPING', 'TAX', 'FINANCE_CHARGE', 'SUBSCRIPTION', 'DISCOUNT', 'DISCOUNT_FREE_TRIAL', 'DISCOUNT_ORDER_TOTAL', 'DISCOUNT_PRODUCT', 'DISCOUNT_PRODUCT_CATEGORY', 'DISCOUNT_SHIPPING', 'OTHER', 'FEE']):
            raise ValueError("must be one of enum values ('PRODUCT', 'SHIPPING', 'TAX', 'FINANCE_CHARGE', 'SUBSCRIPTION', 'DISCOUNT', 'DISCOUNT_FREE_TRIAL', 'DISCOUNT_ORDER_TOTAL', 'DISCOUNT_PRODUCT', 'DISCOUNT_PRODUCT_CATEGORY', 'DISCOUNT_SHIPPING', 'OTHER', 'FEE')")
        return value
