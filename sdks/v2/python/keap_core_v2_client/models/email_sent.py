...
class EmailSent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "subject", "headers", "contact_id", "sent_to_address", "sent_to_cc_address_list", "sent_to_bcc_address_list", "sent_from_address", "sent_from_reply_address", "sent_time", "received_time", "opened_time", "clicked_time", "original_provider_id", "original_provider", "provider_source_id"]
