...
class RestUpdatePaymentRequest(BaseModel):
    """
    ...
    notes: Optional[StrictStr] = Field(default=None, description="Notes or description for the payment.")
    payment_time: Optional[datetime] = Field(default=None, description="The date and time of payment. In ISO-8601 format (e.g. 2024-05-21T23:00:00Z). Can only be modified for manually recorded payments.")
    payment_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The payment amount. Can only be modified for manually recorded payments.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["external_source", "external_source_value", "external_status_value", "external_create_time", "external_update_time", "external_create_user", "notes", "payment_time", "payment_amount"]
