...
class Discount(BaseModel):
    ...
    Discount
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Discount amount")
    special_item_id: Optional[StrictStr] = Field(default=None, description="Discount item ID")
    discount_method: Optional[StrictStr] = Field(default=None, description="Discount method")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["amount", "special_item_id", "discount_method"]
