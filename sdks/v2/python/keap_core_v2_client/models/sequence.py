...
class Sequence(BaseModel):
    ...
    Sequence
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the sequence")
    name: Optional[StrictStr] = Field(default=None, description="The name of the sequence")
    paths: Optional[List[SequencePath]] = Field(default=None, description="List of paths in this sequence")
    active_contact_count: Optional[StrictInt] = Field(default=None, description="Number of contacts currently in this sequence")
    active_contact_count_completed: Optional[StrictInt] = Field(default=None, description="Number of contacts who have completed this sequence")
    historical_contact_count: Optional[HistoricalCounts] = Field(default=None, description="Historical contact counts for this sequence")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "paths", "active_contact_count", "active_contact_count_completed", "historical_contact_count"]
