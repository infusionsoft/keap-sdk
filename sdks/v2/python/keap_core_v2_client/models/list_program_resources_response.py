...
class ListProgramResourcesResponse(BaseModel):
    """
    ListProgramResourcesResponse
    """ # noqa: E501
    resources: Optional[List[AffiliateProgramResource]] = None
    next_page_token: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["resources", "next_page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resources": [AffiliateProgramResource.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None,
