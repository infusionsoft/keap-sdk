...
class ListProductsResponseList(BaseModel):
    """
    ListProductsResponseList
    """ # noqa: E501
    products: Optional[List[RestV2ProductList]] = None
    next_page_token: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["products", "next_page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": [RestV2ProductList.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None,
