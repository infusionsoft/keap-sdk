...
class GetBusinessProfileResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "email", "website", "phone", "address", "time_zone", "logo_url", "currency_code", "language_tag", "business_type", "business_goals", "business_primary_color", "business_secondary_color"]
