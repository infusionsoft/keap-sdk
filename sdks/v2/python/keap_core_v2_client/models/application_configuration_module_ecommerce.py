...
class ApplicationConfigurationModuleEcommerce(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["currency", "default_country", "default_merchant", "credit_card_types", "default_tax", "payment_types", "default_to_auto_charge", "default_charge_max_retry_attempts", "default_number_of_days_between_charge_attempts", "merchant_account_max_retry_attempts", "promo_codes", "track_cost_per_unit", "track_inventory"]
