...
class CreateOpportunityStageRequest(BaseModel):
    ...
    name: StrictStr
    order: StrictInt
    target_number_days: Annotated[int, Field(strict=True, ge=0)]
    probability: Annotated[int, Field(le=100, strict=True, ge=0)]
    checklist_items: Optional[List[CreateOpportunityStageChecklistItem]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "order", "target_number_days", "probability", "checklist_items"]
