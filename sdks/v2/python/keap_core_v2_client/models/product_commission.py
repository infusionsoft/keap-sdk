...
class ProductCommission(BaseModel):
    ...
    product_name: Optional[StrictStr] = Field(default=None, description="Product name")
    product_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Product price")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["payout_type", "dollar_amount", "percentage", "unused", "level_1", "level_2", "product_id", "product_name", "product_price"]
