...
class ProductOptionsDetail(BaseModel):
    """
    ...
    fixed_options: Optional[List[ProductFixedOptionDetail]] = Field(default=None, description="List of option values for the fixed option")
    variable_setting: Optional[ProductVariableSettingDetail] = Field(default=None, description="The option is a user-defined free-form field. The settings define the restrictions on what can be entered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fixed_options": [ProductFixedOptionDetail.from_dict(_item) for _item in obj["fixed_options"]] if obj.get("fixed_options") is not None else None,
            "variable_setting": ProductVariableSettingDetail.from_dict(obj["variable_setting"]) if obj.get("variable_setting") is not None else None
        })
