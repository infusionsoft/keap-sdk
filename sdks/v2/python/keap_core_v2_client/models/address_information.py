...
class AddressInformation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["line1", "line2", "locality", "region", "company", "phone", "zip_code", "zip_four", "country_code", "first_name", "middle_name", "last_name", "is_invoice_to_company"]
