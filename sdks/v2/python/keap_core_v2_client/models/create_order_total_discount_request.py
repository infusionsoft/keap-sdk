...
class CreateOrderTotalDiscountRequest(BaseModel):
    ...
    criteria: Optional[List[CreateOrderTotalDiscountCriteria]] = Field(default=None, description="List of criteria that must be met for this discount to apply")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "criteria": [CreateOrderTotalDiscountCriteria.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None,
