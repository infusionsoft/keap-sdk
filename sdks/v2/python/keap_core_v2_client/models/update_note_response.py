...
class UpdateNoteResponse(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="Note type")
    contact_id: Optional[StrictStr] = Field(default=None, description="Associated contact ID")
    assigned_to_user: Optional[BasicUser] = Field(default=None, description="User assigned to this note")
