...
class ReportingApi:
    ...
    def _list_reports_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v2/reporting/reports',
    ...
    def retrieve_report(
        self,
        report_id: Annotated[StrictStr, Field(description="The unique identifier of the report (Saved Search)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param report_id: The unique identifier of the report (Saved Search) (required)
        :type report_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _retrieve_report_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v2/reporting/reports/{report_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def retrieve_report_model(
        ...
        _param = self._retrieve_report_model_serialize(
            report_id=report_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def retrieve_report_model_with_http_info(
        self,
        report_id: Annotated[StrictStr, Field(description="The unique identifier of the report (Saved Search)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def retrieve_report_model_without_preload_content(
        self,
        report_id: Annotated[StrictStr, Field(description="The unique identifier of the report (Saved Search)")],
        _request_timeout: Union[
            None,
    ...
    def _retrieve_report_model_serialize(
        self,
        report_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v2/reporting/reports/{report_id}/model',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_report(
        ...
        run_report_request: RunReportRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type report_id: str
        :param run_report_request: (required)
    ...
    def _run_report_serialize(
        ...
        if run_report_request is not None:
            ...
            _query_params.append(('runReportRequest', run_report_request))
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v2/reporting/reports/{report_id}:run',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
