...
class CategoryDiscountsApi:
    ...
    def create_category_discount(
        self,
        create_category_discount_request: CreateCategoryDiscountRequest,
        ...
        :param create_category_discount_request: (required)
    ...
    def _create_category_discount_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v2/discounts/productCategories',
    ...
    @validate_call
    def create_category_discount_criteria(
        self,
        discount_id: StrictStr,
        create_category_discount_criteria: CreateCategoryDiscountCriteria,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param create_category_discount_criteria: (required)
        :type create_category_discount_criteria: CreateCategoryDiscountCriteria
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_category_discount_criteria_serialize(
            discount_id=discount_id,
            create_category_discount_criteria=create_category_discount_criteria,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_category_discount_criteria_with_http_info(
        self,
        discount_id: StrictStr,
        create_category_discount_criteria: CreateCategoryDiscountCriteria,
        _request_timeout: Union[
    ...
    @validate_call
    def create_category_discount_criteria_without_preload_content(
        self,
        discount_id: StrictStr,
        create_category_discount_criteria: CreateCategoryDiscountCriteria,
        _request_timeout: Union[
    ...
    def _create_category_discount_criteria_serialize(
        self,
        discount_id,
        ...
        # process the form parameters
        # process the body parameter
        if create_category_discount_criteria is not None:
            _body_params = create_category_discount_criteria
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v2/discounts/productCategories/{discount_id}/criteria',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_category_discount_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v2/discounts/productCategories/{discount_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_category_discount_criteria(
        self,
        discount_id: StrictStr,
        ...
        _param = self._delete_category_discount_criteria_serialize(
            discount_id=discount_id,
    ...
    @validate_call
    def delete_category_discount_criteria_with_http_info(
        self,
        discount_id: StrictStr,
        criteria_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_category_discount_criteria_without_preload_content(
        self,
        discount_id: StrictStr,
        criteria_id: StrictStr,
        _request_timeout: Union[
    ...
    def _delete_category_discount_criteria_serialize(
        self,
        discount_id,
        criteria_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v2/discounts/productCategories/{discount_id}/criteria/{criteria_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_category_discount(
        self,
        discount_id: StrictStr,
        update_category_discount_request: UpdateCategoryDiscountRequest,
        ...
        :param discount_id: (required)
        :type discount_id: str
        :param update_category_discount_request: (required)
