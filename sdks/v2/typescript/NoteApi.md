...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiCreateNoteCustomFieldGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiCreateNoteCustomFieldGroupRequest = {
...
const data = await apiInstance.createNoteCustomFieldGroup(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiCreateNoteCustomFieldTabRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiCreateNoteCustomFieldTabRequest = {
...
const data = await apiInstance.createNoteCustomFieldTab(request);
console.log('API called successfully. Returned data:', data);
```
...
> void deleteNoteCustomFieldGroup()
...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiDeleteNoteCustomFieldGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiDeleteNoteCustomFieldGroupRequest = {
  
  groupId: "group_id_example",
};

const data = await apiInstance.deleteNoteCustomFieldGroup(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiDeleteNoteCustomFieldTabRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiDeleteNoteCustomFieldTabRequest = {
  
  tabId: "tab_id_example",
};

const data = await apiInstance.deleteNoteCustomFieldTab(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiDeleteNotesCustomFieldRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiDeleteNotesCustomFieldRequest = {
  
  customFieldId: "custom_field_id_example",
};

const data = await apiInstance.deleteNotesCustomField(request);
console.log('API called successfully. Returned data:', data);
```
...
> CustomFieldGroup getNoteCustomFieldGroup()
...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiGetNoteCustomFieldGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiGetNoteCustomFieldGroupRequest = {
  
  groupId: "group_id_example",
};

const data = await apiInstance.getNoteCustomFieldGroup(request);
console.log('API called successfully. Returned data:', data);
```
...
> CustomFieldTab getNoteCustomFieldTab()
...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiGetNoteCustomFieldTabRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiGetNoteCustomFieldTabRequest = {
  
  tabId: "tab_id_example",
};

const data = await apiInstance.getNoteCustomFieldTab(request);
console.log('API called successfully. Returned data:', data);
```
...
# **listAllNotes**
> ListNotesResponse listAllNotes()
...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiListAllNotesRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiListAllNotesRequest = {
  ...
  pageToken: "page_token_example",
    // Attribute and direction to order items. One of the following fields: - `id` - `create_time` - `update_time`  One of the following directions: - `asc` - `desc` (optional)
...
const data = await apiInstance.listAllNotes(request);
console.log('API called successfully. Returned data:', data);
```
...
> ListCustomFieldGroupsResponse listNoteCustomFieldGroups()
...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiListNoteCustomFieldGroupsRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiListNoteCustomFieldGroupsRequest = {
    // Optional tab id to scope groups to a single tab (optional)
  tabId: "tab_id_example",
};

const data = await apiInstance.listNoteCustomFieldGroups(request);
console.log('API called successfully. Returned data:', data);
```
...
const data = await apiInstance.listNoteCustomFieldTabs(request);
console.log('API called successfully. Returned data:', data);
```
...
> CustomFieldGroup updateNoteCustomFieldGroup(updateCustomFieldGroupRequest)
...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiUpdateNoteCustomFieldGroupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiUpdateNoteCustomFieldGroupRequest = {
...
const data = await apiInstance.updateNoteCustomFieldGroup(request);
console.log('API called successfully. Returned data:', data);
```
...
> CustomFieldTab updateNoteCustomFieldTab(updateCustomFieldTabRequest)
...
```typescript
import { createConfiguration, NoteApi } from '';
import type { NoteApiUpdateNoteCustomFieldTabRequest } from '';

const configuration = createConfiguration();
const apiInstance = new NoteApi(configuration);

const request: NoteApiUpdateNoteCustomFieldTabRequest = {
...
const data = await apiInstance.updateNoteCustomFieldTab(request);
console.log('API called successfully. Returned data:', data);
```
