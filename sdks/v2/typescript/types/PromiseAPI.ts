...
export class PromiseAffiliateApi {
     ...
     * @param [updateMask] An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public updateCommissionProgramResourceWithHttpInfo(resourceId: string, updateProgramResourceRequest: UpdateProgramResourceRequest, updateMask?: any, _options?: PromiseConfigurationOptions): Promise<HttpInfo<AffiliateProgramResource>> {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [updateMask] An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public updateCommissionProgramResource(resourceId: string, updateProgramResourceRequest: UpdateProgramResourceRequest, updateMask?: any, _options?: PromiseConfigurationOptions): Promise<AffiliateProgramResource> {
        const observableOptions = wrapOptions(_options);
...
export class PromiseSubscriptionsApi {
     ...
     * @param [updateMask] An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public updateSubscriptionWithHttpInfo(subscriptionId: string, updateSubscriptionRequest: UpdateSubscriptionRequest, updateMask?: any, _options?: PromiseConfigurationOptions): Promise<HttpInfo<Subscription>> {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [updateMask] An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public updateSubscription(subscriptionId: string, updateSubscriptionRequest: UpdateSubscriptionRequest, updateMask?: any, _options?: PromiseConfigurationOptions): Promise<Subscription> {
        const observableOptions = wrapOptions(_options);
...
export class PromiseTaskApi {
     ...
     * @param [fields] Comma-delimited list of optional Task properties to include in the response. Allowed values: custom_fields
     */
    public updateTaskWithHttpInfo(taskId: string, createUpdateTaskRequest: CreateUpdateTaskRequest, updateMask?: any, fields?: Array<string>, _options?: PromiseConfigurationOptions): Promise<HttpInfo<UpdateTaskResponse>> {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [fields] Comma-delimited list of optional Task properties to include in the response. Allowed values: custom_fields
     */
    public updateTask(taskId: string, createUpdateTaskRequest: CreateUpdateTaskRequest, updateMask?: any, fields?: Array<string>, _options?: PromiseConfigurationOptions): Promise<UpdateTaskResponse> {
        const observableOptions = wrapOptions(_options);
