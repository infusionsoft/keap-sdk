...
export class SubscriptionPlanList {
    ...
    */
    'billingCycle'?: SubscriptionPlanListBillingCycleEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "SubscriptionPlanListBillingCycleEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return SubscriptionPlanList.attributeTypeMap;
    }
...
export enum SubscriptionPlanListBillingCycleEnum {
    Daily = 'DAILY',
    Weekly = 'WEEKLY',
    Monthly = 'MONTHLY',
    Yearly = 'YEARLY'
