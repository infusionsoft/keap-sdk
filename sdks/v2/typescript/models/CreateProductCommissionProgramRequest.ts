...
export class CreateProductCommissionProgramRequest {
    ...
    */
    'payoutType'?: CreateProductCommissionProgramRequestPayoutTypeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "CreateProductCommissionProgramRequestPayoutTypeEnum",
            "format": ""
        },
        {
            "name": "productId",
...
export enum CreateProductCommissionProgramRequestPayoutTypeEnum {
    Upfront = 'UPFRONT',
