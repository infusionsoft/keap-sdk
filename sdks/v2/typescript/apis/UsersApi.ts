...
export class UsersApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param userId 
     */
    public async getUserById(userId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'userId' is not null or undefined
        if (userId === null || userId === undefined) {
            throw new RequiredError("UsersApi", "getUserById", "userId");
        }


        // Path Params
        const localVarPath = '/rest/v2/users/{user_id}'
    ...
    public async getUserInfo(_options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/oauth/connect/userinfo';
     ...
     * @param userId 
     */
    public async getUserSignature(userId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'userId' is not null or undefined
        if (userId === null || userId === undefined) {
            throw new RequiredError("UsersApi", "getUserSignature", "userId");
        }


        // Path Params
        const localVarPath = '/rest/v2/users/{user_id}/signature'
            .replace('{' + 'user_id' + '}', encodeURIComponent(String(userId)));
    ...
    public async listPaginatedUsers(filter?: string, orderBy?: string, pageSize?: number, pageToken?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/users';
     ...
     */
    public async updateUser(userId: string, updateUserRequest: UpdateUserRequest, updateMask?: Set<'address' | 'company_name' | 'email_address' | 'family_name' | 'fax_numbers' | 'given_name' | 'job_title' | 'phone_numbers' | 'time_zone' | 'website'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'address' | 'company_name' | 'email_address' | 'family_name' | 'fax_numbers' | 'given_name' | 'job_title' | 'phone_numbers' | 'time_zone' | 'website'>", "");
...
export class UsersApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUserInfoWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetUserInfoResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getUserSignature
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUserSignatureWithHttpInfo(response: ResponseContext): Promise<HttpInfo<string >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
