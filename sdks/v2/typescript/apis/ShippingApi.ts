...
export class ShippingApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async listShippingMethods(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // Path Params
        const localVarPath = '/rest/v2/shipping';
...
export class ShippingApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to listShippingMethods
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listShippingMethodsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListRestShippingMethodsResponse >> {
