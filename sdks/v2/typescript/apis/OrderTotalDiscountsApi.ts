...
export class OrderTotalDiscountsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createOrderTotalDiscount(createOrderTotalDiscountRequest: CreateOrderTotalDiscountRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/discounts/orderTotals';
     ...
     */
    public async createOrderTotalDiscountCriteria(discountId: string, createOrderTotalDiscountCriteria: CreateOrderTotalDiscountCriteria, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'discountId' is not null or undefined
        if (discountId === null || discountId === undefined) {
            throw new RequiredError("OrderTotalDiscountsApi", "createOrderTotalDiscountCriteria", "discountId");
        }


        // verify required parameter 'createOrderTotalDiscountCriteria' is not null or undefined
        if (createOrderTotalDiscountCriteria === null || createOrderTotalDiscountCriteria === undefined) {
            throw new RequiredError("OrderTotalDiscountsApi", "createOrderTotalDiscountCriteria", "createOrderTotalDiscountCriteria");
        }


        // Path Params
        const localVarPath = '/rest/v2/discounts/orderTotals/{discount_id}/criteria'
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(createOrderTotalDiscountCriteria, "CreateOrderTotalDiscountCriteria", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
    ...
    public async deleteOrderTotalDiscount(discountId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/discounts/orderTotals/{discount_id}'
            .replace('{' + 'discount_id' + '}', encodeURIComponent(String(discountId)));
     ...
     * @param criteriaId 
     */
    public async deleteOrderTotalDiscountCriteria(discountId: string, criteriaId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'discountId' is not null or undefined
        if (discountId === null || discountId === undefined) {
            throw new RequiredError("OrderTotalDiscountsApi", "deleteOrderTotalDiscountCriteria", "discountId");
        }


        // verify required parameter 'criteriaId' is not null or undefined
        if (criteriaId === null || criteriaId === undefined) {
            throw new RequiredError("OrderTotalDiscountsApi", "deleteOrderTotalDiscountCriteria", "criteriaId");
        }


        // Path Params
        const localVarPath = '/rest/v2/discounts/orderTotals/{discount_id}/criteria/{criteria_id}'
            .replace('{' + 'discount_id' + '}', encodeURIComponent(String(discountId)))
     ...
     */
    public async updateOrderTotalDiscount(discountId: string, updateOrderTotalDiscountRequest: UpdateOrderTotalDiscountRequest, updateMask?: Set<'name' | 'description' | 'apply_to_commissions' | 'discount_type' | 'discount_value' | 'discount_strategy' | 'criteria'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'name' | 'description' | 'apply_to_commissions' | 'discount_type' | 'discount_value' | 'discount_strategy' | 'criteria'>", "");
...
export class OrderTotalDiscountsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createOrderTotalDiscountCriteria
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createOrderTotalDiscountCriteriaWithHttpInfo(response: ResponseContext): Promise<HttpInfo<DiscountCriteria >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteOrderTotalDiscountCriteria
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteOrderTotalDiscountCriteriaWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
