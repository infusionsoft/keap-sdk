...
export class TagsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async applyTags(tagId: string, applyRemoveTagRequest: ApplyRemoveTagRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/tags/{tag_id}/contacts:applyTags'
     ...
     */
    public async countContactsForTag(tagId: string, filter?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'tagId' is not null or undefined
        if (tagId === null || tagId === undefined) {
            throw new RequiredError("TagsApi", "countContactsForTag", "tagId");
        }



        // Path Params
        const localVarPath = '/rest/v2/tags/{tag_id}/contacts/count'
            .replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
    ...
    public async createTag(createUpdateTagRequest: CreateUpdateTagRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/tags';
    ...
    public async createTagCategory(createUpdateTagCategoryRequest: CreateUpdateTagCategoryRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/tags/categories';
    ...
    public async deleteTag(tagId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/tags/{tag_id}'
            .replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
    ...
    public async deleteTagCategory(tagCategoryId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/tags/categories/{tag_category_id}'
    ...
    public async listCompaniesForTagId(tagId: string, filter?: string, orderBy?: string, pageSize?: number, pageToken?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/tags/{tag_id}/companies'
            .replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
    ...
    public async listContactsWithTagId(tagId: string, filter?: string, orderBy?: string, pageSize?: number, pageToken?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/tags/{tag_id}/contacts'
            .replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
    ...
    public async removeTags(tagId: string, applyRemoveTagRequest: ApplyRemoveTagRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/tags/{tag_id}/contacts:removeTags'
            .replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
     ...
     */
    public async updateTag(tagId: string, createUpdateTagRequest: CreateUpdateTagRequest, updateMask?: Set<'name' | 'description' | 'category'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'createUpdateTagRequest' is not null or undefined
        if (createUpdateTagRequest === null || createUpdateTagRequest === undefined) {
            throw new RequiredError("TagsApi", "updateTag", "createUpdateTagRequest");
        }
        ...
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'name' | 'description' | 'category'>", "");
     ...
     * @param updateMask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public async updateTagCategory(tagCategoryId: string, createUpdateTagCategoryRequest: CreateUpdateTagCategoryRequest, updateMask?: Set<'name' | 'description'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'createUpdateTagCategoryRequest' is not null or undefined
        if (createUpdateTagCategoryRequest === null || createUpdateTagCategoryRequest === undefined) {
            throw new RequiredError("TagsApi", "updateTagCategory", "createUpdateTagCategoryRequest");
        }
        ...
        // Query Params
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'name' | 'description'>", "");
            for (const serializedParam of serializedParams) {
                requestContext.appendQueryParam("update_mask", serializedParam);
            }
        }
...
export class TagsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to countContactsForTag
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async countContactsForTagWithHttpInfo(response: ResponseContext): Promise<HttpInfo<TagContactCount >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: TagContactCount = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "TagContactCount", ""
            ) as TagContactCount;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createTagCategoryWithHttpInfo(response: ResponseContext): Promise<HttpInfo<TagCategory >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
            const body: TagCategory = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "TagCategory", ""
            ) as TagCategory;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
