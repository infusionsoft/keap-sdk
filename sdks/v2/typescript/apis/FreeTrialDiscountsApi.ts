...
export class FreeTrialDiscountsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createFreeTrialDiscount(createFreeTrialDiscountRequest: CreateFreeTrialDiscountRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/discounts/freeTrials';
     ...
     */
    public async createFreeTrialDiscountCriteria(discountId: string, createFreeTrialDiscountCriteria: CreateFreeTrialDiscountCriteria, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'discountId' is not null or undefined
        if (discountId === null || discountId === undefined) {
            throw new RequiredError("FreeTrialDiscountsApi", "createFreeTrialDiscountCriteria", "discountId");
        }


        // verify required parameter 'createFreeTrialDiscountCriteria' is not null or undefined
        if (createFreeTrialDiscountCriteria === null || createFreeTrialDiscountCriteria === undefined) {
            throw new RequiredError("FreeTrialDiscountsApi", "createFreeTrialDiscountCriteria", "createFreeTrialDiscountCriteria");
        }


        // Path Params
        const localVarPath = '/rest/v2/discounts/freeTrials/{discount_id}/criteria'
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(createFreeTrialDiscountCriteria, "CreateFreeTrialDiscountCriteria", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
    ...
    public async deleteFreeTrialDiscount(discountId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/discounts/freeTrials/{discount_id}'
            .replace('{' + 'discount_id' + '}', encodeURIComponent(String(discountId)));
     ...
     * @param criteriaId 
     */
    public async deleteFreeTrialDiscountCriteria(discountId: string, criteriaId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'discountId' is not null or undefined
        if (discountId === null || discountId === undefined) {
            throw new RequiredError("FreeTrialDiscountsApi", "deleteFreeTrialDiscountCriteria", "discountId");
        }


        // verify required parameter 'criteriaId' is not null or undefined
        if (criteriaId === null || criteriaId === undefined) {
            throw new RequiredError("FreeTrialDiscountsApi", "deleteFreeTrialDiscountCriteria", "criteriaId");
        }


        // Path Params
        const localVarPath = '/rest/v2/discounts/freeTrials/{discount_id}/criteria/{criteria_id}'
            .replace('{' + 'discount_id' + '}', encodeURIComponent(String(discountId)))
     ...
     */
    public async updateFreeTrialDiscount(discountId: string, updateFreeTrialDiscountRequest: UpdateFreeTrialDiscountRequest, updateMask?: Set<'name' | 'description' | 'free_trial_days' | 'hide_price' | 'subscription_plan_id' | 'criteria'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'name' | 'description' | 'free_trial_days' | 'hide_price' | 'subscription_plan_id' | 'criteria'>", "");
...
export class FreeTrialDiscountsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createFreeTrialDiscountCriteria
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createFreeTrialDiscountCriteriaWithHttpInfo(response: ResponseContext): Promise<HttpInfo<DiscountCriteria >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteFreeTrialDiscountCriteria
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteFreeTrialDiscountCriteriaWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
