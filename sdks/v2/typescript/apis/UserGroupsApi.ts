 ...
 * no description
 */
export class UserGroupsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param userGroupId 
     */
    public async getUserGroup(userGroupId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'userGroupId' is not null or undefined
        if (userGroupId === null || userGroupId === undefined) {
            throw new RequiredError("UserGroupsApi", "getUserGroup", "userGroupId");
        }


        // Path Params
        const localVarPath = '/rest/v2/userGroups/{user_group_id}'
     ...
     * List User Groups
     */
    public async listUserGroups(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // Path Params
        const localVarPath = '/rest/v2/userGroups';
...
export class UserGroupsApiResponseProcessor {
     ...
     */
     public async getUserGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<UserGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: UserGroup = ObjectSerializer.deserialize(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listUserGroupsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListUserGroupsResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ListUserGroupsResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
