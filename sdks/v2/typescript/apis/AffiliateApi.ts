...
export class AffiliateApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async addAffiliate(createAffiliateRequest: CreateAffiliateRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'createAffiliateRequest' is not null or undefined
        if (createAffiliateRequest === null || createAffiliateRequest === undefined) {
            throw new RequiredError("AffiliateApi", "addAffiliate", "createAffiliateRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/affiliates';
    ...
    public async addAffiliateToProgram(id: string, affiliateAddToProgramRequest: AffiliateAddToProgramRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/{id}:assignToProgram'
    ...
    public async addCommissionProgram(createCommissionProgramRequest: CreateCommissionProgramRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'createCommissionProgramRequest' is not null or undefined
        if (createCommissionProgramRequest === null || createCommissionProgramRequest === undefined) {
            throw new RequiredError("AffiliateApi", "addCommissionProgram", "createCommissionProgramRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/affiliates/commissionPrograms';
     ...
     */
    public async addCommissionProgramResource(createProgramResourceRequest: CreateProgramResourceRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'createProgramResourceRequest' is not null or undefined
        if (createProgramResourceRequest === null || createProgramResourceRequest === undefined) {
            throw new RequiredError("AffiliateApi", "addCommissionProgramResource", "createProgramResourceRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/affiliates/commissionPrograms/resources';
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(createProgramResourceRequest, "CreateProgramResourceRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
    ...
    public async assignProductCommissionProgram(commissionProgramId: string, createProductCommissionProgramRequest: CreateProductCommissionProgramRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'createProductCommissionProgramRequest' is not null or undefined
        if (createProductCommissionProgramRequest === null || createProductCommissionProgramRequest === undefined) {
            throw new RequiredError("AffiliateApi", "assignProductCommissionProgram", "createProductCommissionProgramRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/affiliates/commissionPrograms/productCommissionPrograms/{commission_program_id}'
    ...
    public async assignSubscriptionCommissionProgram(commissionProgramId: string, createSubscriptionCommissionProgramRequest: CreateSubscriptionCommissionProgramRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'createSubscriptionCommissionProgramRequest' is not null or undefined
        if (createSubscriptionCommissionProgramRequest === null || createSubscriptionCommissionProgramRequest === undefined) {
            throw new RequiredError("AffiliateApi", "assignSubscriptionCommissionProgram", "createSubscriptionCommissionProgramRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/affiliates/commissionPrograms/subscriptionCommissionPrograms/{commission_program_id}'
            .replace('{' + 'commission_program_id' + '}', encodeURIComponent(String(commissionProgramId)));
    ...
    public async createAffiliateCustomField(createCustomFieldRequest: CreateCustomFieldRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/model/customFields';
     ...
     */
    public async createAffiliateCustomFieldTab(createCustomFieldTabRequest: CreateCustomFieldTabRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (createCustomFieldTabRequest === null || createCustomFieldTabRequest === undefined) {
            throw new RequiredError("AffiliateApi", "createAffiliateCustomFieldTab", "createCustomFieldTabRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/affiliates/model/customFields/tabs';
    ...
    public async createDefaultCommissionProgram(commissionProgramId: string, createDefaultCommissionProgramRequest: CreateDefaultCommissionProgramRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'createDefaultCommissionProgramRequest' is not null or undefined
        if (createDefaultCommissionProgramRequest === null || createDefaultCommissionProgramRequest === undefined) {
            throw new RequiredError("AffiliateApi", "createDefaultCommissionProgram", "createDefaultCommissionProgramRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/affiliates/commissionPrograms/defaultCommissionPrograms/{commission_program_id}'
            .replace('{' + 'commission_program_id' + '}', encodeURIComponent(String(commissionProgramId)));
    ...
    public async createRedirectLink(createOrUpdateAffiliateLinkRequest: CreateOrUpdateAffiliateLinkRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/redirects';
    ...
    public async deleteAffiliateCommissionProgram(commissionProgramId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/commissionPrograms/{commission_program_id}'
            .replace('{' + 'commission_program_id' + '}', encodeURIComponent(String(commissionProgramId)));
     ...
     * @param tabId 
     */
    public async deleteAffiliateCustomFieldTab(tabId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'tabId' is not null or undefined
        if (tabId === null || tabId === undefined) {
            throw new RequiredError("AffiliateApi", "deleteAffiliateCustomFieldTab", "tabId");
        }


        // Path Params
        const localVarPath = '/rest/v2/affiliates/model/customFields/tabs/{tab_id}'
     ...
     * @param resourceId 
     */
    public async deleteCommissionProgramResource(resourceId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'resourceId' is not null or undefined
        if (resourceId === null || resourceId === undefined) {
            throw new RequiredError("AffiliateApi", "deleteCommissionProgramResource", "resourceId");
        }


        // Path Params
        const localVarPath = '/rest/v2/affiliates/commissionPrograms/resources/{resource_id}'
    ...
    public async deleteRedirectLink(redirectId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/redirects/{redirect_id}'
    ...
    public async getAffiliateCommissionTotal(affiliateId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/{affiliate_id}/commissionTotal'
    ...
    public async getAffiliateCommissions(affiliateId: string, filter?: string, orderBy?: string, pageSize?: number, pageToken?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/{affiliate_id}:commissions'
            .replace('{' + 'affiliate_id' + '}', encodeURIComponent(String(affiliateId)));
     ...
     * @param tabId 
     */
    public async getAffiliateCustomFieldTab(tabId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'tabId' is not null or undefined
        if (tabId === null || tabId === undefined) {
            throw new RequiredError("AffiliateApi", "getAffiliateCustomFieldTab", "tabId");
        }
    ...
    public async getAffiliateCustomFields(_options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/model';
    ...
    public async getReferralsByAffiliateId(affiliateId: string, filter?: string, pageToken?: string, orderBy?: string, pageSize?: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/{affiliate_id}/referrals'
            .replace('{' + 'affiliate_id' + '}', encodeURIComponent(String(affiliateId)));
     ...
     */
    public async listAffiliateCustomFieldTabs(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
    ...
    public async listAffiliatePayments(affiliateId: string, filter?: string, orderBy?: string, pageSize?: number, pageToken?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/{affiliate_id}/payments'
            .replace('{' + 'affiliate_id' + '}', encodeURIComponent(String(affiliateId)));
     ...
     * @param commissionProgramId 
     */
    public async listCommissionProgramResources(commissionProgramId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'commissionProgramId' is not null or undefined
        if (commissionProgramId === null || commissionProgramId === undefined) {
            throw new RequiredError("AffiliateApi", "listCommissionProgramResources", "commissionProgramId");
        }


        // Path Params
        const localVarPath = '/rest/v2/affiliates/commissionPrograms/{commission_program_id}/resources'
            .replace('{' + 'commission_program_id' + '}', encodeURIComponent(String(commissionProgramId)));
    ...
    public async listSummaries(filter?: string, orderBy?: string, pageSize?: number, pageToken?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/summaries';
    ...
    public async removeAffiliateFromProgram(id: string, affiliateRemoveFromProgramRequest: AffiliateRemoveFromProgramRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/{id}:removeFromProgram'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
    ...
    public async removeProductCommissionFromCommissions(commissionId: string, deleteProgramCommissionRequest: DeleteProgramCommissionRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/commissionPrograms/{commission_id}:removeProductCommission'
    ...
    public async removeSubscriptionPlanCommissionFromCommissions(commissionId: string, deleteSubscriptionPlanCommissionRequest: DeleteSubscriptionPlanCommissionRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/affiliates/commissionPrograms/{commission_id}:removeSubscriptionCommission'
            .replace('{' + 'commission_id' + '}', encodeURIComponent(String(commissionId)));
     ...
     */
    public async updateAffiliate(id: string, updateAffiliateRequest: UpdateAffiliateRequest, updateMask?: Set<'contact_id' | 'code' | 'name' | 'status' | 'parent_affiliate_id' | 'notify_on_sale' | 'notify_on_lead' | 'track_leads_days' | 'password' | 'custom_fields'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'updateAffiliateRequest' is not null or undefined
        if (updateAffiliateRequest === null || updateAffiliateRequest === undefined) {
            throw new RequiredError("AffiliateApi", "updateAffiliate", "updateAffiliateRequest");
        }
        ...
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'contact_id' | 'code' | 'name' | 'status' | 'parent_affiliate_id' | 'notify_on_sale' | 'notify_on_lead' | 'track_leads_days' | 'password' | 'custom_fields'>", "");
     ...
     * @param updateMask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public async updateAffiliateCustomField(customFieldId: string, updateCustomFieldMetaDataRequest: UpdateCustomFieldMetaDataRequest, updateMask?: Set<'group_id' | 'label' | 'options'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async updateAffiliateCustomFieldTab(tabId: string, updateMask: Set<'name' | 'order'>, updateCustomFieldTabRequest: UpdateCustomFieldTabRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'tabId' is not null or undefined
        if (tabId === null || tabId === undefined) {
            throw new RequiredError("AffiliateApi", "updateAffiliateCustomFieldTab", "tabId");
        }


        // verify required parameter 'updateMask' is not null or undefined
        if (updateMask === null || updateMask === undefined) {
            throw new RequiredError("AffiliateApi", "updateAffiliateCustomFieldTab", "updateMask");
        }
        ...
        if (updateCustomFieldTabRequest === null || updateCustomFieldTabRequest === undefined) {
            throw new RequiredError("AffiliateApi", "updateAffiliateCustomFieldTab", "updateCustomFieldTabRequest");
        }
     ...
     * @param updateMask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public async updateCommissionProgram(commissionProgramId: string, updateCommissionProgramRequest: UpdateCommissionProgramRequest, updateMask?: Set<'name' | 'notes' | 'priority'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // Query Params
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'name' | 'notes' | 'priority'>", "");
            for (const serializedParam of serializedParams) {
                requestContext.appendQueryParam("update_mask", serializedParam);
            }
        }
     ...
     * @param updateMask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public async updateCommissionProgramResource(resourceId: string, updateProgramResourceRequest: UpdateProgramResourceRequest, updateMask?: Set<'title' | 'notes' | 'url' | 'order' | 'content_html' | 'page_width' | 'page_height' | 'commission_program_ids'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'resourceId' is not null or undefined
        if (resourceId === null || resourceId === undefined) {
            throw new RequiredError("AffiliateApi", "updateCommissionProgramResource", "resourceId");
        }


        // verify required parameter 'updateProgramResourceRequest' is not null or undefined
        if (updateProgramResourceRequest === null || updateProgramResourceRequest === undefined) {
            throw new RequiredError("AffiliateApi", "updateCommissionProgramResource", "updateProgramResourceRequest");
        }
        ...
        // Query Params
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'title' | 'notes' | 'url' | 'order' | 'content_html' | 'page_width' | 'page_height' | 'commission_program_ids'>", "");
            for (const serializedParam of serializedParams) {
                requestContext.appendQueryParam("update_mask", serializedParam);
            }
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(updateProgramResourceRequest, "UpdateProgramResourceRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
     ...
     * @param updateMask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public async updateDefaultCommissionProgram(commissionProgramId: string, updateDefaultCommissionProgramRequest: UpdateDefaultCommissionProgramRequest, updateMask?: Set<'percentage' | 'dollar_amount' | 'payout_type' | 'level_1' | 'level_2' | 'unused'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'updateDefaultCommissionProgramRequest' is not null or undefined
        if (updateDefaultCommissionProgramRequest === null || updateDefaultCommissionProgramRequest === undefined) {
            throw new RequiredError("AffiliateApi", "updateDefaultCommissionProgram", "updateDefaultCommissionProgramRequest");
        }
        ...
        // Query Params
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'percentage' | 'dollar_amount' | 'payout_type' | 'level_1' | 'level_2' | 'unused'>", "");
            for (const serializedParam of serializedParams) {
                requestContext.appendQueryParam("update_mask", serializedParam);
            }
        }
     ...
     * @param updateMask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public async updateProductCommissionProgram(commissionProgramId: string, updateProductCommissionProgramRequest: UpdateProductCommissionProgramRequest, updateMask?: Set<'percentage' | 'dollar_amount' | 'payout_type' | 'level_1' | 'level_2' | 'unused'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'updateProductCommissionProgramRequest' is not null or undefined
        if (updateProductCommissionProgramRequest === null || updateProductCommissionProgramRequest === undefined) {
            throw new RequiredError("AffiliateApi", "updateProductCommissionProgram", "updateProductCommissionProgramRequest");
        }
     ...
     * @param updateMask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public async updateSubscriptionCommissionProgram(commissionProgramId: string, updateSubscriptionCommissionProgramRequest: UpdateSubscriptionCommissionProgramRequest, updateMask?: Set<'percentage' | 'dollar_amount' | 'payout_type' | 'level_1' | 'level_2' | 'unused'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'updateSubscriptionCommissionProgramRequest' is not null or undefined
        if (updateSubscriptionCommissionProgramRequest === null || updateSubscriptionCommissionProgramRequest === undefined) {
            throw new RequiredError("AffiliateApi", "updateSubscriptionCommissionProgram", "updateSubscriptionCommissionProgramRequest");
        }
...
export class AffiliateApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to addCommissionProgramResource
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async addCommissionProgramResourceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<AffiliateProgramResource >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
            const body: AffiliateProgramResource = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "AffiliateProgramResource", ""
            ) as AffiliateProgramResource;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async assignProductCommissionProgramWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetRestCommissionProgram >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
            const body: GetRestCommissionProgram = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "GetRestCommissionProgram", ""
            ) as GetRestCommissionProgram;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async assignSubscriptionCommissionProgramWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetRestCommissionProgram >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
            const body: GetRestCommissionProgram = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createAffiliateCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createAffiliateCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldTab >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createDefaultCommissionProgramWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetRestCommissionProgram >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
            const body: GetRestCommissionProgram = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteAffiliateCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteAffiliateCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteCommissionProgramResource
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteCommissionProgramResourceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getAffiliateCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getAffiliateCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldTab >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CustomFieldTab = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getCommissionProgramWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetRestCommissionProgram >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GetRestCommissionProgram = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getReferralsByAffiliateId
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getReferralsByAffiliateIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListAffiliateReferralsResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ListAffiliateReferralsResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "ListAffiliateReferralsResponse", ""
            ) as ListAffiliateReferralsResponse;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to listAffiliateCustomFieldTabs
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listAffiliateCustomFieldTabsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListCustomFieldTabsResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to listCommissionProgramResources
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listCommissionProgramResourcesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListProgramResourcesResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ListProgramResourcesResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "ListProgramResourcesResponse", ""
            ) as ListProgramResourcesResponse;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateAffiliateCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateAffiliateCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldTab >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CustomFieldTab = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateCommissionProgramResource
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateCommissionProgramResourceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<AffiliateProgramResource >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: AffiliateProgramResource = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateDefaultCommissionProgramWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetRestCommissionProgram >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GetRestCommissionProgram = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateProductCommissionProgramWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetRestCommissionProgram >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GetRestCommissionProgram = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateSubscriptionCommissionProgramWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetRestCommissionProgram >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GetRestCommissionProgram = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
