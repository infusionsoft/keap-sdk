...
export class OrdersApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async applyCommissionOnOrderItems(orderId: string, orderItemId: string, applyCommissionRequest: ApplyCommissionRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'applyCommissionRequest' is not null or undefined
        if (applyCommissionRequest === null || applyCommissionRequest === undefined) {
            throw new RequiredError("OrdersApi", "applyCommissionOnOrderItems", "applyCommissionRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/orders/{order_id}/items/{order_item_id}:applyCommission'
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(applyCommissionRequest, "ApplyCommissionRequest", ""),
            contentType
        );
    ...
    public async applyTax(orderId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/orders/{order_id}:applyTax'
            .replace('{' + 'order_id' + '}', encodeURIComponent(String(orderId)));
    ...
    public async attachFileToOrder(orderId: string, fileOperationRequest: FileOperationRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/orders/{order_id}:attachFile'
            .replace('{' + 'order_id' + '}', encodeURIComponent(String(orderId)));
    ...
    public async createOrder(restCreateOrderRequest: RestCreateOrderRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/orders';
    ...
    public async createOrderCustomField(createCustomFieldRequest: CreateCustomFieldRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/orders/model/customFields';
     ...
     */
    public async createOrderCustomFieldGroup(createCustomFieldGroupRequest: CreateCustomFieldGroupRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (createCustomFieldGroupRequest === null || createCustomFieldGroupRequest === undefined) {
            throw new RequiredError("OrdersApi", "createOrderCustomFieldGroup", "createCustomFieldGroupRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/orders/model/customFields/groups';
     ...
     */
    public async createOrderCustomFieldTab(createCustomFieldTabRequest: CreateCustomFieldTabRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (createCustomFieldTabRequest === null || createCustomFieldTabRequest === undefined) {
            throw new RequiredError("OrdersApi", "createOrderCustomFieldTab", "createCustomFieldTabRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/orders/model/customFields/tabs';
    ...
    public async createOrderItem(orderId: string, createOrderItemRequest: CreateOrderItemRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/orders/{order_id}/items'
            .replace('{' + 'order_id' + '}', encodeURIComponent(String(orderId)));
     ...
     */
    public async createPaymentForAnOrder(orderId: string, restCreatePaymentRequest: RestCreatePaymentRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'restCreatePaymentRequest' is not null or undefined
        if (restCreatePaymentRequest === null || restCreatePaymentRequest === undefined) {
            throw new RequiredError("OrdersApi", "createPaymentForAnOrder", "restCreatePaymentRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/orders/{order_id}/payments'
            .replace('{' + 'order_id' + '}', encodeURIComponent(String(orderId)));
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(restCreatePaymentRequest, "RestCreatePaymentRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
    ...
    public async deleteOrder(orderId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/orders/{order_id}'
            .replace('{' + 'order_id' + '}', encodeURIComponent(String(orderId)));
    ...
    public async deleteOrderCustomField(customFieldId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/orders/model/customFields/{custom_field_id}'
     ...
     * @param groupId 
     */
    public async deleteOrderCustomFieldGroup(groupId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'groupId' is not null or undefined
        if (groupId === null || groupId === undefined) {
            throw new RequiredError("OrdersApi", "deleteOrderCustomFieldGroup", "groupId");
        }


        // Path Params
        const localVarPath = '/rest/v2/orders/model/customFields/groups/{group_id}'
     ...
     * @param tabId 
     */
    public async deleteOrderCustomFieldTab(tabId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'tabId' is not null or undefined
        if (tabId === null || tabId === undefined) {
            throw new RequiredError("OrdersApi", "deleteOrderCustomFieldTab", "tabId");
        }


        // Path Params
        const localVarPath = '/rest/v2/orders/model/customFields/tabs/{tab_id}'
    ...
    public async deleteOrderItem(orderId: string, orderItemId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/orders/{order_id}/items/{order_item_id}'
            .replace('{' + 'order_id' + '}', encodeURIComponent(String(orderId)))
            .replace('{' + 'order_item_id' + '}', encodeURIComponent(String(orderItemId)));
    ...
    public async detachFileFromOrder(orderId: string, fileOperationRequest: FileOperationRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/orders/{order_id}:detachFile'
            .replace('{' + 'order_id' + '}', encodeURIComponent(String(orderId)));
     ...
     * @param groupId 
     */
    public async getOrderCustomFieldGroup(groupId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'groupId' is not null or undefined
        if (groupId === null || groupId === undefined) {
            throw new RequiredError("OrdersApi", "getOrderCustomFieldGroup", "groupId");
        }
     ...
     * @param tabId 
     */
    public async getOrderCustomFieldTab(tabId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'tabId' is not null or undefined
        if (tabId === null || tabId === undefined) {
            throw new RequiredError("OrdersApi", "getOrderCustomFieldTab", "tabId");
        }
     ...
     * @param orderItemId 
     */
    public async getOrderItem(orderId: string, orderItemId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'orderId' is not null or undefined
        if (orderId === null || orderId === undefined) {
            throw new RequiredError("OrdersApi", "getOrderItem", "orderId");
        }


        // verify required parameter 'orderItemId' is not null or undefined
        if (orderItemId === null || orderItemId === undefined) {
            throw new RequiredError("OrdersApi", "getOrderItem", "orderItemId");
        }
     ...
     */
    public async listOrderCustomFieldGroups(tabId?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async listOrderCustomFieldTabs(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
    ...
    public async retrieveOrderCustomFieldModel(_options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/orders/model';
    ...
    public async updateOrder(orderId: string, updateOrderRequest: UpdateOrderRequest, updateMask?: Set<'contact_id' | 'order_items' | 'order_title' | 'order_time' | 'order_type' | 'promo_codes' | 'lead_affiliate_id' | 'sales_affiliate_id' | 'shipping_address' | 'notes' | 'terms' | 'payment_plan' | 'custom_fields'>, _options?: Configuration): Promise<RequestContext> {
        ...
        if (updateOrderRequest === null || updateOrderRequest === undefined) {
            throw new RequiredError("OrdersApi", "updateOrder", "updateOrderRequest");
        }
     ...
     */
    public async updateOrderCustomFieldGroup(groupId: string, updateMask: Set<'name' | 'tab_id' | 'order'>, updateCustomFieldGroupRequest: UpdateCustomFieldGroupRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'groupId' is not null or undefined
        if (groupId === null || groupId === undefined) {
            throw new RequiredError("OrdersApi", "updateOrderCustomFieldGroup", "groupId");
        }


        // verify required parameter 'updateMask' is not null or undefined
        if (updateMask === null || updateMask === undefined) {
            throw new RequiredError("OrdersApi", "updateOrderCustomFieldGroup", "updateMask");
        }
        ...
        if (updateCustomFieldGroupRequest === null || updateCustomFieldGroupRequest === undefined) {
            throw new RequiredError("OrdersApi", "updateOrderCustomFieldGroup", "updateCustomFieldGroupRequest");
        }
     ...
     */
    public async updateOrderCustomFieldTab(tabId: string, updateMask: Set<'name' | 'order'>, updateCustomFieldTabRequest: UpdateCustomFieldTabRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'tabId' is not null or undefined
        if (tabId === null || tabId === undefined) {
            throw new RequiredError("OrdersApi", "updateOrderCustomFieldTab", "tabId");
        }


        // verify required parameter 'updateMask' is not null or undefined
        if (updateMask === null || updateMask === undefined) {
            throw new RequiredError("OrdersApi", "updateOrderCustomFieldTab", "updateMask");
        }
        ...
        if (updateCustomFieldTabRequest === null || updateCustomFieldTabRequest === undefined) {
            throw new RequiredError("OrdersApi", "updateOrderCustomFieldTab", "updateCustomFieldTabRequest");
        }
    ...
    public async updateOrderItem(orderId: string, orderItemId: string, updateOrderItemRequest: UpdateOrderItemRequest, updateMask?: Set<'name' | 'description' | 'notes' | 'quantity' | 'price_per_unit' | 'cost_per_unit' | 'product_id' | 'subscription_plan_id' | 'subscription_plan_description'>, _options?: Configuration): Promise<RequestContext> {
        ...
        if (updateOrderItemRequest === null || updateOrderItemRequest === undefined) {
            throw new RequiredError("OrdersApi", "updateOrderItem", "updateOrderItemRequest");
        }
...
export class OrdersApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async applyTaxWithHttpInfo(response: ResponseContext): Promise<HttpInfo<OrderV2 >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrderV2 = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "OrderV2", ""
            ) as OrderV2;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async attachFileToOrderWithHttpInfo(response: ResponseContext): Promise<HttpInfo<OrderV2 >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrderV2 = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createOrderWithHttpInfo(response: ResponseContext): Promise<HttpInfo<OrderV2 >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createOrderCustomFieldGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createOrderCustomFieldGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createOrderCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createOrderCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldTab >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteOrderCustomFieldGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteOrderCustomFieldGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteOrderCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteOrderCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async detachFileFromOrderWithHttpInfo(response: ResponseContext): Promise<HttpInfo<OrderV2 >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrderV2 = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getOrderWithHttpInfo(response: ResponseContext): Promise<HttpInfo<OrderV2 >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrderV2 = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getOrderCustomFieldGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getOrderCustomFieldGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CustomFieldGroup = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getOrderCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getOrderCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldTab >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CustomFieldTab = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getOrderItem
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getOrderItemWithHttpInfo(response: ResponseContext): Promise<HttpInfo<OrderItem >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrderItem = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to listOrderCustomFieldGroups
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listOrderCustomFieldGroupsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListCustomFieldGroupsResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to listOrderCustomFieldTabs
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listOrderCustomFieldTabsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListCustomFieldTabsResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateOrderWithHttpInfo(response: ResponseContext): Promise<HttpInfo<OrderV2 >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrderV2 = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateOrderCustomFieldGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateOrderCustomFieldGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CustomFieldGroup = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateOrderCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateOrderCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldTab >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CustomFieldTab = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
