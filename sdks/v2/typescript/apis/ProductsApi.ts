...
export class ProductsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async adjustInventory(productId: string, updateProductInventoryRequest: UpdateProductInventoryRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        if (updateProductInventoryRequest === null || updateProductInventoryRequest === undefined) {
            throw new RequiredError("ProductsApi", "adjustInventory", "updateProductInventoryRequest");
        }
     ...
     */
    public async createProduct(createProductRequest: CreateProductRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (createProductRequest === null || createProductRequest === undefined) {
            throw new RequiredError("ProductsApi", "createProduct", "createProductRequest");
        }
    ...
    public async createProductImage(productId: string, file: HttpFile, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v2/products/{product_id}/images'
            .replace('{' + 'product_id' + '}', encodeURIComponent(String(productId)));
     ...
     */
    public async updateProduct(productId: string, updateProductRequest: UpdateProductRequest, updateMask?: Array<string>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (updateProductRequest === null || updateProductRequest === undefined) {
            throw new RequiredError("ProductsApi", "updateProduct", "updateProductRequest");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(updateProductRequest, "UpdateProductRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
...
export class ProductsApiResponseProcessor {
     ...
     */
     public async adjustInventoryWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RestV2Product >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createProductWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RestV2Product >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getProductWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RestV2Product >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: RestV2Product = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listProductsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListProductsResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateProductWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RestV2Product >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: RestV2Product = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
