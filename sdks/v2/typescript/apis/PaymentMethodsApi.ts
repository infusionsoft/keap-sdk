...
export class PaymentMethodsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async deactivatePaymentMethod(contactId: string, paymentMethodId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/contacts/{contact_id}/paymentMethods/{payment_method_id}:deactivate'
    ...
    public async deletePaymentMethod(contactId: string, paymentMethodId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/contacts/{contact_id}/paymentMethods/{payment_method_id}'
            .replace('{' + 'contact_id' + '}', encodeURIComponent(String(contactId)))
            .replace('{' + 'payment_method_id' + '}', encodeURIComponent(String(paymentMethodId)));
     ...
     */
    public async listPaymentMethods(filter?: string, orderBy?: string, pageSize?: number, pageToken?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // Path Params
        const localVarPath = '/rest/v2/paymentMethods';
    ...
    public async listPaymentMethods_1(contactId: string, filter?: string, orderBy?: string, pageSize?: number, pageToken?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/contacts/{contact_id}/paymentMethods'
            .replace('{' + 'contact_id' + '}', encodeURIComponent(String(contactId)));
     ...
     */
     public async listPaymentMethods_1WithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListContactPaymentMethodsResponse >> {
        ...
        if (isCodeInRange("200", response.httpStatusCode)) {
            ...
            ) as ListContactPaymentMethodsResponse;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
