...
export class ProductDiscountsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async updateProductDiscount(discountId: string, updateProductDiscountRequest: UpdateProductDiscountRequest, updateMask?: 'name,description,apply_to_commissions,discount_type,discount_value,product_id,criteria', _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (updateMask !== undefined) {
            requestContext.setQueryParam("update_mask", ObjectSerializer.serialize(updateMask, "'name,description,apply_to_commissions,discount_type,discount_value,product_id,criteria'", ""));
        }
