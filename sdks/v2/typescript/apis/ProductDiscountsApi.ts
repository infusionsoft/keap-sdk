...
export class ProductDiscountsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createProductDiscount(createProductDiscountRequest: CreateProductDiscountRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/discounts/products';
     ...
     */
    public async createProductDiscountCriteria(discountId: string, createProductDiscountCriteria: CreateProductDiscountCriteria, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'discountId' is not null or undefined
        if (discountId === null || discountId === undefined) {
            throw new RequiredError("ProductDiscountsApi", "createProductDiscountCriteria", "discountId");
        }


        // verify required parameter 'createProductDiscountCriteria' is not null or undefined
        if (createProductDiscountCriteria === null || createProductDiscountCriteria === undefined) {
            throw new RequiredError("ProductDiscountsApi", "createProductDiscountCriteria", "createProductDiscountCriteria");
        }


        // Path Params
        const localVarPath = '/rest/v2/discounts/products/{discount_id}/criteria'
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(createProductDiscountCriteria, "CreateProductDiscountCriteria", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
    ...
    public async deleteProductDiscount(discountId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/rest/v2/discounts/products/{discount_id}'
            .replace('{' + 'discount_id' + '}', encodeURIComponent(String(discountId)));
     ...
     * @param criteriaId 
     */
    public async deleteProductDiscountCriteria(discountId: string, criteriaId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'discountId' is not null or undefined
        if (discountId === null || discountId === undefined) {
            throw new RequiredError("ProductDiscountsApi", "deleteProductDiscountCriteria", "discountId");
        }


        // verify required parameter 'criteriaId' is not null or undefined
        if (criteriaId === null || criteriaId === undefined) {
            throw new RequiredError("ProductDiscountsApi", "deleteProductDiscountCriteria", "criteriaId");
        }


        // Path Params
        const localVarPath = '/rest/v2/discounts/products/{discount_id}/criteria/{criteria_id}'
            .replace('{' + 'discount_id' + '}', encodeURIComponent(String(discountId)))
     ...
     */
    public async updateProductDiscount(discountId: string, updateProductDiscountRequest: UpdateProductDiscountRequest, updateMask?: Set<'name' | 'description' | 'apply_to_commissions' | 'discount_type' | 'discount_value' | 'product_id' | 'criteria'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'name' | 'description' | 'apply_to_commissions' | 'discount_type' | 'discount_value' | 'product_id' | 'criteria'>", "");
...
export class ProductDiscountsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createProductDiscountCriteria
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createProductDiscountCriteriaWithHttpInfo(response: ResponseContext): Promise<HttpInfo<DiscountCriteria >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteProductDiscountCriteria
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteProductDiscountCriteriaWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
