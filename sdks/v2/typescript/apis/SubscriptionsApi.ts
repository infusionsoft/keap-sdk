...
export class SubscriptionsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createSubscriptionCustomFieldGroup(createCustomFieldGroupRequest: CreateCustomFieldGroupRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (createCustomFieldGroupRequest === null || createCustomFieldGroupRequest === undefined) {
            throw new RequiredError("SubscriptionsApi", "createSubscriptionCustomFieldGroup", "createCustomFieldGroupRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/subscriptions/model/customFields/groups';
     ...
     */
    public async createSubscriptionCustomFieldTab(createCustomFieldTabRequest: CreateCustomFieldTabRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (createCustomFieldTabRequest === null || createCustomFieldTabRequest === undefined) {
            throw new RequiredError("SubscriptionsApi", "createSubscriptionCustomFieldTab", "createCustomFieldTabRequest");
        }


        // Path Params
        const localVarPath = '/rest/v2/subscriptions/model/customFields/tabs';
     ...
     * @param groupId 
     */
    public async deleteSubscriptionCustomFieldGroup(groupId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'groupId' is not null or undefined
        if (groupId === null || groupId === undefined) {
            throw new RequiredError("SubscriptionsApi", "deleteSubscriptionCustomFieldGroup", "groupId");
        }


        // Path Params
        const localVarPath = '/rest/v2/subscriptions/model/customFields/groups/{group_id}'
     ...
     * @param tabId 
     */
    public async deleteSubscriptionCustomFieldTab(tabId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'tabId' is not null or undefined
        if (tabId === null || tabId === undefined) {
            throw new RequiredError("SubscriptionsApi", "deleteSubscriptionCustomFieldTab", "tabId");
        }


        // Path Params
        const localVarPath = '/rest/v2/subscriptions/model/customFields/tabs/{tab_id}'
     ...
     * @param groupId 
     */
    public async getSubscriptionCustomFieldGroup(groupId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'groupId' is not null or undefined
        if (groupId === null || groupId === undefined) {
            throw new RequiredError("SubscriptionsApi", "getSubscriptionCustomFieldGroup", "groupId");
        }
     ...
     * @param tabId 
     */
    public async getSubscriptionCustomFieldTab(tabId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'tabId' is not null or undefined
        if (tabId === null || tabId === undefined) {
            throw new RequiredError("SubscriptionsApi", "getSubscriptionCustomFieldTab", "tabId");
        }
     ...
     * @param subscriptionId 
     */
    public async invoiceSubscription(subscriptionId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'subscriptionId' is not null or undefined
        if (subscriptionId === null || subscriptionId === undefined) {
            throw new RequiredError("SubscriptionsApi", "invoiceSubscription", "subscriptionId");
        }


        // Path Params
        const localVarPath = '/rest/v2/subscriptions/{subscription_id}:invoice'
            .replace('{' + 'subscription_id' + '}', encodeURIComponent(String(subscriptionId)));
     ...
     */
    public async listSubscriptionCustomFieldGroups(tabId?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async listSubscriptionCustomFieldTabs(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
    ...
    public async updateSubscription(subscriptionId: string, updateSubscriptionRequest: UpdateSubscriptionRequest, updateMask?: Set<'contact_id' | 'subscription_plan_id' | 'quantity' | 'billing_amount' | 'auto_charge' | 'max_charge_attempts' | 'days_between_retries' | 'active' | 'billing_frequency' | 'billing_cycle' | 'next_bill_date' | 'end_date' | 'payment_method_id' | 'allow_tax' | 'lead_affiliate_id' | 'sale_affiliate_id' | 'promo_code' | 'shipping_option_id' | 'reason_stopped' | 'shipping_address' | 'custom_fields'>, _options?: Configuration): Promise<RequestContext> {
        ...
        if (updateMask !== undefined) {
            const serializedParams = ObjectSerializer.serialize(updateMask, "Set<'contact_id' | 'subscription_plan_id' | 'quantity' | 'billing_amount' | 'auto_charge' | 'max_charge_attempts' | 'days_between_retries' | 'active' | 'billing_frequency' | 'billing_cycle' | 'next_bill_date' | 'end_date' | 'payment_method_id' | 'allow_tax' | 'lead_affiliate_id' | 'sale_affiliate_id' | 'promo_code' | 'shipping_option_id' | 'reason_stopped' | 'shipping_address' | 'custom_fields'>", "");
     ...
     * @param updateMask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public async updateSubscriptionCustomField(customFieldId: string, updateCustomFieldMetaDataRequest: UpdateCustomFieldMetaDataRequest, updateMask?: Set<'group_id' | 'label' | 'options'>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async updateSubscriptionCustomFieldGroup(groupId: string, updateMask: Set<'name' | 'tab_id' | 'order'>, updateCustomFieldGroupRequest: UpdateCustomFieldGroupRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'groupId' is not null or undefined
        if (groupId === null || groupId === undefined) {
            throw new RequiredError("SubscriptionsApi", "updateSubscriptionCustomFieldGroup", "groupId");
        }


        // verify required parameter 'updateMask' is not null or undefined
        if (updateMask === null || updateMask === undefined) {
            throw new RequiredError("SubscriptionsApi", "updateSubscriptionCustomFieldGroup", "updateMask");
        }
        ...
        if (updateCustomFieldGroupRequest === null || updateCustomFieldGroupRequest === undefined) {
            throw new RequiredError("SubscriptionsApi", "updateSubscriptionCustomFieldGroup", "updateCustomFieldGroupRequest");
        }
     ...
     */
    public async updateSubscriptionCustomFieldTab(tabId: string, updateMask: Set<'name' | 'order'>, updateCustomFieldTabRequest: UpdateCustomFieldTabRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'tabId' is not null or undefined
        if (tabId === null || tabId === undefined) {
            throw new RequiredError("SubscriptionsApi", "updateSubscriptionCustomFieldTab", "tabId");
        }


        // verify required parameter 'updateMask' is not null or undefined
        if (updateMask === null || updateMask === undefined) {
            throw new RequiredError("SubscriptionsApi", "updateSubscriptionCustomFieldTab", "updateMask");
        }
        ...
        if (updateCustomFieldTabRequest === null || updateCustomFieldTabRequest === undefined) {
            throw new RequiredError("SubscriptionsApi", "updateSubscriptionCustomFieldTab", "updateCustomFieldTabRequest");
        }
...
export class SubscriptionsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createSubscriptionCustomFieldGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createSubscriptionCustomFieldGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createSubscriptionCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createSubscriptionCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldTab >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteSubscriptionCustomFieldGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteSubscriptionCustomFieldGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteSubscriptionCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteSubscriptionCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getSubscriptionCustomFieldGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSubscriptionCustomFieldGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CustomFieldGroup = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getSubscriptionCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSubscriptionCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldTab >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CustomFieldTab = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to invoiceSubscription
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async invoiceSubscriptionWithHttpInfo(response: ResponseContext): Promise<HttpInfo<OrderV2 >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to listSubscriptionCustomFieldGroups
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listSubscriptionCustomFieldGroupsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListCustomFieldGroupsResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to listSubscriptionCustomFieldTabs
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listSubscriptionCustomFieldTabsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ListCustomFieldTabsResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateSubscriptionCustomFieldGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateSubscriptionCustomFieldGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CustomFieldGroup = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateSubscriptionCustomFieldTab
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateSubscriptionCustomFieldTabWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CustomFieldTab >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: CustomFieldTab = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
