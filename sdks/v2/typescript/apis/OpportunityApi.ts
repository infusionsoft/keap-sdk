...
export class OpportunityApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param updateMask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.
     */
    public async updateOpportunityUsingPATCH(opportunityId: string, updateOpportunityRequestV2: UpdateOpportunityRequestV2, updateMask?: Array<string>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (updateOpportunityRequestV2 === null || updateOpportunityRequestV2 === undefined) {
            throw new RequiredError("OpportunityApi", "updateOpportunityUsingPATCH", "updateOpportunityRequestV2");
        }
