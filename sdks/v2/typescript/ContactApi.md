...
const request: ContactApiCreateContactRequest = {
  ...
  createUpdateContactRequest: {
    ...
    assistantName: "Pat Doe",
    assistantPhone: "5551234567",
...
```typescript
import { createConfiguration, ContactApi } from '';
import type { ContactApiCreateContactCustomFieldTabRequest } from '';

const configuration = createConfiguration();
const apiInstance = new ContactApi(configuration);

const request: ContactApiCreateContactCustomFieldTabRequest = {
...
const data = await apiInstance.createContactCustomFieldTab(request);
console.log('API called successfully. Returned data:', data);
```
...
> void deleteContactCustomFieldTab()
...
```typescript
import { createConfiguration, ContactApi } from '';
import type { ContactApiDeleteContactCustomFieldTabRequest } from '';

const configuration = createConfiguration();
const apiInstance = new ContactApi(configuration);

const request: ContactApiDeleteContactCustomFieldTabRequest = {
  
  tabId: "tab_id_example",
};

const data = await apiInstance.deleteContactCustomFieldTab(request);
console.log('API called successfully. Returned data:', data);
```
...
> CustomFieldTab getContactCustomFieldTab()
...
```typescript
import { createConfiguration, ContactApi } from '';
import type { ContactApiGetContactCustomFieldTabRequest } from '';

const configuration = createConfiguration();
const apiInstance = new ContactApi(configuration);

const request: ContactApiGetContactCustomFieldTabRequest = {
  
  tabId: "tab_id_example",
};

const data = await apiInstance.getContactCustomFieldTab(request);
console.log('API called successfully. Returned data:', data);
```
...
const data = await apiInstance.listContactCustomFieldTabs(request);
console.log('API called successfully. Returned data:', data);
```
...
> CustomFieldTab updateContactCustomFieldTab(updateCustomFieldTabRequest)
...
```typescript
import { createConfiguration, ContactApi } from '';
import type { ContactApiUpdateContactCustomFieldTabRequest } from '';

const configuration = createConfiguration();
const apiInstance = new ContactApi(configuration);

const request: ContactApiUpdateContactCustomFieldTabRequest = {
...
const data = await apiInstance.updateContactCustomFieldTab(request);
console.log('API called successfully. Returned data:', data);
```
