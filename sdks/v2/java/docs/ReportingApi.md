...
| [**retrieveReportModelWithHttpInfo**](ReportingApi.md#retrieveReportModelWithHttpInfo) | **GET** /rest/v2/reporting/reports/{report_id}/model | Retrieve Report Model |
...
public class Example {
    public static void main(String[] args) {
        ...
        String reportId = "123"; // String | The unique identifier of the report (Saved Search)
        try {
            ReportModel result = apiInstance.retrieveReportModel(reportId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ReportingApi#retrieveReportModel");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## retrieveReportModelWithHttpInfo

> ApiResponse<ReportModel> retrieveReportModel retrieveReportModelWithHttpInfo(reportId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String reportId = "123"; // String | The unique identifier of the report (Saved Search)
        try {
            ApiResponse<ReportModel> response = apiInstance.retrieveReportModelWithHttpInfo(reportId);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**ReportModel**](ReportModel.md)>
