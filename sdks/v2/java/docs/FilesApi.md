...
| [**getFileData1WithHttpInfo**](FilesApi.md#getFileData1WithHttpInfo) | **GET** /rest/v2/files/{file_id}:data | Retrieve a file&#39;s data |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling FilesApi#getFileData1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getFileData1WithHttpInfo

> ApiResponse<byte[]> getFileData1 getFileData1WithHttpInfo(fileId)
