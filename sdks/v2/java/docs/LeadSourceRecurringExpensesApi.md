...
public class Example {
    public static void main(String[] args) {
        ...
        LeadSourceRecurringExpensesApi apiInstance = new LeadSourceRecurringExpensesApi(defaultClient);
        String leadSourceId = "-"; // String | The ID of the lead source this recurring expense belongs to. Use '-' as a wildcard to list recurring expenses across all lead sources.
...
| **updateMask** | [**Set&lt;String&gt;**](String.md)| An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped. | [optional] [enum: title, notes, amount, start_time, end_time] |
