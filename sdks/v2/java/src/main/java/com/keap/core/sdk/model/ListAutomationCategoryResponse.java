 ...
 */
@Schema(description = "Response containing a list of automation categories")
@JsonPropertyOrder({
...
public class ListAutomationCategoryResponse implements Serializable {
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "List of automation categories")
