...
@JsonPropertyOrder({
  ...
  RestV2Product.JSON_PROPERTY_SHIPPABLE,
...
public class RestV2Product implements Serializable {
  ...
  public RestV2Product shippable(@jakarta.annotation.Nullable Boolean shippable) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, restV2Product.active) &&
        ...
        Objects.equals(this.shippable, restV2Product.shippable) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, categories, cityTaxable, countryTaxable, description, id, inventory, name, options, price, shippable, shortDescription, sku, stateTaxable, storefrontHidden, subscriptionOnly, subscriptionPlans, taxable, weight);
  }
    ...
    public static class Builder {
        ...
        public RestV2Product.Builder active(Boolean active) {
          ...
          return this;
            ...
            public RestV2Product.Builder options(List<ProductOptions> options) {
          ...
          return this;
            ...
            public RestV2Product.Builder shippable(Boolean shippable) {
          ...
          return this;
            ...
            public RestV2Product.Builder subscriptionPlans(List<SubscriptionPlan> subscriptionPlans) {
