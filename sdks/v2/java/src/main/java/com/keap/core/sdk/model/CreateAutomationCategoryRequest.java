 ...
 */
@Schema(description = "Request to create an automation category")
@JsonPropertyOrder({
...
public class CreateAutomationCategoryRequest implements Serializable {
  ...
  public CreateAutomationCategoryRequest name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  @Schema(example = "Marketing Campaigns", requiredMode = Schema.RequiredMode.REQUIRED, description = "The name of the category to create")
