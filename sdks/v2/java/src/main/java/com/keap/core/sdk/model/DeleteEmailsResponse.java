 ...
 */
@Schema(description = "Response from deleting email records")
@JsonPropertyOrder({
...
public class DeleteEmailsResponse implements Serializable {
   ...
   * @return results
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Map of email ID to deletion result (SUCCESS, NO_PERMISSION, EMAIL_ID_NOT_FOUND)")
