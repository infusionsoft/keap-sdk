 ...
 */
@Schema(description = "Error that occurred when creating an email record")
@JsonPropertyOrder({
...
public class EmailSentCreateError implements Serializable {
   ...
   * @return errorMessage
   */
  @jakarta.annotation.Nullable  @Schema(example = "Contact not found", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Description of the error")
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The email request that failed")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errorMessage, emailSentCreateError.errorMessage) &&
        Objects.equals(this.email, emailSentCreateError.email);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errorMessage, email);
  }
