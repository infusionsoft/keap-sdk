...
public class UpdateProductInterestRequest implements Serializable {
   ...
   * @return price
   */
  @jakarta.annotation.Nullable  @Schema(example = "10000", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The price per unit of the product.")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "10", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The percent to discount the product.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.price, updateProductInterestRequest.price) &&
        Objects.equals(this.quantity, updateProductInterestRequest.quantity) &&
        Objects.equals(this.discountPercent, updateProductInterestRequest.discountPercent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(price, quantity, discountPercent);
  }
