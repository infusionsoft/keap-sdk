...
public class CreateShippingDiscountRequest implements Serializable {
  ...
  @jakarta.annotation.Nullable  private List<@Valid CreateShippingDiscountCriteria> criteria = new ArrayList<>();
  ...
  @Schema(example = "Free Shipping Over $100", requiredMode = Schema.RequiredMode.REQUIRED, description = "Name of the discount")
  ...
  public CreateShippingDiscountRequest criteria(@jakarta.annotation.Nullable List<@Valid CreateShippingDiscountCriteria> criteria) {
    this.criteria = criteria;
    return this;
  }

  public CreateShippingDiscountRequest addCriteriaItem(CreateShippingDiscountCriteria criteriaItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<@Valid CreateShippingDiscountCriteria> getCriteria() {
    return criteria;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CRITERIA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCriteria(@jakarta.annotation.Nullable List<@Valid CreateShippingDiscountCriteria> criteria) {
    this.criteria = criteria;
  }
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(example = "100", requiredMode = Schema.RequiredMode.REQUIRED, description = "Value of the discount (amount or percentage depending on discount_type)")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createShippingDiscountRequest.name) &&
        Objects.equals(this.description, createShippingDiscountRequest.description) &&
        Objects.equals(this.criteria, createShippingDiscountRequest.criteria) &&
    ...
    public static class Builder {
        ...
        public CreateShippingDiscountRequest.Builder name(String name) {
          ...
          return this;
            ...
            public CreateShippingDiscountRequest.Builder criteria(List<CreateShippingDiscountCriteria> criteria) {
