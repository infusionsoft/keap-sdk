...
public class UpdateProductInventoryRequest implements Serializable {
  ...
  public UpdateProductInventoryRequest quantity(@jakarta.annotation.Nonnull Integer quantity) {
  ...
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "The amount to increment or decrement by. Must be greater than or equal to 0.")
  ...
  public UpdateProductInventoryRequest type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "The direction to alter the quantity in")
