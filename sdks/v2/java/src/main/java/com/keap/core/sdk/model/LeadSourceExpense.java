...
public class LeadSourceExpense implements Serializable {
   ...
   * @return leadSourceId
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The ID of the lead source this expense belongs to")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "If this expense was incurred from a recurring expense, this is the ID of that recurring expense")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, createTime, id, incurredTime, leadSourceId, leadSourceRecurringExpenseId, notes, title, updateTime);
  }
