...
public class CreateLeadSourceRecurringExpenseRequest implements Serializable {
  ...
  public CreateLeadSourceRecurringExpenseRequest amount(@jakarta.annotation.Nonnull Long amount) {
    this.amount = amount;
    return this;
  }
 ...
 @Min(0L)  @Schema(example = "22550", requiredMode = Schema.RequiredMode.REQUIRED, description = "The monthly cost of the lead source recurring expense. The value should be in the smallest unit of currency for your currency locale. For example, if your currency locale is USD, then the smallest unit of currency is in cents, $225.50 would be provided in the request as 22550.")
  ...
  public CreateLeadSourceRecurringExpenseRequest startTime(@jakarta.annotation.Nullable ZonedDateTime startTime) {
  ...
  @Schema(example = "2024-01-01T00:00:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The time the lead source recurring expense starts")
  ...
  public CreateLeadSourceRecurringExpenseRequest endTime(@jakarta.annotation.Nullable ZonedDateTime endTime) {
   ...
   */
  @jakarta.annotation.Nullable  @Valid
  @Schema(example = "2024-12-31T23:59:59Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The time the lead source recurring expense ends")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, createLeadSourceRecurringExpenseRequest.title) &&
        Objects.equals(this.notes, createLeadSourceRecurringExpenseRequest.notes) &&
        Objects.equals(this.amount, createLeadSourceRecurringExpenseRequest.amount) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, notes, amount, startTime, endTime);
  }
    ...
    public static class Builder {
        ...
        public CreateLeadSourceRecurringExpenseRequest.Builder title(String title) {
          ...
          return this;
            ...
            public CreateLeadSourceRecurringExpenseRequest.Builder startTime(ZonedDateTime startTime) {
              this.instance.startTime = startTime;
          return this;
        }
            public CreateLeadSourceRecurringExpenseRequest.Builder endTime(ZonedDateTime endTime) {
