...
public class Report implements Serializable {
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "123", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The unique identifier of the report (Saved Search)")
   ...
   * @return name
   */
  @jakarta.annotation.Nullable  @Schema(example = "Monthly Sales Report", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of the report")
   ...
   * @return updatedTime
   */
  @jakarta.annotation.Nullable  @Schema(example = "2024-01-15T10:30:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The last update timestamp")
   ...
   * @return createdTime
   */
  @jakarta.annotation.Nullable  @Schema(example = "2024-01-01T08:00:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The creation timestamp")
   ...
   * @return userIds
   */
  @jakarta.annotation.Nullable  @Schema(example = "[1, 2, ALL_USERS]", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "A list of Users who have access to this Saved Search, or ALL_USERS if visible to all")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, updatedTime, createdTime, userIds);
  }
