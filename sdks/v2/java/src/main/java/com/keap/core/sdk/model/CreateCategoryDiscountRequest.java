...
public class CreateCategoryDiscountRequest implements Serializable {
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "The discount percent. Must be greater than or equal to 0.")
    ...
    public static class Builder {
        ...
        public CreateCategoryDiscountRequest.Builder applyToCommissions(Boolean applyToCommissions) {
          ...
          return this;
            ...
            public CreateCategoryDiscountRequest.Builder criteria(List<DiscountCriteria> criteria) {
