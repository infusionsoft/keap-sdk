 ...
 */
@JsonPropertyOrder({
  BasicContact.JSON_PROPERTY_APPLIED_TIME,
...
public class BasicContact implements Serializable {
  ...
  public BasicContact appliedTime(@jakarta.annotation.Nullable String appliedTime) {
   ...
   * @return appliedTime
   */
  @jakarta.annotation.Nullable  @Schema(example = "2023-10-01T12:00:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The time the tag was applied to the contact, in ISO 8601 format.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appliedTime, basicContact.appliedTime) &&
        Objects.equals(this.email, basicContact.email) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appliedTime, email, familyName, givenName, id);
  }
  ...
  private String toIndentedString(Object o) {
    ...
    public static class Builder {
        ...
        public BasicContact.Builder appliedTime(String appliedTime) {
