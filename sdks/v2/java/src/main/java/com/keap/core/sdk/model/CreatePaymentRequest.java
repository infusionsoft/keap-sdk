...
public class CreatePaymentRequest implements Serializable {
   ...
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Whether to apply this payment to commissions.")
  ...
  public CreatePaymentRequest paymentAmount(@jakarta.annotation.Nullable Double paymentAmount) {
   ...
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The amount to pay. Must not exceed the current balance of the order. Must be greater than 0 if charging with a payment_method_id")
   ...
   * @return paymentTime
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The date and time of payment. In ISO-8601 format (e.g. 2024-05-21T23:00:00Z)")
