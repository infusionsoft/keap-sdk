...
public class AddProductInterestRequest implements Serializable {
  ...
  @Schema(example = "PRODUCT", requiredMode = Schema.RequiredMode.REQUIRED, description = "The product interest type.")
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(example = "123", requiredMode = Schema.RequiredMode.REQUIRED, description = "The `product_id` (when the `type` is set to `PRODUCT`)  or the `subscription_plan_id` (when the `type` is set to `SUBSCRIPTION_PLAN`). ")
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(example = "10000", requiredMode = Schema.RequiredMode.REQUIRED, description = "The price per unit of the product.")
   ...
   * @return quantity
   */
  @jakarta.annotation.Nullable  @Schema(example = "1", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Defaults to `1`.")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "10", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Defaults to `0`.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, addProductInterestRequest.type) &&
        ...
        Objects.equals(this.discountPercent, addProductInterestRequest.discountPercent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, entityId, price, quantity, discountPercent);
  }
