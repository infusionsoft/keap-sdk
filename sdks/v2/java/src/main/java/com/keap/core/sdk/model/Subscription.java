...
public class Subscription implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, allowTax, autoCharge, billingAmount, billingCycle, billingFrequency, contactId, endDate, id, lastBillDate, merchantAccountId, nextBillDate, paymentMethodId, productId, quantity, saleAffiliateId, startDate, subscriptionPlanId);
  }
