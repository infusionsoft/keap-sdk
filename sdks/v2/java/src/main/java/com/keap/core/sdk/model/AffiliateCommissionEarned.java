...
public class AffiliateCommissionEarned implements Serializable {
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "1250.5", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Total commission earned by affiliate")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "https://app.thryv.com/affiliate/ledger?affiliateId=123", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "URL to view affiliate ledger")
