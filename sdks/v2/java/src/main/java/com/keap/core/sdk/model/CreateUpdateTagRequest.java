...
public class CreateUpdateTagRequest implements Serializable {
   ...
   * @return name
   */
  @jakarta.annotation.Nullable  @Schema(example = "VIP Customer", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Name of the tag, up to 255 characters will be saved")
   ...
   * @return description
   */
  @jakarta.annotation.Nullable  @Schema(example = "High-value customers", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Description of the tag")
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Category of the tag. If not provided, the tag will not be assigned to a category.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createUpdateTagRequest.name) &&
        Objects.equals(this.description, createUpdateTagRequest.description) &&
        Objects.equals(this.category, createUpdateTagRequest.category);
  }
