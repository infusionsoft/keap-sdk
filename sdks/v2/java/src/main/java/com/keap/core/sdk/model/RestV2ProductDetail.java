...
import com.keap.core.sdk.model.ProductOptionsDetail;
import com.keap.core.sdk.model.SubscriptionPlanDetail;
 ...
 */
@JsonPropertyOrder({
  RestV2ProductDetail.JSON_PROPERTY_ID,
  RestV2ProductDetail.JSON_PROPERTY_NAME,
  RestV2ProductDetail.JSON_PROPERTY_PRICE,
  RestV2ProductDetail.JSON_PROPERTY_ACTIVE,
  RestV2ProductDetail.JSON_PROPERTY_DESCRIPTION,
  RestV2ProductDetail.JSON_PROPERTY_SKU,
  RestV2ProductDetail.JSON_PROPERTY_SHIPPABLE,
  RestV2ProductDetail.JSON_PROPERTY_WEIGHT,
  RestV2ProductDetail.JSON_PROPERTY_TAXABLE,
  RestV2ProductDetail.JSON_PROPERTY_CATEGORIES,
  RestV2ProductDetail.JSON_PROPERTY_OPTIONS,
  RestV2ProductDetail.JSON_PROPERTY_INVENTORY,
  RestV2ProductDetail.JSON_PROPERTY_SHORT_DESCRIPTION,
  RestV2ProductDetail.JSON_PROPERTY_SUBSCRIPTION_ONLY,
  RestV2ProductDetail.JSON_PROPERTY_STOREFRONT_HIDDEN,
...
public class RestV2ProductDetail implements Serializable {
  ...
  @jakarta.annotation.Nullable  private CurrencyValueDetail price;
  ...
  @jakarta.annotation.Nullable  private List<@Valid ProductOptionsDetail> options = new ArrayList<>();
  ...
  public RestV2ProductDetail id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public RestV2ProductDetail name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public RestV2ProductDetail price(@jakarta.annotation.Nullable CurrencyValueDetail price) {
    this.price = price;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public CurrencyValueDetail getPrice() {
    return price;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PRICE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPrice(@jakarta.annotation.Nullable CurrencyValueDetail price) {
    this.price = price;
  }


  public RestV2ProductDetail active(@jakarta.annotation.Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestV2ProductDetail description(@jakarta.annotation.Nullable String description) {
  ...
  public RestV2ProductDetail sku(@jakarta.annotation.Nullable String sku) {
    this.sku = sku;
    return this;
  }
  ...
  public RestV2ProductDetail shippable(@jakarta.annotation.Nullable Boolean shippable) {
  ...
  public RestV2ProductDetail weight(@jakarta.annotation.Nullable Double weight) {
    this.weight = weight;
    return this;
  }
  ...
  public RestV2ProductDetail taxable(@jakarta.annotation.Nullable Boolean taxable) {
  ...
  public RestV2ProductDetail categories(@jakarta.annotation.Nullable List<String> categories) {
    this.categories = categories;
    return this;
  }

  public RestV2ProductDetail addCategoriesItem(String categoriesItem) {
  ...
  public RestV2ProductDetail options(@jakarta.annotation.Nullable List<@Valid ProductOptionsDetail> options) {
    this.options = options;
    return this;
  }

  public RestV2ProductDetail addOptionsItem(ProductOptionsDetail optionsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<@Valid ProductOptionsDetail> getOptions() {
    return options;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OPTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOptions(@jakarta.annotation.Nullable List<@Valid ProductOptionsDetail> options) {
    this.options = options;
  }


  public RestV2ProductDetail inventory(@jakarta.annotation.Nullable ProductInventoryDetail inventory) {
  ...
  public RestV2ProductDetail shortDescription(@jakarta.annotation.Nullable String shortDescription) {
  ...
  public RestV2ProductDetail subscriptionOnly(@jakarta.annotation.Nullable Boolean subscriptionOnly) {
  ...
  public RestV2ProductDetail storefrontHidden(@jakarta.annotation.Nullable Boolean storefrontHidden) {
  ...
  public RestV2ProductDetail countryTaxable(@jakarta.annotation.Nullable Boolean countryTaxable) {
  ...
  public RestV2ProductDetail stateTaxable(@jakarta.annotation.Nullable Boolean stateTaxable) {
  ...
  public RestV2ProductDetail cityTaxable(@jakarta.annotation.Nullable Boolean cityTaxable) {
  ...
  public RestV2ProductDetail subscriptionPlans(@jakarta.annotation.Nullable List<@Valid SubscriptionPlanDetail> subscriptionPlans) {
    this.subscriptionPlans = subscriptionPlans;
    return this;
  }

  public RestV2ProductDetail addSubscriptionPlansItem(SubscriptionPlanDetail subscriptionPlansItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<@Valid SubscriptionPlanDetail> getSubscriptionPlans() {
    return subscriptionPlans;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUBSCRIPTION_PLANS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubscriptionPlans(@jakarta.annotation.Nullable List<@Valid SubscriptionPlanDetail> subscriptionPlans) {
    this.subscriptionPlans = subscriptionPlans;
  }
  ...
  public boolean equals(Object o) {
    ...
    RestV2ProductDetail restV2ProductDetail = (RestV2ProductDetail) o;
    return Objects.equals(this.id, restV2ProductDetail.id) &&
        Objects.equals(this.name, restV2ProductDetail.name) &&
        Objects.equals(this.price, restV2ProductDetail.price) &&
        Objects.equals(this.active, restV2ProductDetail.active) &&
        Objects.equals(this.description, restV2ProductDetail.description) &&
        Objects.equals(this.sku, restV2ProductDetail.sku) &&
        Objects.equals(this.shippable, restV2ProductDetail.shippable) &&
        Objects.equals(this.weight, restV2ProductDetail.weight) &&
        Objects.equals(this.taxable, restV2ProductDetail.taxable) &&
        Objects.equals(this.categories, restV2ProductDetail.categories) &&
        Objects.equals(this.options, restV2ProductDetail.options) &&
        Objects.equals(this.inventory, restV2ProductDetail.inventory) &&
        Objects.equals(this.shortDescription, restV2ProductDetail.shortDescription) &&
        Objects.equals(this.subscriptionOnly, restV2ProductDetail.subscriptionOnly) &&
        Objects.equals(this.storefrontHidden, restV2ProductDetail.storefrontHidden) &&
  ...
  private String toIndentedString(Object o) {
    ...
    public static class Builder {
        ...
        private RestV2ProductDetail instance;
    
        public Builder() {
          this(new RestV2ProductDetail());
        }
    
        protected Builder(RestV2ProductDetail instance) {
          this.instance = instance;
        }
    
        public RestV2ProductDetail.Builder id(String id) {
              this.instance.id = id;
          return this;
        }
            public RestV2ProductDetail.Builder name(String name) {
              this.instance.name = name;
          return this;
        }
            public RestV2ProductDetail.Builder price(CurrencyValueDetail price) {
              this.instance.price = price;
          return this;
        }
            public RestV2ProductDetail.Builder active(Boolean active) {
              this.instance.active = active;
          return this;
        }
            public RestV2ProductDetail.Builder description(String description) {
              this.instance.description = description;
          return this;
        }
            public RestV2ProductDetail.Builder sku(String sku) {
              this.instance.sku = sku;
          return this;
        }
            public RestV2ProductDetail.Builder shippable(Boolean shippable) {
              this.instance.shippable = shippable;
          return this;
        }
            public RestV2ProductDetail.Builder weight(Double weight) {
              this.instance.weight = weight;
          return this;
        }
            public RestV2ProductDetail.Builder taxable(Boolean taxable) {
              this.instance.taxable = taxable;
          return this;
        }
            public RestV2ProductDetail.Builder categories(List<String> categories) {
              this.instance.categories = categories;
          return this;
        }
            public RestV2ProductDetail.Builder options(List<ProductOptionsDetail> options) {
              this.instance.options = options;
          return this;
        }
            public RestV2ProductDetail.Builder inventory(ProductInventoryDetail inventory) {
              this.instance.inventory = inventory;
          return this;
        }
            public RestV2ProductDetail.Builder shortDescription(String shortDescription) {
              this.instance.shortDescription = shortDescription;
          return this;
        }
            public RestV2ProductDetail.Builder subscriptionOnly(Boolean subscriptionOnly) {
              this.instance.subscriptionOnly = subscriptionOnly;
          return this;
        }
            public RestV2ProductDetail.Builder storefrontHidden(Boolean storefrontHidden) {
              this.instance.storefrontHidden = storefrontHidden;
          return this;
        }
            public RestV2ProductDetail.Builder countryTaxable(Boolean countryTaxable) {
              this.instance.countryTaxable = countryTaxable;
          return this;
        }
            public RestV2ProductDetail.Builder stateTaxable(Boolean stateTaxable) {
              this.instance.stateTaxable = stateTaxable;
          return this;
        }
            public RestV2ProductDetail.Builder cityTaxable(Boolean cityTaxable) {
              this.instance.cityTaxable = cityTaxable;
          return this;
        }
            public RestV2ProductDetail.Builder subscriptionPlans(List<SubscriptionPlanDetail> subscriptionPlans) {
        ...
        /**
        * returns a built RestV2ProductDetail instance.
        *
        * The builder is not reusable.
        */
        public RestV2ProductDetail build() {
          try {
      ...
      */
      public static RestV2ProductDetail.Builder builder() {
        return new RestV2ProductDetail.Builder();
      }
    
      /**
      * Create a builder with a shallow copy of this instance.
      */
      public RestV2ProductDetail.Builder toBuilder() {
        return new RestV2ProductDetail.Builder()
          .id(getId())
          .name(getName())
          .price(getPrice())
