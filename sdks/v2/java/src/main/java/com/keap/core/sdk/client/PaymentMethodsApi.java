...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class PaymentMethodsApi {
  ...
  private HttpRequest.Builder deactivatePaymentMethodRequestBuilder(String contactId, String paymentMethodId) throws ApiException {
    ...
    String localVarPath = "/rest/v2/contacts/{contact_id}/paymentMethods/{payment_method_id}:deactivate"
  ...
  private HttpRequest.Builder deletePaymentMethodRequestBuilder(String contactId, String paymentMethodId) throws ApiException {
    ...
    String localVarPath = "/rest/v2/contacts/{contact_id}/paymentMethods/{payment_method_id}"
        .replace("{contact_id}", ApiClient.urlEncode(contactId.toString()))
        .replace("{payment_method_id}", ApiClient.urlEncode(paymentMethodId.toString()));
  ...
  private HttpRequest.Builder listPaymentMethods_0RequestBuilder(String contactId, String filter, String orderBy, Integer pageSize, String pageToken) throws ApiException {
    ...
    String localVarPath = "/rest/v2/contacts/{contact_id}/paymentMethods"
        .replace("{contact_id}", ApiClient.urlEncode(contactId.toString()));
