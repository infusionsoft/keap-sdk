...
public class Item implements Serializable {
  ...
  public enum TypeEnum {
    ...
    UNLAYER_EMAIL_CONFIRM(String.valueOf("UnlayerEmailConfirm")),
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "101", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The unique identifier of the item")
   ...
   * @return name
   */
  @jakarta.annotation.Nullable  @Schema(example = "Send Welcome Email", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of the item")
   ...
   * @return type
   */
  @jakarta.annotation.Nullable  @Schema(example = "Email", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The type of flow item")
   ...
   * @return nextItemId
   */
  @jakarta.annotation.Nullable  @Schema(example = "102", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The ID of the next item in the sequence")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "100", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The ID of the previous item in the sequence")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, type, nextItemId, previousItemId);
  }
