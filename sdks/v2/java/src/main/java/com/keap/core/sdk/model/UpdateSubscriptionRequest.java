...
public class UpdateSubscriptionRequest implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, allowTax, autoCharge, billingAmount, billingCycle, billingFrequency, contactId, daysBetweenRetries, endDate, leadAffiliateId, maxChargeAttempts, nextBillDate, paymentMethodId, productId, quantity, saleAffiliateId, shippingAddress, subscriptionPlanId);
  }
