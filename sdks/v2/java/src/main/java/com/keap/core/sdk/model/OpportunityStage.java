...
public class OpportunityStage implements Serializable {
  ...
  @Schema(example = "1", requiredMode = Schema.RequiredMode.REQUIRED, description = "Stage ID")
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Stage details")
   ...
   * @return reasons
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Stage change reasons")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, opportunityStage.id) &&
        Objects.equals(this.name, opportunityStage.name) &&
        Objects.equals(this.details, opportunityStage.details) &&
        Objects.equals(this.reasons, opportunityStage.reasons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, details, reasons);
  }
