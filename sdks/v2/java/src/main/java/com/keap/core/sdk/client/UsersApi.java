...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class UsersApi {
  ...
  private HttpRequest.Builder getUserByIdRequestBuilder(String userId) throws ApiException {
    ...
    String localVarPath = "/rest/v2/users/{user_id}"
  ...
  private HttpRequest.Builder getUserInfoRequestBuilder() throws ApiException {
    ...
    String localVarPath = "/rest/v2/oauth/connect/userinfo";
  ...
  private HttpRequest.Builder getUserSignatureRequestBuilder(String userId) throws ApiException {
    ...
    String localVarPath = "/rest/v2/users/{user_id}/signature"
        .replace("{user_id}", ApiClient.urlEncode(userId.toString()));
   ...
   * @param orderBy Attribute and direction to order items. One of the following fields: - &#x60;create_time&#x60; - &#x60;email&#x60; - &#x60;name&#x60; (sorts by family name / last name; uses User ID as tiebreaker for stable pagination)  One of the following directions: - &#x60;asc&#x60; - &#x60;desc&#x60; (optional)
  ...
  private HttpRequest.Builder listPaginatedUsersRequestBuilder(String filter, String orderBy, Integer pageSize, String pageToken) throws ApiException {
    ...
    String localVarPath = "/rest/v2/users";
