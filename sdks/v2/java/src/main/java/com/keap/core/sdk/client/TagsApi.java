...
import com.keap.core.sdk.model.ListTagContactAssociationsResponse;
...
import com.keap.core.sdk.model.TagContactCount;
...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class TagsApi {
   ...
   * @param applyRemoveTagRequest  (required)
  ...
  private HttpRequest.Builder applyTagsRequestBuilder(String tagId, ApplyRemoveTagRequest applyRemoveTagRequest) throws ApiException {
    ...
    String localVarPath = "/rest/v2/tags/{tag_id}/contacts:applyTags"
   ...
   * @param tagId The ID of the tag whose contacts are counted (required)
   ...
   * @return TagContactCount
   * @throws ApiException if fails to make API call
   */
  public TagContactCount countContactsForTag(String tagId, String filter) throws ApiException {
    ApiResponse<TagContactCount> localVarResponse = countContactsForTagWithHttpInfo(tagId, filter);
    return localVarResponse.getData();
  }
   ...
   * @param tagId The ID of the tag whose contacts are counted (required)
   * @param filter Filter to apply, allowed fields are: - (String) &#x60;given_name&#x60; - (String) &#x60;family_name&#x60; - (String) &#x60;email&#x60; - (String) &#x60;since_applied_time&#x60; - (String) &#x60;until_applied_time&#x60;  You will need to apply the &#x60;&#x3D;&#x3D;&#x60; operator to check the equality of one of the filters with your searched word, in the encoded form &#x60;%3D%3D&#x60;. If NONE is passed in for &#x60;email&#x60;, &#x60;given_name&#x60;, or &#x60;family_name&#x60;, it will check for the non-existence of that field. For the filters listed above, here are some examples: - &#x60;filter&#x3D;given_name%3D%3DJohn&#x60; - &#x60;filter&#x3D;family_name%3D%3DSmith&#x60; - &#x60;filter&#x3D;email%3D%3DNONE&#x60; - &#x60;filter&#x3D;since_applied_time%3D%3D2025-04-16T20:33:02.321Z;until_applied_time%3D%3D2025-08-16T20:33:02.321Z;&#x60;  Omit the filter to count every contact associated with the tag. (optional)
   * @return ApiResponse&lt;TagContactCount&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<TagContactCount> countContactsForTagWithHttpInfo(String tagId, String filter) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = countContactsForTagRequestBuilder(tagId, filter);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("countContactsForTag", localVarResponse);
        }
        return new ApiResponse<TagContactCount>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<TagContactCount>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder countContactsForTagRequestBuilder(String tagId, String filter) throws ApiException {
    // verify the required parameter 'tagId' is set
    if (tagId == null) {
      throw new ApiException(400, "Missing the required parameter 'tagId' when calling countContactsForTag");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/rest/v2/tags/{tag_id}/contacts/count"
        .replace("{tag_id}", ApiClient.urlEncode(tagId.toString()));
   ...
   * Create Tag
   * Creates a new Tag
   * @param createUpdateTagRequest  (required)
   * @return Tag
   * @throws ApiException if fails to make API call
   */
  ...
  private HttpRequest.Builder createTagRequestBuilder(CreateUpdateTagRequest createUpdateTagRequest) throws ApiException {
    ...
    String localVarPath = "/rest/v2/tags";
   ...
   * @param createUpdateTagCategoryRequest  (required)
   * @return TagCategory
   * @throws ApiException if fails to make API call
   */
  public TagCategory createTagCategory(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest) throws ApiException {
    ApiResponse<TagCategory> localVarResponse = createTagCategoryWithHttpInfo(createUpdateTagCategoryRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<TagCategory> createTagCategoryWithHttpInfo(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<TagCategory>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<TagCategory>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder createTagCategoryRequestBuilder(CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest) throws ApiException {
    ...
    String localVarPath = "/rest/v2/tags/categories";
  ...
  private HttpRequest.Builder deleteTagRequestBuilder(String tagId) throws ApiException {
    ...
    String localVarPath = "/rest/v2/tags/{tag_id}"
        .replace("{tag_id}", ApiClient.urlEncode(tagId.toString()));
  ...
  private HttpRequest.Builder deleteTagCategoryRequestBuilder(String tagCategoryId) throws ApiException {
    ...
    String localVarPath = "/rest/v2/tags/categories/{tag_category_id}"
   ...
   * @param orderBy Attribute and direction to order items. One of the following fields: - &#x60;company_name&#x60; - &#x60;email&#x60; - &#x60;applied_time&#x60;  One of the following directions: - &#x60;asc&#x60; - &#x60;desc&#x60; (optional)
  ...
  private HttpRequest.Builder listCompaniesForTagIdRequestBuilder(String tagId, String filter, String orderBy, Integer pageSize, String pageToken) throws ApiException {
    ...
    String localVarPath = "/rest/v2/tags/{tag_id}/companies"
        .replace("{tag_id}", ApiClient.urlEncode(tagId.toString()));
   ...
   * @param filter Filter to apply (at least one is required). Allowed fields: - (List[String]) &#x60;tag_ids&#x60; (max 100) - (ISO-8601) &#x60;since_applied_time&#x60; - (ISO-8601) &#x60;until_applied_time&#x60;  (optional)
   * @param pageToken Page token (optional)
   * @param orderBy Attribute and direction to order items (best-effort for cross-collection reads). Field: - &#x60;applied_time&#x60;  Direction: - &#x60;asc&#x60; - &#x60;desc&#x60;  Field and direction are space-separated, e.g. &#x60;applied_time desc&#x60;. (optional)
   * @param pageSize Total number of items to return per page (optional)
   * @return ListTagContactAssociationsResponse
   * @throws ApiException if fails to make API call
   */
  public ListTagContactAssociationsResponse listContactsAcrossTags(String filter, String pageToken, String orderBy, Integer pageSize) throws ApiException {
    ApiResponse<ListTagContactAssociationsResponse> localVarResponse = listContactsAcrossTagsWithHttpInfo(filter, pageToken, orderBy, pageSize);
    return localVarResponse.getData();
  }
   ...
   * @param orderBy Attribute and direction to order items (best-effort for cross-collection reads). Field: - &#x60;applied_time&#x60;  Direction: - &#x60;asc&#x60; - &#x60;desc&#x60;  Field and direction are space-separated, e.g. &#x60;applied_time desc&#x60;. (optional)
   * @param pageSize Total number of items to return per page (optional)
   * @return ApiResponse&lt;ListTagContactAssociationsResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ListTagContactAssociationsResponse> listContactsAcrossTagsWithHttpInfo(String filter, String pageToken, String orderBy, Integer pageSize) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = listContactsAcrossTagsRequestBuilder(filter, pageToken, orderBy, pageSize);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("listContactsAcrossTags", localVarResponse);
        }
        return new ApiResponse<ListTagContactAssociationsResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<ListTagContactAssociationsResponse>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder listContactsAcrossTagsRequestBuilder(String filter, String pageToken, String orderBy, Integer pageSize) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/rest/v2/tags/-/contacts";
   ...
   * @param orderBy Attribute and direction to order items. One of the following fields: - &#x60;given_name&#x60; - &#x60;family_name&#x60; - &#x60;email&#x60; - &#x60;applied_time&#x60;  One of the following directions: - &#x60;asc&#x60; - &#x60;desc&#x60; (optional)
   * @param pageSize Total number of items to return per page (optional)
   * @param pageToken Page token (optional)
  ...
  private HttpRequest.Builder listContactsWithTagIdRequestBuilder(String tagId, String filter, String orderBy, Integer pageSize, String pageToken) throws ApiException {
    ...
    String localVarPath = "/rest/v2/tags/{tag_id}/contacts"
        .replace("{tag_id}", ApiClient.urlEncode(tagId.toString()));
  ...
  private HttpRequest.Builder removeTagsRequestBuilder(String tagId, ApplyRemoveTagRequest applyRemoveTagRequest) throws ApiException {
    ...
    String localVarPath = "/rest/v2/tags/{tag_id}/contacts:removeTags"
        .replace("{tag_id}", ApiClient.urlEncode(tagId.toString()));
  ...
  private HttpRequest.Builder updateTagRequestBuilder(String tagId, CreateUpdateTagRequest createUpdateTagRequest, Set<String> updateMask) throws ApiException {
    ...
    // verify the required parameter 'createUpdateTagRequest' is set
    if (createUpdateTagRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'createUpdateTagRequest' when calling updateTag");
    }
  ...
  private HttpRequest.Builder updateTagCategoryRequestBuilder(String tagCategoryId, CreateUpdateTagCategoryRequest createUpdateTagCategoryRequest, Set<String> updateMask) throws ApiException {
    ...
    // verify the required parameter 'createUpdateTagCategoryRequest' is set
    if (createUpdateTagCategoryRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'createUpdateTagCategoryRequest' when calling updateTagCategory");
    }
