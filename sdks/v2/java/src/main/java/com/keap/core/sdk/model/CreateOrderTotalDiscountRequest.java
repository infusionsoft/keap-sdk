...
public class CreateOrderTotalDiscountRequest implements Serializable {
  ...
  @jakarta.annotation.Nullable  private List<@Valid CreateOrderTotalDiscountCriteria> criteria = new ArrayList<>();
  ...
  @Schema(example = "Bulk Order Discount", requiredMode = Schema.RequiredMode.REQUIRED, description = "Name of the discount")
   ...
   * @return description
   */
  @jakarta.annotation.Nullable  @Schema(example = "$50 off orders over $500", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Description of the discount")
  ...
  public CreateOrderTotalDiscountRequest criteria(@jakarta.annotation.Nullable List<@Valid CreateOrderTotalDiscountCriteria> criteria) {
    this.criteria = criteria;
    return this;
  }

  public CreateOrderTotalDiscountRequest addCriteriaItem(CreateOrderTotalDiscountCriteria criteriaItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<@Valid CreateOrderTotalDiscountCriteria> getCriteria() {
    return criteria;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CRITERIA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCriteria(@jakarta.annotation.Nullable List<@Valid CreateOrderTotalDiscountCriteria> criteria) {
    this.criteria = criteria;
  }
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(example = "AMOUNT", requiredMode = Schema.RequiredMode.REQUIRED, description = "Type of discount: AMOUNT (fixed amount) or PERCENT (percentage)")
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(example = "50", requiredMode = Schema.RequiredMode.REQUIRED, description = "Value of the discount (amount or percentage depending on discount_type)")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "GROSS", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Strategy for applying discount: GROSS (before tax) or NET (after tax)")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createOrderTotalDiscountRequest.name) &&
        ...
        Objects.equals(this.applyToCommissions, createOrderTotalDiscountRequest.applyToCommissions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, criteria, applyToCommissions, discountType, discountValue, discountStrategy);
  }
    ...
    public static class Builder {
        ...
        public CreateOrderTotalDiscountRequest.Builder name(String name) {
          ...
          return this;
            ...
            public CreateOrderTotalDiscountRequest.Builder criteria(List<CreateOrderTotalDiscountCriteria> criteria) {
