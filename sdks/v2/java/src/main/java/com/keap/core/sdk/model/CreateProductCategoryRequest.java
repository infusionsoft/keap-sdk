 ...
 * productCategory
 */
@Schema(description = "productCategory")
@JsonPropertyOrder({
...
public class CreateProductCategoryRequest implements Serializable {
  ...
  @Schema(example = "Electronics", requiredMode = Schema.RequiredMode.REQUIRED, description = "The category name")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createProductCategoryRequest.name) &&
        Objects.equals(this.displayOrderIndex, createProductCategoryRequest.displayOrderIndex) &&
        Objects.equals(this.parentCategoryId, createProductCategoryRequest.parentCategoryId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayOrderIndex, parentCategoryId);
  }
