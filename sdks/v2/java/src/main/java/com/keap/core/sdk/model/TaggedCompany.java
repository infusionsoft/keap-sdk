...
public class TaggedCompany implements Serializable {
   ...
   * @return appliedTime
   */
  @jakarta.annotation.Nullable  @Schema(example = "2023-10-01T12:00:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The time the tag was applied to the company, in ISO 8601 format.")
