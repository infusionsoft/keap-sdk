...
public class RestCreateOrderRequest implements Serializable {
  ...
  public RestCreateOrderRequest orderTime(@jakarta.annotation.Nullable String orderTime) {
   ...
   * @return orderTime
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The date and time of the order. In ISO-8601 format (e.g. 2024-05-21T23:00:00Z)")
  ...
  public RestCreateOrderRequest orderType(@jakarta.annotation.Nullable OrderTypeEnum orderType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contactId, restCreateOrderRequest.contactId) &&
        ...
        Objects.equals(this.notes, restCreateOrderRequest.notes) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contactId, leadAffiliateId, notes, orderItems, orderTime, orderTitle, orderType, promoCodes, salesAffiliateId, shippingAddress, terms);
  }
