...
public class RestCreateOrderRequest implements Serializable {
  ...
  @jakarta.annotation.Nonnull  private List<@Valid CreateOrderItemRequest> orderItems = new ArrayList<>();
  ...
  public RestCreateOrderRequest orderItems(@jakarta.annotation.Nonnull List<@Valid CreateOrderItemRequest> orderItems) {
  ...
  @JsonProperty(JSON_PROPERTY_ORDER_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOrderItems(@jakarta.annotation.Nonnull List<@Valid CreateOrderItemRequest> orderItems) {
    this.orderItems = orderItems;
  }
