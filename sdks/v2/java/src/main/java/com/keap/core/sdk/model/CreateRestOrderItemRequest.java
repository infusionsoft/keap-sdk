...
@JsonPropertyOrder({
  ...
  CreateRestOrderItemRequest.JSON_PROPERTY_ITEM_TYPE,
...
public class CreateRestOrderItemRequest implements Serializable {
  ...
  public CreateRestOrderItemRequest itemType(@jakarta.annotation.Nullable ItemTypeEnum itemType) {
   ...
   * @return itemType
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The type of this line item. For now only [PRODUCT] is supported. Will default to [PRODUCT] if omitted.")
   ...
   * @return price
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Overridable price of the product. Must be greater than or equal to 0. If not specified, the product price will be used.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, createRestOrderItemRequest.description) &&
        Objects.equals(this.itemType, createRestOrderItemRequest.itemType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, itemType, price, productId, quantity);
  }
    ...
    public static class Builder {
        ...
        public CreateRestOrderItemRequest.Builder description(String description) {
          ...
          return this;
            ...
            public CreateRestOrderItemRequest.Builder itemType(ItemTypeEnum itemType) {
