...
public class OrderTotalDiscount implements Serializable {
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "103", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Unique identifier for this order total discount")
   ...
   * @return name
   */
  @jakarta.annotation.Nullable  @Schema(example = "Bulk Order Discount", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Name of the discount")
   ...
   * @return discountType
   */
  @jakarta.annotation.Nullable  @Schema(example = "AMOUNT", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Type of discount: AMOUNT (fixed amount) or PERCENT (percentage)")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "50", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Value of the discount (amount or percentage depending on discount_type)")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, orderTotalDiscount.id) &&
        ...
        Objects.equals(this.applyToCommissions, orderTotalDiscount.applyToCommissions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, criteria, applyToCommissions, discountType, discountValue, discountStrategy);
  }
