...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class StagesApi {
   ...
   */
  public Long countDealsInStage(String id) throws ApiException {
    ApiResponse<Long> localVarResponse = countDealsInStageWithHttpInfo(id);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Long> countDealsInStageWithHttpInfo(String id) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = countDealsInStageRequestBuilder(id);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("countDealsInStage", localVarResponse);
        }
  ...
  private HttpRequest.Builder countDealsInStageRequestBuilder(String id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling countDealsInStage");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/stages/{id}/dealCount"
   ...
   * @throws ApiException if fails to make API call
   */
  public StageDealListResponse listStageDeals(String id, String filter, String pageToken, String orderBy, Integer pageSize) throws ApiException {
    ApiResponse<StageDealListResponse> localVarResponse = listStageDealsWithHttpInfo(id, filter, pageToken, orderBy, pageSize);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<StageDealListResponse> listStageDealsWithHttpInfo(String id, String filter, String pageToken, String orderBy, Integer pageSize) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = listStageDealsRequestBuilder(id, filter, pageToken, orderBy, pageSize);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("listStageDeals", localVarResponse);
        }
  ...
  private HttpRequest.Builder listStageDealsRequestBuilder(String id, String filter, String pageToken, String orderBy, Integer pageSize) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling listStageDeals");
    }
