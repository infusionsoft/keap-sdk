...
public class OpportunityContact implements Serializable {
  ...
  @Schema(example = "1001", requiredMode = Schema.RequiredMode.REQUIRED, description = "Contact ID")
   ...
   * @return lastName
   */
  @jakarta.annotation.Nullable  @Schema(example = "Smith", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Last name")
   ...
   * @return jobTitle
   */
  @jakarta.annotation.Nullable  @Schema(example = "Sales Manager", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Job title")
