...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class AutomationCategoryApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public AutomationCategory patchCategoryUsingPATCH(String id, PatchAutomationCategoryRequest patchAutomationCategoryRequest) throws ApiException {
    ApiResponse<AutomationCategory> localVarResponse = patchCategoryUsingPATCHWithHttpInfo(id, patchAutomationCategoryRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<AutomationCategory> patchCategoryUsingPATCHWithHttpInfo(String id, PatchAutomationCategoryRequest patchAutomationCategoryRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = patchCategoryUsingPATCHRequestBuilder(id, patchAutomationCategoryRequest);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("patchCategoryUsingPATCH", localVarResponse);
        }
        return new ApiResponse<AutomationCategory>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder patchCategoryUsingPATCHRequestBuilder(String id, PatchAutomationCategoryRequest patchAutomationCategoryRequest) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling patchCategoryUsingPATCH");
    }
    // verify the required parameter 'patchAutomationCategoryRequest' is set
    if (patchAutomationCategoryRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'patchAutomationCategoryRequest' when calling patchCategoryUsingPATCH");
    }
