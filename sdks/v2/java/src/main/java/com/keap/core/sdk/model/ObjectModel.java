...
public class ObjectModel implements Serializable {
  ...
  @jakarta.annotation.Nullable  private Set<String> optionalProperties = new LinkedHashSet<>();
  ...
  public ObjectModel optionalProperties(@jakarta.annotation.Nullable Set<String> optionalProperties) {
  ...
  public ObjectModel addOptionalPropertiesItem(String optionalPropertiesItem) {
    if (this.optionalProperties == null) {
      this.optionalProperties = new LinkedHashSet<>();
    }
  ...
  @JsonProperty(JSON_PROPERTY_OPTIONAL_PROPERTIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOptionalProperties(@jakarta.annotation.Nullable Set<String> optionalProperties) {
    this.optionalProperties = optionalProperties;
  }
  ...
  private String toIndentedString(Object o) {
    ...
    public static class Builder {
        ...
        public ObjectModel.Builder customFields(List<CustomFieldMetaData> customFields) {
              this.instance.customFields = customFields;
          return this;
        }
            public ObjectModel.Builder optionalProperties(Set<String> optionalProperties) {
