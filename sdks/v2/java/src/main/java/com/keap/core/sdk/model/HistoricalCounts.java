...
public class HistoricalCounts implements Serializable {
   ...
   * @return _24hours
   */
  @jakarta.annotation.Nullable  @Schema(example = "50", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Number of contacts in the last 24 hours")
   ...
   * @return _30days
   */
  @jakarta.annotation.Nullable  @Schema(example = "1200", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Number of contacts in the last 30 days")
