...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class TaskApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ListTasksResponse listTasks(String endDueTime, String filter, String orderBy, Integer pageSize, String pageToken, String startDueTime) throws ApiException {
    ApiResponse<ListTasksResponse> localVarResponse = listTasksWithHttpInfo(endDueTime, filter, orderBy, pageSize, pageToken, startDueTime);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ListTasksResponse> listTasksWithHttpInfo(String endDueTime, String filter, String orderBy, Integer pageSize, String pageToken, String startDueTime) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = listTasksRequestBuilder(endDueTime, filter, orderBy, pageSize, pageToken, startDueTime);
  ...
  private HttpRequest.Builder listTasksRequestBuilder(String endDueTime, String filter, String orderBy, Integer pageSize, String pageToken, String startDueTime) throws ApiException {
