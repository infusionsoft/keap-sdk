...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class TaskApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public UpdateTaskResponse updateTaskUsingPATCH(String taskId, List<String> updateMask, CreateUpdateTaskRequest createUpdateTaskRequest) throws ApiException {
    ApiResponse<UpdateTaskResponse> localVarResponse = updateTaskUsingPATCHWithHttpInfo(taskId, updateMask, createUpdateTaskRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UpdateTaskResponse> updateTaskUsingPATCHWithHttpInfo(String taskId, List<String> updateMask, CreateUpdateTaskRequest createUpdateTaskRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = updateTaskUsingPATCHRequestBuilder(taskId, updateMask, createUpdateTaskRequest);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("updateTaskUsingPATCH", localVarResponse);
        }
  ...
  private HttpRequest.Builder updateTaskUsingPATCHRequestBuilder(String taskId, List<String> updateMask, CreateUpdateTaskRequest createUpdateTaskRequest) throws ApiException {
    // verify the required parameter 'taskId' is set
    if (taskId == null) {
      throw new ApiException(400, "Missing the required parameter 'taskId' when calling updateTaskUsingPATCH");
    }
