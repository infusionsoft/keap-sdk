...
public class ListLeadSourcesResponse implements Serializable {
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The lead sources in the current page")
  ...
  private String toIndentedString(Object o) {
    ...
    public static class Builder {
        ...
        public ListLeadSourcesResponse.Builder leadSources(List<LeadSource> leadSources) {
