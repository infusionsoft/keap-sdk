...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class EmailApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public void sendEmailTemplateUsingPOST(EmailSendTemplateRequest emailSendTemplateRequest) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> sendEmailTemplateUsingPOSTWithHttpInfo(EmailSendTemplateRequest emailSendTemplateRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = sendEmailTemplateUsingPOSTRequestBuilder(emailSendTemplateRequest);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("sendEmailTemplateUsingPOST", localVarResponse);
        }
        return new ApiResponse<Void>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder sendEmailTemplateUsingPOSTRequestBuilder(EmailSendTemplateRequest emailSendTemplateRequest) throws ApiException {
