 ...
 */
@JsonPropertyOrder({
  Order.JSON_PROPERTY_ALLOW_PAYMENT,
  Order.JSON_PROPERTY_ALLOW_PAYPAL,
  Order.JSON_PROPERTY_CONTACT,
  Order.JSON_PROPERTY_CREATION_TIME,
  Order.JSON_PROPERTY_FILES,
  Order.JSON_PROPERTY_ID,
  Order.JSON_PROPERTY_INVOICE_NUMBER,
  Order.JSON_PROPERTY_LEAD_AFFILIATE_ID,
  Order.JSON_PROPERTY_MODIFICATION_TIME,
  Order.JSON_PROPERTY_NOTES,
  Order.JSON_PROPERTY_ORDER_ITEMS,
  Order.JSON_PROPERTY_ORDER_TIME,
  Order.JSON_PROPERTY_ORDER_TYPE,
  Order.JSON_PROPERTY_PAYMENT_PLAN,
  Order.JSON_PROPERTY_REFUND_TOTAL,
  Order.JSON_PROPERTY_SALES_AFFILIATE_ID,
  Order.JSON_PROPERTY_SHIPPING_INFORMATION,
  Order.JSON_PROPERTY_SOURCE_TYPE,
  Order.JSON_PROPERTY_STATUS,
  Order.JSON_PROPERTY_TERMS,
  Order.JSON_PROPERTY_TITLE,
  Order.JSON_PROPERTY_TOTAL,
  Order.JSON_PROPERTY_TOTAL_DUE,
  Order.JSON_PROPERTY_TOTAL_PAID
})
...
public class Order implements Serializable {
  ...
  public Order allowPayment(@jakarta.annotation.Nullable Boolean allowPayment) {
  ...
  public Order allowPaypal(@jakarta.annotation.Nullable Boolean allowPaypal) {
  ...
  public Order contact(@jakarta.annotation.Nullable BasicContact contact) {
  ...
  public Order creationTime(@jakarta.annotation.Nullable String creationTime) {
  ...
  public Order files(@jakarta.annotation.Nullable List<@Valid InvoiceFile> files) {
    this.files = files;
    return this;
  }

  public Order addFilesItem(InvoiceFile filesItem) {
    if (this.files == null) {
  ...
  public Order id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Order invoiceNumber(@jakarta.annotation.Nullable String invoiceNumber) {
  ...
  public Order leadAffiliateId(@jakarta.annotation.Nullable String leadAffiliateId) {
  ...
  public Order modificationTime(@jakarta.annotation.Nullable String modificationTime) {
  ...
  public Order notes(@jakarta.annotation.Nullable String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public Order orderItems(@jakarta.annotation.Nullable List<@Valid OrderItem> orderItems) {
  ...
  public Order orderTime(@jakarta.annotation.Nullable String orderTime) {
  ...
  public Order orderType(@jakarta.annotation.Nullable OrderTypeEnum orderType) {
  ...
  public Order paymentPlan(@jakarta.annotation.Nullable PaymentPlan paymentPlan) {
  ...
  public Order refundTotal(@jakarta.annotation.Nullable CurrencyValue refundTotal) {
  ...
  public Order salesAffiliateId(@jakarta.annotation.Nullable String salesAffiliateId) {
  ...
  public Order shippingInformation(@jakarta.annotation.Nullable ShippingInformation shippingInformation) {
  ...
  public Order sourceType(@jakarta.annotation.Nullable SourceTypeEnum sourceType) {
  ...
  public Order terms(@jakarta.annotation.Nullable String terms) {
    this.terms = terms;
    return this;
  }
  ...
  public Order title(@jakarta.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public Order total(@jakarta.annotation.Nullable CurrencyValue total) {
    this.total = total;
    return this;
  }
  ...
  public Order totalDue(@jakarta.annotation.Nullable CurrencyValue totalDue) {
  ...
  public Order totalPaid(@jakarta.annotation.Nullable CurrencyValue totalPaid) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowPayment, order.allowPayment) &&
        ...
        Objects.equals(this.creationTime, order.creationTime) &&
        Objects.equals(this.files, order.files) &&
        Objects.equals(this.id, order.id) &&
        Objects.equals(this.invoiceNumber, order.invoiceNumber) &&
        Objects.equals(this.leadAffiliateId, order.leadAffiliateId) &&
        Objects.equals(this.modificationTime, order.modificationTime) &&
        ...
        Objects.equals(this.sourceType, order.sourceType) &&
  ...
  private String toIndentedString(Object o) {
    ...
    public static class Builder {
        ...
        public Order.Builder allowPayment(Boolean allowPayment) {
              this.instance.allowPayment = allowPayment;
          return this;
        }
            public Order.Builder allowPaypal(Boolean allowPaypal) {
              this.instance.allowPaypal = allowPaypal;
          return this;
        }
            public Order.Builder contact(BasicContact contact) {
              this.instance.contact = contact;
          return this;
        }
            public Order.Builder creationTime(String creationTime) {
              this.instance.creationTime = creationTime;
          return this;
        }
            public Order.Builder files(List<InvoiceFile> files) {
          ...
          return this;
            ...
            public Order.Builder invoiceNumber(String invoiceNumber) {
              this.instance.invoiceNumber = invoiceNumber;
          return this;
        }
            public Order.Builder leadAffiliateId(String leadAffiliateId) {
              this.instance.leadAffiliateId = leadAffiliateId;
          return this;
        }
            public Order.Builder modificationTime(String modificationTime) {
              this.instance.modificationTime = modificationTime;
          return this;
        }
            public Order.Builder notes(String notes) {
              this.instance.notes = notes;
          return this;
        }
            public Order.Builder orderItems(List<OrderItem> orderItems) {
              this.instance.orderItems = orderItems;
          return this;
        }
            public Order.Builder orderTime(String orderTime) {
              this.instance.orderTime = orderTime;
          return this;
        }
            public Order.Builder orderType(OrderTypeEnum orderType) {
              this.instance.orderType = orderType;
          return this;
        }
            public Order.Builder paymentPlan(PaymentPlan paymentPlan) {
              this.instance.paymentPlan = paymentPlan;
          return this;
        }
            public Order.Builder refundTotal(CurrencyValue refundTotal) {
              this.instance.refundTotal = refundTotal;
          return this;
        }
            public Order.Builder salesAffiliateId(String salesAffiliateId) {
              this.instance.salesAffiliateId = salesAffiliateId;
          return this;
        }
            public Order.Builder shippingInformation(ShippingInformation shippingInformation) {
              this.instance.shippingInformation = shippingInformation;
          return this;
        }
            public Order.Builder sourceType(SourceTypeEnum sourceType) {
          ...
          return this;
            ...
            public Order.Builder terms(String terms) {
              this.instance.terms = terms;
          return this;
        }
            public Order.Builder title(String title) {
              this.instance.title = title;
          return this;
        }
            public Order.Builder total(CurrencyValue total) {
              this.instance.total = total;
          return this;
        }
            public Order.Builder totalDue(CurrencyValue totalDue) {
              this.instance.totalDue = totalDue;
          return this;
        }
            public Order.Builder totalPaid(CurrencyValue totalPaid) {
