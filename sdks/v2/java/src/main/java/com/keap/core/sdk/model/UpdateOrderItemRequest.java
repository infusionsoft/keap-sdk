...
@JsonPropertyOrder({
  ...
  UpdateOrderItemRequest.JSON_PROPERTY_ITEM_TYPE,
...
public class UpdateOrderItemRequest implements Serializable {
   ...
   * @return costPerUnit
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The cost per unit. Must be greater than or equal to 0.")
  ...
  public UpdateOrderItemRequest itemType(@jakarta.annotation.Nullable ItemTypeEnum itemType) {
   ...
   * @return name
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of the order item. Must not be whitespace.")
   ...
   * @return pricePerUnit
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The price per unit. Must be greater than or equal to 0.")
   ...
   * @return quantity
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The quantity. Must be greater than or equal to 1.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.costPerUnit, updateOrderItemRequest.costPerUnit) &&
        Objects.equals(this.description, updateOrderItemRequest.description) &&
        Objects.equals(this.itemType, updateOrderItemRequest.itemType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(costPerUnit, description, itemType, name, notes, pricePerUnit, quantity);
  }
    ...
    public static class Builder {
        ...
        public UpdateOrderItemRequest.Builder costPerUnit(Double costPerUnit) {
          ...
          return this;
            ...
            public UpdateOrderItemRequest.Builder itemType(ItemTypeEnum itemType) {
