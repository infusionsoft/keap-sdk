...
public class User implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, admin, companyName, createTime, createdBy, emailAddresses, familyName, faxNumbers, givenName, globalUserId, id, keapId, partner, phoneNumbers, socialAccounts, status, title, updateTime, updatedBy, website);
  }
