...
public class LeadSourceRecurringExpense implements Serializable {
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The ID of the lead source recurring expense")
   ...
   * @return leadSourceId
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The ID of the lead source the recurring expense belongs to")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, createTime, endTime, id, leadSourceId, nextExpenseTime, notes, startTime, title, updateTime);
  }
