...
public class CreateProductDiscountRequest implements Serializable {
  ...
  @jakarta.annotation.Nullable  private List<@Valid CreateProductDiscountCriteria> criteria = new ArrayList<>();
  ...
  public CreateProductDiscountRequest name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  @Schema(example = "Summer Sale 20% Off", requiredMode = Schema.RequiredMode.REQUIRED, description = "Name of the discount")
  ...
  public CreateProductDiscountRequest criteria(@jakarta.annotation.Nullable List<@Valid CreateProductDiscountCriteria> criteria) {
    this.criteria = criteria;
    return this;
  }

  public CreateProductDiscountRequest addCriteriaItem(CreateProductDiscountCriteria criteriaItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<@Valid CreateProductDiscountCriteria> getCriteria() {
    return criteria;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CRITERIA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCriteria(@jakarta.annotation.Nullable List<@Valid CreateProductDiscountCriteria> criteria) {
    this.criteria = criteria;
  }
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(example = "456", requiredMode = Schema.RequiredMode.REQUIRED, description = "ID of the product this discount applies to")
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(example = "PERCENT", requiredMode = Schema.RequiredMode.REQUIRED, description = "Type of discount: AMOUNT (fixed amount) or PERCENT (percentage)")
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(example = "20", requiredMode = Schema.RequiredMode.REQUIRED, description = "Value of the discount (amount or percentage depending on discount_type)")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createProductDiscountRequest.name) &&
        ...
        Objects.equals(this.applyToCommissions, createProductDiscountRequest.applyToCommissions) &&
    ...
    public static class Builder {
        ...
        public CreateProductDiscountRequest.Builder name(String name) {
          ...
          return this;
            ...
            public CreateProductDiscountRequest.Builder criteria(List<CreateProductDiscountCriteria> criteria) {
