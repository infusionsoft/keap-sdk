 ...
 * businessProfile
 */
@Schema(description = "businessProfile")
@JsonPropertyOrder({
...
public class UpdateBusinessProfileRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateBusinessProfileRequest.name) &&
        ...
        Objects.equals(this.address, updateBusinessProfileRequest.address) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, email, website, phone, address, currencyCode, businessGoals, businessPrimaryColor, businessSecondaryColor);
  }
