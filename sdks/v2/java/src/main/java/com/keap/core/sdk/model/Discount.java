...
public class Discount implements Serializable {
  ...
  @jakarta.annotation.Nullable  private String specialItemId;
  ...
  @jakarta.annotation.Nullable  private DiscountMethodEnum discountMethod;

  public Discount() { 
  }

  public Discount amount(@jakarta.annotation.Nullable Double amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @return amount
   */
  @jakarta.annotation.Nullable  @Schema(example = "10", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Discount amount")
  ...
  public Discount specialItemId(@jakarta.annotation.Nullable String specialItemId) {
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "123", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Discount item ID")
  ...
  @JsonProperty(JSON_PROPERTY_SPECIAL_ITEM_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSpecialItemId(@jakarta.annotation.Nullable String specialItemId) {
    this.specialItemId = specialItemId;
  }


  public Discount discountMethod(@jakarta.annotation.Nullable DiscountMethodEnum discountMethod) {
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "PERCENT", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Discount method")
  ...
  @JsonProperty(JSON_PROPERTY_DISCOUNT_METHOD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDiscountMethod(@jakarta.annotation.Nullable DiscountMethodEnum discountMethod) {
    this.discountMethod = discountMethod;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, specialItemId, discountMethod);
  }
