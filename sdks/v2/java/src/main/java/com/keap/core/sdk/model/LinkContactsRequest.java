...
public class LinkContactsRequest implements Serializable {
   ...
   * @return contact1Id
   */
  @jakarta.annotation.Nullable  @Schema(example = "1001", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "First contact ID to link")
   ...
   * @return contact2Id
   */
  @jakarta.annotation.Nullable  @Schema(example = "1002", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Second contact ID to link")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contact1Id, linkTypeId, contact2Id);
  }
