...
public class ReportExecutionResult implements Serializable {
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The list of report result records")
   ...
   * @return pageToken
   */
  @jakarta.annotation.Nullable  @Schema(example = "eyJsYXN0Um93IjoxMDB9", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Token for retrieving the next page of results")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.results, reportExecutionResult.results) &&
        Objects.equals(this.pageToken, reportExecutionResult.pageToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(results, pageToken);
  }
  ...
  private String toIndentedString(Object o) {
    ...
    public static class Builder {
        ...
        public ReportExecutionResult.Builder results(List<ReportEntryRecord> results) {
