...
public class ReportEntryValue implements Serializable {
   ...
   * @return fieldName
   */
  @jakarta.annotation.Nullable  @Schema(example = "contact_email", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of the field/column")
   ...
   * @return value
   */
  @jakarta.annotation.Nullable  @Schema(example = "john.smith@example.com", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The value of the field")
