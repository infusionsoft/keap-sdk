...
public class SubscriptionPlan implements Serializable {
   ...
   * @return active
   */
  @jakarta.annotation.Nullable  @Schema(example = "true", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "If the subscription plan is active or not.")
   ...
   * @return cycleType
   */
  @jakarta.annotation.Nullable  @Schema(example = "MONTHLY", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The cycle type of the subscription plan.")
   ...
   * @return totalCycles
   */
  @jakarta.annotation.Nullable  @Schema(example = "12", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Total number of cycles the plan will run before ending. Value of 0 indicates plan will never end.")
