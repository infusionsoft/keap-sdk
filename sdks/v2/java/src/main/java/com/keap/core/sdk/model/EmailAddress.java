...
public class EmailAddress implements Serializable {
   ...
   * @return field
   */
  @jakarta.annotation.Nullable  @Schema(example = "EMAIL1", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Email address slot")
   ...
   * @return optInReason
   */
  @jakarta.annotation.Nullable  @Schema(example = "Subscribed via website form", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Reason for opting in")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, field, optInReason, isOptIn, emailOptStatus);
  }
