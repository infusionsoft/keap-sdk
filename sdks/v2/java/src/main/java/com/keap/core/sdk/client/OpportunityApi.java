...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class OpportunityApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public RestV2Opportunity updateOpportunityUsingPATCH(String opportunityId, UpdateOpportunityRequestV2 updateOpportunityRequestV2, List<String> updateMask) throws ApiException {
    ApiResponse<RestV2Opportunity> localVarResponse = updateOpportunityUsingPATCHWithHttpInfo(opportunityId, updateOpportunityRequestV2, updateMask);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RestV2Opportunity> updateOpportunityUsingPATCHWithHttpInfo(String opportunityId, UpdateOpportunityRequestV2 updateOpportunityRequestV2, List<String> updateMask) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = updateOpportunityUsingPATCHRequestBuilder(opportunityId, updateOpportunityRequestV2, updateMask);
  ...
  private HttpRequest.Builder updateOpportunityUsingPATCHRequestBuilder(String opportunityId, UpdateOpportunityRequestV2 updateOpportunityRequestV2, List<String> updateMask) throws ApiException {
    // verify the required parameter 'opportunityId' is set
    if (opportunityId == null) {
    ...
    if (updateOpportunityRequestV2 == null) {
      throw new ApiException(400, "Missing the required parameter 'updateOpportunityRequestV2' when calling updateOpportunityUsingPATCH");
    }
