...
@JsonPropertyOrder({
  ...
  CreateProductRequest.JSON_PROPERTY_INVENTORY,
  CreateProductRequest.JSON_PROPERTY_NAME,
  CreateProductRequest.JSON_PROPERTY_PRICE,
  CreateProductRequest.JSON_PROPERTY_SHIPPABLE,
...
public class CreateProductRequest implements Serializable {
  ...
  public CreateProductRequest inventory(@jakarta.annotation.Nullable ProductInventory inventory) {
  ...
  public CreateProductRequest name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "Product name")
  ...
  public CreateProductRequest price(@jakarta.annotation.Nonnull Long price) {
    this.price = price;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "The product price. The value is in the currency’s smallest unit. e.g. $12.50 is 1250. Must be greater than or equal to 0.")
  ...
  public CreateProductRequest shippable(@jakarta.annotation.Nullable Boolean shippable) {
  ...
  public CreateProductRequest shortDescription(@jakarta.annotation.Nonnull String shortDescription) {
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "Product short description")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, createProductRequest.active) &&
        ...
        Objects.equals(this.inventory, createProductRequest.inventory) &&
        Objects.equals(this.name, createProductRequest.name) &&
        Objects.equals(this.price, createProductRequest.price) &&
        Objects.equals(this.shippable, createProductRequest.shippable) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, cityTaxable, countryTaxable, description, inventory, name, price, shippable, shortDescription, sku, stateTaxable, storefrontHidden, subscriptionOnly, taxable, weight);
  }
    ...
    public static class Builder {
        ...
        public CreateProductRequest.Builder active(Boolean active) {
          ...
          return this;
            ...
            public CreateProductRequest.Builder inventory(ProductInventory inventory) {
          ...
          return this;
            ...
            public CreateProductRequest.Builder shippable(Boolean shippable) {
