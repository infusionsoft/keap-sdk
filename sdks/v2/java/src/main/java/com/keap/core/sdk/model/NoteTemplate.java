...
public class NoteTemplate implements Serializable {
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "5001", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Template ID")
   ...
   * @return title
   */
  @jakarta.annotation.Nullable  @Schema(example = "Post-Sale Follow-up", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Template title")
   ...
   * @return description
   */
  @jakarta.annotation.Nullable  @Schema(example = "Follow up within 24 hours of purchase", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Template description")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "100", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Default assigned user ID")
   ...
   * @return notifyUsers
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "List of user IDs to notify")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, title, description, actionType, assignmentUserId, notifyUsers);
  }
