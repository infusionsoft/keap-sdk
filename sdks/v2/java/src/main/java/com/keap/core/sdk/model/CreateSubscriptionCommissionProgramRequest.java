...
@JsonPropertyOrder({
  ...
  CreateSubscriptionCommissionProgramRequest.JSON_PROPERTY_UNUSED,
  CreateSubscriptionCommissionProgramRequest.JSON_PROPERTY_DOLLAR_AMOUNT,
  CreateSubscriptionCommissionProgramRequest.JSON_PROPERTY_LEVEL1,
  CreateSubscriptionCommissionProgramRequest.JSON_PROPERTY_LEVEL2,
  CreateSubscriptionCommissionProgramRequest.JSON_PROPERTY_PAYOUT_TYPE,
...
public class CreateSubscriptionCommissionProgramRequest implements Serializable {
  ...
  public CreateSubscriptionCommissionProgramRequest unused(@jakarta.annotation.Nullable CommissionItemRequest unused) {
    this.unused = unused;
    return this;
  }
  ...
  public CreateSubscriptionCommissionProgramRequest level1(@jakarta.annotation.Nullable CommissionItemRequest level1) {
    this.level1 = level1;
    return this;
  }
  ...
  public CreateSubscriptionCommissionProgramRequest level2(@jakarta.annotation.Nullable CommissionItemRequest level2) {
    this.level2 = level2;
    return this;
  }
  ...
  public CreateSubscriptionCommissionProgramRequest payoutType(@jakarta.annotation.Nullable PayoutTypeEnum payoutType) {
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "456", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Subscription ID to assign commission")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.percentage, createSubscriptionCommissionProgramRequest.percentage) &&
        Objects.equals(this.unused, createSubscriptionCommissionProgramRequest.unused) &&
        Objects.equals(this.dollarAmount, createSubscriptionCommissionProgramRequest.dollarAmount) &&
        Objects.equals(this.level1, createSubscriptionCommissionProgramRequest.level1) &&
        Objects.equals(this.level2, createSubscriptionCommissionProgramRequest.level2) &&
        Objects.equals(this.payoutType, createSubscriptionCommissionProgramRequest.payoutType) &&
        Objects.equals(this.subscriptionId, createSubscriptionCommissionProgramRequest.subscriptionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(percentage, unused, dollarAmount, level1, level2, payoutType, subscriptionId);
  }
    ...
    public static class Builder {
        ...
        public CreateSubscriptionCommissionProgramRequest.Builder percentage(String percentage) {
          ...
          return this;
            ...
            public CreateSubscriptionCommissionProgramRequest.Builder unused(CommissionItemRequest unused) {
          ...
          return this;
            ...
            public CreateSubscriptionCommissionProgramRequest.Builder level1(CommissionItemRequest level1) {
              this.instance.level1 = level1;
          return this;
        }
            public CreateSubscriptionCommissionProgramRequest.Builder level2(CommissionItemRequest level2) {
              this.instance.level2 = level2;
          return this;
        }
            public CreateSubscriptionCommissionProgramRequest.Builder payoutType(PayoutTypeEnum payoutType) {
