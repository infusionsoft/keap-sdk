...
public class Webform implements Serializable {
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "42", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The unique identifier for this webform")
   ...
   * @return xid
   */
  @jakarta.annotation.Nullable  @Schema(example = "a1b2c3d4e5", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The public unique identifier for this webform, used in webform URLs")
   ...
   * @return name
   */
  @jakarta.annotation.Nullable  @Schema(example = "Newsletter Signup Form", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of this webform")
   ...
   * @return funnelId
   */
  @jakarta.annotation.Nullable  @Schema(example = "15", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The id of the funnel this webform belongs to, if any")
   ...
   * @return customSlug
   */
  @jakarta.annotation.Nullable  @Schema(example = "newsletter-signup", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The custom slug of the webform. Used in pretty webform URLs")
   ...
   * @return webformUrl
   */
  @jakarta.annotation.Nullable  @Schema(example = "https://thryv.com/app/form/a1b2c3d4e5", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The URL for this webform that uses the xid to identify it")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "https://thryv.com/app/form/newsletter-signup", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The URL for this webform that uses the custom slug to identify it")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "https://thryv.com/thank-you", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The URL of the thank you page for this webform")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "EMAIL", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The option that determines if the lead submitted through the form is a duplicate or not. If it's a duplicate, then the lead will be merged with the existing contact record")
   ...
   * @return exitOption
   */
  @jakarta.annotation.Nullable  @Schema(example = "REDIRECT", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The option that determines what happens after the form is submitted")
   ...
   * @return webformType
   */
  @jakarta.annotation.Nullable  @Schema(example = "STANDALONE", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The type of webform this is")
  ...
  public Webform createTime(@jakarta.annotation.Nullable ZonedDateTime createTime) {
  ...
  @Schema(example = "2024-01-15T10:30:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "When the webform was created")
  ...
  public Webform updateTime(@jakarta.annotation.Nullable ZonedDateTime updateTime) {
   ...
   */
  @jakarta.annotation.Nullable  @Valid
  @Schema(example = "2024-06-20T14:45:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "When the webform was last updated")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webform.id) &&
        ...
        Objects.equals(this.createTime, webform.createTime) &&
        Objects.equals(this.updateTime, webform.updateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, xid, name, funnelId, customSlug, webformUrl, prettyWebformUrl, thankYouPageUrl, duplicateCheckOption, exitOption, webformType, createTime, updateTime);
  }
    ...
    public static class Builder {
        ...
        public Webform.Builder id(String id) {
          ...
          return this;
            ...
            public Webform.Builder createTime(ZonedDateTime createTime) {
              this.instance.createTime = createTime;
          return this;
        }
            public Webform.Builder updateTime(ZonedDateTime updateTime) {
