...
public class ListLeadSourceCategoriesResponse implements Serializable {
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The lead source categories in the current page")
  ...
  private String toIndentedString(Object o) {
    ...
    public static class Builder {
        ...
        public ListLeadSourceCategoriesResponse.Builder leadSourceCategories(List<LeadSourceCategory> leadSourceCategories) {
