 ...
 */
@Schema(description = "Response containing created emails and any errors")
@JsonPropertyOrder({
...
public class EmailsSentList implements Serializable {
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Successfully created email records")
   ...
   */
  @jakarta.annotation.Nullable  @Valid
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Errors that occurred during creation")
  ...
  private String toIndentedString(Object o) {
    ...
    public static class Builder {
        ...
        public EmailsSentList.Builder emails(List<EmailSentWithContent> emails) {
              this.instance.emails = emails;
          return this;
        }
            public EmailsSentList.Builder errors(List<EmailSentCreateError> errors) {
