...
public class Link implements Serializable {
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "1", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Link ID")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "2001", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "ID of the linked contact")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, linkedContactId, linkTypeId, linkTypeName);
  }
