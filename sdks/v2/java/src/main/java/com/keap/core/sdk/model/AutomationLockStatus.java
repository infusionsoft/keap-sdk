...
public class AutomationLockStatus implements Serializable {
   ...
   * @return locked
   */
  @jakarta.annotation.Nullable  @Schema(example = "true", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Whether the automation is currently locked")
   ...
   * @return userId
   */
  @jakarta.annotation.Nullable  @Schema(example = "123", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The ID of the user who has the lock")
   ...
   * @return userName
   */
  @jakarta.annotation.Nullable  @Schema(example = "john.doe@example.com", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The username of the user who has the lock")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "John", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The first name of the user who has the lock")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(locked, userId, userName, userFirstname);
  }
