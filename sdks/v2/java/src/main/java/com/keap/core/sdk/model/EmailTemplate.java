...
public class EmailTemplate implements Serializable {
   ...
   * @return textBody
   */
  @jakarta.annotation.Nullable  @Schema(example = "Hello ~Contact.FirstName~, welcome!", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The text body of the email")
   ...
   * @return htmlBody
   */
  @jakarta.annotation.Nullable  @Schema(example = "<h1>Welcome ~Contact.FirstName~!</h1>", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The HTML body of the email")
