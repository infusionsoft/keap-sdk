...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class SubscriptionsApi {
   ...
   * @param cancelSubscriptionRequest request (required)
   ...
   * @throws ApiException if fails to make API call
   */
  public Subscription updateSubscription(String subscriptionId, UpdateSubscriptionRequest updateSubscriptionRequest, List<String> updateMask) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Subscription> updateSubscriptionWithHttpInfo(String subscriptionId, UpdateSubscriptionRequest updateSubscriptionRequest, List<String> updateMask) throws ApiException {
  ...
  private HttpRequest.Builder updateSubscriptionRequestBuilder(String subscriptionId, UpdateSubscriptionRequest updateSubscriptionRequest, List<String> updateMask) throws ApiException {
    // verify the required parameter 'subscriptionId' is set
    if (subscriptionId == null) {
