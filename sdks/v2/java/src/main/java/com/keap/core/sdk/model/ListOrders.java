...
public class ListOrders implements Serializable {
  ...
  @jakarta.annotation.Nullable  private List<@Valid OrderV2> orders = new ArrayList<>();
  ...
  public ListOrders orders(@jakarta.annotation.Nullable List<@Valid OrderV2> orders) {
    this.orders = orders;
    return this;
  }

  public ListOrders addOrdersItem(OrderV2 ordersItem) {
    if (this.orders == null) {
  ...
  public List<@Valid OrderV2> getOrders() {
    return orders;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ORDERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOrders(@jakarta.annotation.Nullable List<@Valid OrderV2> orders) {
    this.orders = orders;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orders, listOrders.orders) &&
        Objects.equals(this.nextPageToken, listOrders.nextPageToken);
  }
  ...
  private String toIndentedString(Object o) {
    ...
    public static class Builder {
        ...
        public ListOrders.Builder orders(List<OrderV2> orders) {
