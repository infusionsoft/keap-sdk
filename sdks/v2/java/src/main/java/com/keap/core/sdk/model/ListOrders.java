...
public class ListOrders implements Serializable {
  ...
  @jakarta.annotation.Nullable  private List<@Valid Order> orders = new ArrayList<>();
  ...
  public ListOrders orders(@jakarta.annotation.Nullable List<@Valid Order> orders) {
    this.orders = orders;
    return this;
  }

  public ListOrders addOrdersItem(Order ordersItem) {
    if (this.orders == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ORDERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOrders(@jakarta.annotation.Nullable List<@Valid Order> orders) {
    this.orders = orders;
  }
    ...
    public static class Builder {
        ...
        public ListOrders.Builder nextPageToken(String nextPageToken) {
          ...
          return this;
            ...
            public ListOrders.Builder orders(List<Order> orders) {
