...
public class AddToAutomationSequenceRequest implements Serializable {
  ...
  public AddToAutomationSequenceRequest contactIds(@jakarta.annotation.Nonnull List<String> contactIds) {
  ...
  @Schema(example = "[123, 456, 789]", requiredMode = Schema.RequiredMode.REQUIRED, description = "List of contact IDs to add to the automation sequence")
