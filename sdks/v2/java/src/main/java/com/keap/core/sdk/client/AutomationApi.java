...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")public class AutomationApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public void bulkAssignmentAutomationsCategoriesUsingPOST(AssignAutomationCategoryRequest assignAutomationCategoryRequest) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> bulkAssignmentAutomationsCategoriesUsingPOSTWithHttpInfo(AssignAutomationCategoryRequest assignAutomationCategoryRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = bulkAssignmentAutomationsCategoriesUsingPOSTRequestBuilder(assignAutomationCategoryRequest);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("bulkAssignmentAutomationsCategoriesUsingPOST", localVarResponse);
        }
  ...
  private HttpRequest.Builder bulkAssignmentAutomationsCategoriesUsingPOSTRequestBuilder(AssignAutomationCategoryRequest assignAutomationCategoryRequest) throws ApiException {
    // verify the required parameter 'assignAutomationCategoryRequest' is set
    if (assignAutomationCategoryRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'assignAutomationCategoryRequest' when calling bulkAssignmentAutomationsCategoriesUsingPOST");
    }
