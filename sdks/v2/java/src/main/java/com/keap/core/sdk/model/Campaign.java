...
public class Campaign implements Serializable {
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "123", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The unique identifier of the campaign")
   ...
   * @return name
   */
  @jakarta.annotation.Nullable  @Schema(example = "Summer Sale Campaign", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of the campaign")
   ...
   * @return locked
   */
  @jakarta.annotation.Nullable  @Schema(example = "false", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Whether the campaign is locked for editing")
  ...
  public Campaign dateCreated(@jakarta.annotation.Nullable ZonedDateTime dateCreated) {
  ...
  @Schema(example = "2024-05-21T14:30:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The date and time when the campaign was created. In ISO-8601 format")
   ...
   */
  @jakarta.annotation.Nullable  @Valid
  @Schema(example = "2024-05-21T14:30:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The date and time when the campaign was published. In ISO-8601 format")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "true", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Whether the campaign is published")
   ...
   * @return errorMessage
   */
  @jakarta.annotation.Nullable  @Schema(example = "Invalid sequence configuration", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Error message if the campaign has issues")
   ...
   * @return timeZone
   */
  @jakarta.annotation.Nullable  @Schema(example = "America/New_York", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The timezone of the campaign")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "America/New_York", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The timezone used when the campaign was published")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "user_abc123", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The global ID of the user who created the campaign")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "250", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Number of contacts currently active in this campaign")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "1500", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Number of contacts who have completed this campaign")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, campaign.id) &&
        ...
        Objects.equals(this.activeContactCount, campaign.activeContactCount) &&
        Objects.equals(this.completedContactCount, campaign.completedContactCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, locked, dateCreated, publishedDate, publishedStatus, errorMessage, timeZone, publishedTimeZone, createdByGlobalId, activeContactCount, completedContactCount);
  }
    ...
    public static class Builder {
        ...
        public Campaign.Builder id(String id) {
          ...
          return this;
            ...
            public Campaign.Builder dateCreated(ZonedDateTime dateCreated) {
