...
@JsonPropertyOrder({
  ...
  PaymentMethod.JSON_PROPERTY_STATUS
})
...
public class PaymentMethod implements Serializable {
   ...
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The type of payment method. For now, only CARD is supported.")
  ...
  public PaymentMethod status(@jakarta.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Status of the payment method. Fow now, only EXPIRED is supported.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cardInfo, contactId, createdTime, merchantAccountId, merchantAccountType, paymentMethodId, paymentMethodType, status);
  }
    ...
    public static class Builder {
        ...
        public PaymentMethod.Builder cardInfo(CardInfo cardInfo) {
          ...
          return this;
            ...
            public PaymentMethod.Builder status(StatusEnum status) {
