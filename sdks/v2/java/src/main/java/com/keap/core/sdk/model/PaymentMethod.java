...
@JsonPropertyOrder({
  ...
  PaymentMethod.JSON_PROPERTY_PAYMENT_GATEWAY_ID,
  PaymentMethod.JSON_PROPERTY_PAYMENT_METHOD_ID,
  PaymentMethod.JSON_PROPERTY_PAYMENT_METHOD_TYPE,
  PaymentMethod.JSON_PROPERTY_PAYMENT_PROCESSOR_TYPE
})
...
public class PaymentMethod implements Serializable {
  ...
  public enum PaymentProcessorTypeEnum {
    ...
    PaymentProcessorTypeEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static PaymentProcessorTypeEnum fromValue(String value) {
      for (PaymentProcessorTypeEnum b : PaymentProcessorTypeEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public static final String JSON_PROPERTY_PAYMENT_PROCESSOR_TYPE = "payment_processor_type";
  @jakarta.annotation.Nullable  private PaymentProcessorTypeEnum paymentProcessorType;
  ...
  public PaymentMethod paymentGatewayId(@jakarta.annotation.Nullable String paymentGatewayId) {
  ...
  public PaymentMethod paymentProcessorType(@jakarta.annotation.Nullable PaymentProcessorTypeEnum paymentProcessorType) {
   ...
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "")
  @JsonProperty(JSON_PROPERTY_PAYMENT_PROCESSOR_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public PaymentProcessorTypeEnum getPaymentProcessorType() {
    return paymentProcessorType;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYMENT_PROCESSOR_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPaymentProcessorType(@jakarta.annotation.Nullable PaymentProcessorTypeEnum paymentProcessorType) {
    this.paymentProcessorType = paymentProcessorType;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cardInfo, paymentMethod.cardInfo) &&
        ...
        Objects.equals(this.paymentGatewayId, paymentMethod.paymentGatewayId) &&
        ...
        Objects.equals(this.paymentProcessorType, paymentMethod.paymentProcessorType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cardInfo, contactId, createdTime, paymentGatewayId, paymentMethodId, paymentMethodType, paymentProcessorType);
  }
  ...
  public String toString() {
    ...
    sb.append("    paymentProcessorType: ").append(toIndentedString(paymentProcessorType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
    ...
    public static class Builder {
        ...
        public PaymentMethod.Builder cardInfo(CardInfo cardInfo) {
          ...
          return this;
            ...
            public PaymentMethod.Builder paymentGatewayId(String paymentGatewayId) {
          ...
          return this;
            ...
            public PaymentMethod.Builder paymentProcessorType(PaymentProcessorTypeEnum paymentProcessorType) {
              this.instance.paymentProcessorType = paymentProcessorType;
          return this;
        }
