...
public class RestAffiliatePayment implements Serializable {
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "789", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Payment ID")
   ...
   * @return payDate
   */
  @jakarta.annotation.Nullable  @Schema(example = "2024-03-15T10:30:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Payment date (ISO-8601)")
   ...
   * @return payNotes
   */
  @jakarta.annotation.Nullable  @Schema(example = "Monthly commission payout", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Payment notes")
   ...
   * @return payAmount
   */
  @jakarta.annotation.Nullable  @Schema(example = "250", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Payment amount")
   ...
   * @return payType
   */
  @jakarta.annotation.Nullable  @Schema(example = "CHECK", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Payment type")
   ...
   * @return createTime
   */
  @jakarta.annotation.Nullable  @Schema(example = "2024-03-15T10:30:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Record creation time (ISO-8601)")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, restAffiliatePayment.id) &&
        ...
        Objects.equals(this.createTime, restAffiliatePayment.createTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, payDate, payNotes, payAmount, payType, createTime);
  }
