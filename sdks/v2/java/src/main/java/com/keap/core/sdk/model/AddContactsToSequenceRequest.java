...
public class AddContactsToSequenceRequest implements Serializable {
  ...
  public AddContactsToSequenceRequest contactIds(@jakarta.annotation.Nonnull List<String> contactIds) {
  ...
  @Schema(example = "[123, 456, 789]", requiredMode = Schema.RequiredMode.REQUIRED, description = "List of contact IDs to add to the sequence")
