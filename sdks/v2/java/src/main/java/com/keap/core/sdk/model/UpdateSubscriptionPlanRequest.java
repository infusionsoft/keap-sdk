...
public class UpdateSubscriptionPlanRequest implements Serializable {
   ...
   * @return active
   */
  @jakarta.annotation.Nullable  @Schema(example = "true", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Whether the subscription plan is active.")
  ...
  /**
   * The frequency of the subscription plan. Must be greater than 0.
   * @return frequency
   */
  @jakarta.annotation.Nullable  @Schema(example = "1", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The frequency of the subscription plan. Must be greater than 0.")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "false", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Allow prorating of the subscription plan.")
  ...
  @Schema(example = "MONTHLY", requiredMode = Schema.RequiredMode.REQUIRED, description = "The cycle type of the subscription plan.")
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(example = "10000", requiredMode = Schema.RequiredMode.REQUIRED, description = "The price of the subscription plan in the smallest currency unit. Must be greater than or equal to 0.")
   ...
   * @return totalCycles
   */
  @jakarta.annotation.Nullable  @Schema(example = "12", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "How many cycles the subscription plan will have. 0 means infinite.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, frequency, allowProrating, cycleType, displayOrderIndex, planPrice, totalCycles);
  }
