...
public class UpdateSubscriptionPlanRequest implements Serializable {
   ...
   * @return frequency
   */
  @jakarta.annotation.Nullable  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The frequency of the subscription plan. Must be greater than 0.")
   ...
   */
  @jakarta.annotation.Nonnull  @NotNull
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "The price of the subscription plan in the smallest currency unit. Must be greater than or equal to 0.")
