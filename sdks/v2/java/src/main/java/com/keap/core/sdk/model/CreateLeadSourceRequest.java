...
public class CreateLeadSourceRequest implements Serializable {
   ...
   * @return description
   */
  @jakarta.annotation.Nullable  @Schema(example = "Paid search advertising", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "A description of the lead source")
   ...
   * @return message
   */
  @jakarta.annotation.Nullable  @Schema(example = "Spring promotion", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "A message on the lead source")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "456", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The lead source category that the lead source belongs to")
  ...
  public CreateLeadSourceRequest startTime(@jakarta.annotation.Nullable ZonedDateTime startTime) {
  ...
  @Schema(example = "2024-01-01T00:00:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "When the lead source starts")
  ...
  public CreateLeadSourceRequest endTime(@jakarta.annotation.Nullable ZonedDateTime endTime) {
   ...
   */
  @jakarta.annotation.Nullable  @Valid
  @Schema(example = "2024-12-31T23:59:59Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "When the lead source ends")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createLeadSourceRequest.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, vendor, medium, message, status, leadSourceCategoryId, startTime, endTime);
  }
    ...
    public static class Builder {
        ...
        public CreateLeadSourceRequest.Builder name(String name) {
          ...
          return this;
            ...
            public CreateLeadSourceRequest.Builder startTime(ZonedDateTime startTime) {
              this.instance.startTime = startTime;
          return this;
        }
            public CreateLeadSourceRequest.Builder endTime(ZonedDateTime endTime) {
