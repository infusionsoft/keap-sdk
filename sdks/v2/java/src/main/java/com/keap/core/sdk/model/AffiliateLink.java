...
public class AffiliateLink implements Serializable {
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "789", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Affiliate link ID")
   ...
   * @return name
   */
  @jakarta.annotation.Nullable  @Schema(example = "Fitness Program", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Link name")
   ...
   * @return affiliateId
   */
  @jakarta.annotation.Nullable  @Schema(example = "123", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Associated affiliate ID")
   ...
   * @return programIds
   */
  @jakarta.annotation.Nullable  @Schema(example = "[1, 2]", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Associated program IDs")
   ...
   * @return dateCreated
   */
  @jakarta.annotation.Nullable  @Schema(example = "2024-03-15T10:30:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Date link was created (ISO-8601)")
