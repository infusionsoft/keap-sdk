...
public class RestV2Opportunity implements Serializable {
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "123", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Opportunity ID")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "Follow up with decision maker", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Notes for next action")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "High-value prospect from trade show", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "General notes")
   ...
   */
  @jakarta.annotation.Nullable  @Schema(example = "2024-03-15T14:30:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Last update timestamp (ISO-8601)")
   ...
   * @return affiliateId
   */
  @jakarta.annotation.Nullable  @Schema(example = "456", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Affiliate ID")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, restV2Opportunity.id) &&
    ...
    public static class Builder {
        ...
        public RestV2Opportunity.Builder id(String id) {
          ...
          return this;
            ...
            public RestV2Opportunity.Builder customFields(List<CustomField> customFields) {
