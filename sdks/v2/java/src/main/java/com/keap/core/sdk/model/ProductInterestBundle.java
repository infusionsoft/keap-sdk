...
public class ProductInterestBundle implements Serializable {
  ...
  @jakarta.annotation.Nullable  private List<@Valid ProductInterest> subscriptionPlanInterests = new ArrayList<>();
   ...
   * @return id
   */
  @jakarta.annotation.Nullable  @Schema(example = "123", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The product interest bundle ID")
   ...
   * @return name
   */
  @jakarta.annotation.Nullable  @Schema(example = "Premium Bundle", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Product interest bundle name")
   ...
   * @return description
   */
  @jakarta.annotation.Nullable  @Schema(example = "Bundle of premium products", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Product interest bundle description")
  ...
  public ProductInterestBundle subscriptionPlanInterests(@jakarta.annotation.Nullable List<@Valid ProductInterest> subscriptionPlanInterests) {
    this.subscriptionPlanInterests = subscriptionPlanInterests;
    return this;
  }

  public ProductInterestBundle addSubscriptionPlanInterestsItem(ProductInterest subscriptionPlanInterestsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<@Valid ProductInterest> getSubscriptionPlanInterests() {
    return subscriptionPlanInterests;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUBSCRIPTION_PLAN_INTERESTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubscriptionPlanInterests(@jakarta.annotation.Nullable List<@Valid ProductInterest> subscriptionPlanInterests) {
    this.subscriptionPlanInterests = subscriptionPlanInterests;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, productInterestBundle.id) &&
        Objects.equals(this.name, productInterestBundle.name) &&
        Objects.equals(this.description, productInterestBundle.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, productInterests, subscriptionPlanInterests);
  }
    ...
    public static class Builder {
        ...
        public ProductInterestBundle.Builder id(String id) {
          ...
          return this;
            ...
            public ProductInterestBundle.Builder productInterests(List<ProductInterest> productInterests) {
              this.instance.productInterests = productInterests;
          return this;
        }
            public ProductInterestBundle.Builder subscriptionPlanInterests(List<ProductInterest> subscriptionPlanInterests) {
